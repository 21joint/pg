 ...
 */
class Sitereviewlistingtype_Form_Admin_Listingtypes_Create extends Engine_Form {
  ...
  public function init() {
    ...
    if (empty($listingtype_id)) {
      $this->addElement('Select', 'template_type', array(
          'label' => 'Default Template',
          'description' => 'Choose the default template which you want to activate for this listing type. (If you do not want to create this listing type using default template, then simply leave the drop-down blank.)',
          'multiOptions' => array(
              'default_type' => '',
              'food' => 'Template 1 - Food',
              'tourism' => 'Template 2 - Tourism',
              'blog' => 'Template 3 - Blogs',
              'fashion' => 'Template 4 - Fashion',
              'electronic' => 'Template 5 - Electronics',
              'sport' => 'Template 6 - Sports',
              'classified' => 'Template 7 - Classifieds',
              'property' => 'Template 8 - Properties',
              'entertainment' => 'Template 9 - Entertainment',
              'article' => 'Template 10 - Articles',
              'job' => 'Template 10 - Jobs'
          ),
          'onchange' => 'setListingTypeValues($(this).value);',
      ));
    }

    $this->addElement('Text', 'title_singular', array(
        'label' => 'Singular Listing Title',
        'description' => 'Please enter the Singular Title for listing. This text will come in places like admin panel, feeds generated, widgets etc.',
        'allowEmpty' => false,
        'required' => true,
        'validators' => array(
            array('NotEmpty', true),
    ...
    $this->addElement('Text', 'slug_singular', array(
        'label' => 'Listings Singular URL text',
        'description' => 'Please enter the singular text below which you want to display in the URLs of this listing type. You can enter singular URL like movie.',
        'allowEmpty' => false,
        'required' => true,
        'validators' => array(
            array('NotEmpty', true),
    ...
    $this->addElement('Text', 'slug_plural', array(
        'label' => 'Listings Plural URL text',
        'description' => 'Please enter the plural text below which you want to display in the URLs of this listing type. You can enter plural URL like movies.',
        'allowEmpty' => false,
        'required' => true,
        'validators' => array(
            array('NotEmpty', true),
    ...
    $this->addElement('File', 'photo', array(
        'label' => 'Default Photo for Listings',
        'description' => 'Upload the default photo for the listings. (Note: If listing owners upload a profile picture for their listings, then that profile picture will be associated with the listing, otherwise this default image will be associated.)',
    ));
    ...
    $listingTypes = array();
    $listingTypes[0] = 'Default Settings';
    ...
    if (empty($listingtype_id)) {
      $this->addElement('Checkbox', 'main_menu', array(
          ...
          'label' => "Yes, enable this listing type in Main Navigation Menu. (Note: You can also enable / disable this listing type by editing 'Main Navigation Menu' from the Layout >> Menu Editor section of your admin panel.)",
          'value' => 1,
      ));
    } else {
//      $this->addElement('Multicheckbox', 'pages_navigation', array(
//          'label' => 'Replace Singular and Plural title',
//          'description' => 'Select that where you want to replace the Previous Singular and Plural title with new Singular and Plural title.',
//          'multiOptions' => array(
//              'pages' => "Widgetized Pages Title and widgets title text",
//              'navigations' => "Main navigation menu and Profile page options text",
//          ),
//              //'value' => array('pages','navigations'),
//      ));

      $this->addElement('Checkbox', 'translation_file', array(
          'description' => 'Replace Language Files',
          'label' => "Replace the language files for this listing in all language folders and not reflect the changes be done in \"custom.csv\" file.",
