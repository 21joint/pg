...
class Core_Form_Admin_Settings_General extends Engine_Form
{
  public function init()
  {
    ...
    $description = vsprintf($description.$moreinfo, array(
      'http://support.socialengine.com/questions/167/Admin-Panel-Settings-General-Settings',
    ));
    ...
    */
    ...
    $this->getElement('staticBaseUrl')->getDecorator('Label')
        ...
        'http://support.socialengine.com/questions/188/How-to-use-the-CDN-Storage-Feature#maxcdn'));
    ...
    $this->getElement('analytics')->getDecorator('Label')
        ...
        ->setOptSuffix(sprintf(
        '<a class="admin help" href="%1$s" target="_blank"> </a>',
        'http://support.socialengine.com/questions/142/How-to-install-Google-Analytics'));
    ...
    if( $settings->getSetting('user.support.links', 0) == 1 ) {
      ...
      $links[] = 'http://support.socialengine.com/php/customer/portal/articles/2766232-add-this?b_id=4311';
    }
    // Social share code
