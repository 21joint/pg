...
(function() {
    ...
    if (document.location.protocol === 'https:') {
      e.src = 'https://rpxnow.com/js/lib/$janrainUsername/share_beta.js';
    } else {
      e.src = 'http://widget-cdn.rpxnow.com/js/lib/$janrainUsername/share_beta.js';
    }
...
//        $view->headLink()->prependStylesheet('https://use.fontawesome.com/releases/v5.1.0/css/all.css');
    }
