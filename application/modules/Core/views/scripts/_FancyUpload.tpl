 ...
 * @version    $Id: _FancyUpload.tpl 10241 2014-05-26 16:47:23Z andres $
 * @author     Sami
 */
?>
    ...
    var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
      ...
      onFileRemove: function (file) {
        ...
        request = new Request.JSON({
          ...
          'url': '<?php echo $this->url(
            Array('module' => 'core', 'controller' => 'admin-ads',
                  'action' => 'removephoto'), 'default'
          ) ?>',
          'data': {
            'photo_id': file_id
          },
      ...
      onFileSuccess: function (file, response) {
        ...
        if (json.get('status') == '1') {
          ...
          $('photo_id').value = json.get('photo_id');
...
<fieldset id="demo-fallback">
  ...
  <p>
    <?php echo $this->translate(
      "CORE_VIEWS_SCRIPTS_FANCYUPLOAD_DESCRIPTION"
    ); ?>
  </p>
  <label for="demo-photoupload">
    <?php echo $this->translate('Upload a Photo:'); ?>
    <input id="fallback" type="file" name="Filedata" accept="image/*"/>
  </label>
</fieldset>

<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('CORE_VIEWS_SCRIPTS_FANCYUPLOAD_ADDPHOTOS'); ?>
  </div>
  <div>
