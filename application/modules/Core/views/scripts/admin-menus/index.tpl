...
<p>
  ...
  if( $settings->getSetting('user.support.links', 0) == 1 ) {
    ...
    if( Zend_Controller_Front::getInstance()->getRequest()->getParam('name') == "core_social_sites" ) {
      echo '<br> For more info on how to change the social footer menu icons, read this <a href="http://support.socialengine.com/php/customer/portal/articles/2773564-social-footer-menu-icons?b_id=4311" target="_blank">KB article</a>';
    }
  } 
  ?>	
</p>
