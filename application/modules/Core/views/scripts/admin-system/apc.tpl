 ...
 * @version    $Id: apc.tpl 9747 2012-07-26 02:08:08Z john $
 * @author     John
 */
...
global $PHP_SELF, $MY_SELF, $MY_SELF_WO_SORT, $MYREQUEST;
...
defaults('ADMIN_PASSWORD','bleh');    // Admin Password - CHANGE THIS TO ENABLE!!!
...
list($PHP_SELF) = explode('?', htmlentities(strip_tags($_SERVER['REQUEST_URI'],''), ENT_QUOTES, 'UTF-8'));
$time = time();
$host = php_uname('n');
if($host) { $host = '('.$host.')'; }
