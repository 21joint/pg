...
INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('sitevideo', 'Advanced Videos', 'Advanced Videos / Channels / Playlists Plugin', '4.9.4p8', 1, 'extra') ;
