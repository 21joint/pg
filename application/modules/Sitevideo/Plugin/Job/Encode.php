 ...
 */
class Sitevideo_Plugin_Job_Encode extends Core_Plugin_Job_Abstract {
    ...
    protected function _execute() {
        ...
        if (!$video || !($video instanceof Sitevideo_Model_Video)) {
    ...
    private function getFFMPEGPath() {set_time_limit(0);
