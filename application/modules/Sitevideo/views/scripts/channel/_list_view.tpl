...
<?php if ($this->paginator->getTotalItemCount() > 0): ?>
    ...
    if (in_array('subscriptionSettings', $this->channelOption))
        $sideLinkOption[] = 'subscriptionSettings';
    ?>
    <ul class='videos_manage siteevideo_list_view siteevideo_channels_list_view' id='channels_manage<?php echo "_" . $identity; ?>'>
                ...
                <div class="sitevideo_thumb_wrapper">
                    <div class="sitevideo_list_thumb">
                        ...
                        <div class="sitevideo_desc">
                            <?php echo $this->shareLinks($item, $linkOption); ?>
                        </div>
                    </div>
                        ...
                        <div class="sitevideo_bottom_info">
                            ...
                            <div class="sitevideo_stats o_hidden">
                                ...
                                <?php if (in_array('rating', $this->channelOption)) : ?>
                                    <div class="sitevideo_ratings"><?php echo $this->ratingInfo($item, array('widget_id' => $identity . '_c')); ?></div>
                                <?php endif; ?>
                            </div> 
                            <div class="video_desc sitevideo_desc_channel">
                                <?php echo $this->shareLinks($item, $sideLinkOption); ?>
                            </div>
                            ...
                            <div class="sitevideo_list_desc clr">
                                <?php
                                if (!$this->descriptionTruncation)
                                    $this->descriptionTruncation = 200;
                                ?>
