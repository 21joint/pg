 ...
 * @version    $Id: _FancyUploadPhoto.tpl 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
...
// url is read from the form, so you just have to change one place
             ...
             *
             * This example creates a list of error elements directly in the file channel, which
             * hide on click.
             */
            ...
            onFileRemove: function (file) {
                ...
                request = new Request.JSON({
                    'format': 'json',
                    'url': '<?php echo $this->url(Array('module' => 'sitevideo', 'controller' => 'photo', 'action' => 'remove'), 'default') ?>',
                    'data': {
                        'photo_id': file_id,
                        'is_ajax': 1,
                    },
                ...
                if (uploadCount == 0)
                {
                    ...
                    var demositevideo = document.getElementById("demo-list");
                    var demosubmit = document.getElementById("submit-wrapper");
                    democlear.style.display = "none";
                    demositevideo.style.display = "none";
...
<div id="demo-status" class="hide">
    <div>
        <?php echo $this->translate("Click 'Add Photos' to select one or more photos from your computer. After you have selected the photos, they will begin to upload right away. When your upload is finished, click the button below your photo to save them to your channel."); ?>
    </div>
