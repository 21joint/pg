 ...
 * @version    $Id: _FancyUpload.tpl 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
...
<div id="demo-status" class="hide" style="display:none;">
  <div>
    <?php echo $this->translate('Click "Add Video" to select a video from your computer. After you have selected video, click on Save Video at the bottom to begin uploading the file. Please wait while your video is being uploaded. When your upload is finished, your video will be processed - you will be notified when it is ready to be viewed.');?>
  </div>
  <div>
    <a class="seaocore_icon_add" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Video');?></a>
  </div>
...
<div><br/>
  <button class="buttonlink" onclick="javascript:startUpload(); return false;" id="demo-upload" style='display:none;'><?php echo $this->translate('Save Video');?></button>
</div>
