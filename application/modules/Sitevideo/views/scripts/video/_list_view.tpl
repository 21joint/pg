 ...
 * @version    $Id: _list_view.tpl 6590 2016-3-3 00:00:00Z SocialEngineAddOns $
...
<?php if ($this->paginator->getTotalItemCount() > 0): ?>
    ...
    <ul class='videos_manage  siteevideo_list_view' id='videos_manage<?php echo "_" . $identity; ?>'>
                    ...
                    <div class="sitevideo_info  sitevideo_list_video_info">
                        <div class="sitevideo_bottom_info">
                            ...
                            <div class="sitevideo_stats o_hidden">
                                <div class="video_views">
                                    <?php if (in_array('owner', $this->videoOption)) : ?>
                                        ...
                                        <span class='site_video_author_name clr'>
                                            <?php echo $this->translate('by %s', $this->htmlLink($owner->getHref(), $this->string()->truncate($this->string()->stripTags($owner->getTitle()), 17))); ?> 
                                        </span>
                                    <?php else : ?>
                                        ...
                                        if (!$videoOwnerLeader)
                                            $itemTypeValue = 'user';
                                        ?>
                                        <?php $channel = $item->getChannel(); ?>
                                        <?php if ($channel) : ?> 
                                            <span class='site_video_author_name clr'>
                                                <?php echo $this->htmlLink($channel->getHref(), $this->string()->truncate($this->string()->stripTags($channel->getTitle()), 17)); ?>
                                            </span>

                                        <?php else: ?>
                                            <?php if ($itemTypeValue == 'user'): ?>
                                                <span class='site_video_author_name clr'>
                                                    <?php echo $this->htmlLink($item->getOwner()->getHref(), $this->string()->truncate($this->string()->stripTags($item->getOwner()->getTitle()), 17)); ?>
                                                </span>
                                            <?php else: ?>
                                                <span class='site_video_author_name clr'>
                                                    <?php echo $this->htmlLink($contentitem->getHref(), $this->string()->truncate($this->string()->stripTags($contentitem->getTitle()), 17)); ?>
                                                <?php endif; ?>
                                ...
                                <?php if (in_array('rating', $this->videoOption)) : ?>
                                    <div class="sitevideo_ratings">
                                        <?php echo $this->ratingInfo($item, array('widget_id' => $identity . '_c')); ?>
                                    </div>
                                <?php endif; ?>
                            ...
                            <div class="sitevideo_list_desc">
                                ...
                                if (!$isEnableTinymce) {
                                    $description = $this->string()->stripTags($item->description);
                                    echo $this->string()->truncate($description, $this->descriptionTruncation);
                                } else {
                                    echo $description;
                                }
                                ?>
