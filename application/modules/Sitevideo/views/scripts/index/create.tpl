...
<div class="channel-video-list">
    ...
    <div id="prev_button" style="display:none;" onclick="en4.sitevideo.youtubeChannel.previousPage()">Prev</div><div id="next_button" style="display:none;" onclick="en4.sitevideo.youtubeChannel.nextPage()">Next</div>
</div>
<div id="channel_list_div" style="display:none;" class="popup_element">
    <ul id="channel_list">

    </ul>
    <div id="channel_prev_button" style="display:none;" onclick="en4.sitevideo.youtubeChannel.previousPage()">Prev</div><div id="channel_next_button" style="display:none;" onclick="en4.sitevideo.youtubeChannel.nextPage()">Next</div>
</div>
