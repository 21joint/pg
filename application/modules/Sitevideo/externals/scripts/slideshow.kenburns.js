/**
 Script: Siteslideshow.KenBurns.js
 Siteslideshow.KenBurns - KenBurns extension for Slideshow, includes zooming and panning effects.
...
(function () {
    Slideshow.KenBurns = new Class({
        ...
        /**
         ...
         Syntax:
         var myShow = new Siteslideshow.KenBurns(element, data, options);
         */
        ...
        initialize: function (el, data, options) {
            ...
            ['pan', 'zoom'].each(function (p) {
                if (this[p] != undefined) {
                    if (typeOf(this[p]) != 'array')
                        this[p] = [this[p], this[p]];
                    this[p].map(function (n) {
                        return (n.toInt() || 0).limit(0, 100);
                    });
                }
            }, options);
