 ...
 */
class Siteiosapp_Form_Admin_PushNotification_Send extends Engine_Form {

    public function init() {
        $this
                ->setTitle('Send Push Notifications')
//                ->setDescription('Using this form, you will be able to send a push notification out to your members by choosing robust targeting options for who should receive your push notification based on "Member Levels" and "Networks", depending on which of these are being used on your site. You can also choose to send push notification to particular members by choosing their names from the auto-suggest box.')
        ;
        ...
        $this->addElement('Text', 'to', array(
            'label' => 'Choose Users',
            'description' => 'Enter and choose the names of specific users to whom you want to send push notification. Note that you will only be able to choose from those users who have installed your iOS App, and have logged into it once.',
            'order' => 7,
            'autocomplete' => 'off'));
