...
class Siteiosapp_AdminAppBuilderController extends Core_Controller_Action_Admin {
    ...
    protected $_enabledTabsArray = array(
        ...
        3 => 'siteiosapp_admin_dashboard_setting',
        4 => 'siteiosapp_admin_splash_and_slideshows',
        5 => 'siteiosapp_admin_language_assets',
        6 => 'siteiosapp_admin_advertising',
        7 => 'siteiosapp_admin_download',
        8 => 'siteiosapp_admin_people',
    );
    protected $_advertisingEnabledTabsArray = array(
        1 => 'siteiosapp_admin_advertising_type',
        2 => 'siteiosapp_admin_advertising_modules',
    );
    protected $_dynamicImages = array(
        'splash_portrait_2',
        'splash_portrait_3',
        'splash_portrait_4',
        'splash_portrait_6',
    ...
    protected $_getAPPImageDetailsForUpload = array(
        ...
        'app_icon_21' => array(
            'title' => 'APP Icon (20 x 20)',
            'width' => 20,
            'height' => 20,
            'directoryName' => 'App_Icons',
            'fileName' => 'icon 20 x 20'
        ),
        'app_icon_17' => array(
            'title' => 'APP Icon (167 x 167)',
            'width' => 167,
            'height' => 167,
            'directoryName' => 'App_Icons',
            'fileName' => 'icon 167 x 167'
        ),
...
//        ),
        'splash_portrait_6' => array(
            'title' => 'Splash Portrait Image (750 x 1334)',
            'width' => 750,
            'height' => 1334,
            'directoryName' => 'Splash_Screen_Images/Ipad/Portrait',
            'fileName' => 'screen 750 x 1334'
        ),
        'splash_portrait_7' => array(
            'title' => 'Splash Portrait Image (1242 x 2208)',
            'width' => 1242,
            'height' => 2208,
            'directoryName' => 'Splash_Screen_Images/Ipad/Portrait',
            'fileName' => 'screen 1242 x 2208'
        ),
...
//        ),
        ...
        'secondControllerImage1' => array(
            'title' => 'Second tab icon 18 x 18',
            'width' => 18,
            'height' => 18,
            'directoryName' => 'App_Icons',
            'fileName' => 'second tab 18 x 18'
        ),
        'secondControllerImage2' => array(
            'title' => 'Second tab icon 36 x 36',
            'width' => 36,
            'height' => 36,
            'directoryName' => 'App_Icons',
            'fileName' => 'second tab 36 x 36'
        ),
        'secondControllerImage3' => array(
            'title' => 'Second tab icon 54 x 54',
            'width' => 54,
            'height' => 54,
            'directoryName' => 'App_Icons',
            'fileName' => 'second tab 54 x 54'
        ),
        'thirdControllerImage1' => array(
            'title' => 'third tab icon 18 x 18',
            'width' => 18,
            'height' => 18,
            'directoryName' => 'App_Icons',
            'fileName' => 'third tab 18 x 18'
        ),
        'thirdControllerImage2' => array(
            'title' => 'third tab icon 36 x 36',
            'width' => 36,
            'height' => 36,
            'directoryName' => 'App_Icons',
            'fileName' => 'third tab 36 x 36'
        ),
        'thirdControllerImage3' => array(
            'title' => 'third tab icon 54 x 54',
            'width' => 54,
            'height' => 54,
            'directoryName' => 'App_Icons',
            'fileName' => 'third tab 54 x 54'
        ),
        'fourthControllerImage1' => array(
            'title' => 'fourth tab icon 18 x 18',
            'width' => 18,
            'height' => 18,
            'directoryName' => 'App_Icons',
            'fileName' => 'fourth tab 18 x 18'
        ),
        'fourthControllerImage2' => array(
            'title' => 'fourth tab icon 36 x 36',
            'width' => 36,
            'height' => 36,
            'directoryName' => 'App_Icons',
            'fileName' => 'fourth tab 36 x 36'
        ),
        'fourthControllerImage3' => array(
            'title' => 'fourth tab icon 54 x 54',
            'width' => 54,
            'height' => 54,
            'directoryName' => 'App_Icons',
            'fileName' => 'fourth tab 54 x 54'
        ),
    );
    ...
    public function init() {
        ...
        unset($tempImageArray['secondControllerImage1']);
        unset($tempImageArray['secondControllerImage2']);
        unset($tempImageArray['secondControllerImage3']);
        unset($tempImageArray['thirdControllerImage1']);
        unset($tempImageArray['thirdControllerImage2']);
        unset($tempImageArray['thirdControllerImage3']);
        unset($tempImageArray['fourthControllerImage1']);
        unset($tempImageArray['fourthControllerImage2']);
        unset($tempImageArray['fourthControllerImage3']);
    ...
    public function editGoogleAdModulesAction() {
        ...
        $this->view->form = $form = new Siteiosapp_Form_Admin_AppBuilder_GoogleAds_Edit();
        ...
        $storyPluginEnabled = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled("communityadsponsored");

        if ($appBuilderParams['adv_type'] == 0) {
            $adMultiOptions[0] = 'Google Ads';
        } else {
            $adMultiOptions[1] = 'Facebook Ads';
        }
        if ($communityPluginEnabled) {
            $adMultiOptions[2] = 'Community Ads';
        }
        if ($storyPluginEnabled && strstr($key, 'advancedactivity')) {
            $adMultiOptions[4] = 'Sponsered Stories';
        }

        $form->getElement('module_ad_type')->setMultiOptions($adMultiOptions);
        if ($this->getRequest()->isPost()) {
            $formError = array();
            $values = $this->getRequest()->getPost();

            if ($values['google_ad_show_after'] < 5) {
                $this->_forward('success', 'utility', 'core', array(
                    'smoothboxClose' => 10000,
                    'messages' => array(Zend_Registry::get('Zend_Translate')->_('Show add after : should not be less than 5'))
                ));
                return;
            }
    ...
    public function languageEditAction() {
        $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('siteiosapp_admin_main', array(), 'siteiosapp_admin_app_create');
        $this->view->subnavigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('siteiosapp_admin_appsetup_main', array(), $this->_enabledTabsArray[5]);

        $this->view->isFileExist = false;
        $this->view->locale = $locale = $this->_getParam('locale');
        $this->view->page = $page = $this->_getParam('page');
        $translation = $this->_getParam('translation', 0);
        ...
        if (@file_exists(APPLICATION_PATH . DIRECTORY_SEPARATOR . '/application/modules/Siteiosapp/settings/Localizable.strings')) {
            ...
            if (!empty($translation) && Engine_Api::_()->hasModuleBootstrap('sitetranslator') && $locale != 'en' && !file_exists($path)) {
                $variables = $this->_csv_to_array(APPLICATION_PATH . "/application/modules/Sitetranslator/settings/variables.csv");
                $responseData = Engine_Api::_()->sitetranslator()->getTranslatedBaseMessage($getDefaultLanguageArray, $locale, $variables);
                if ($responseData['responseCode'] != 200) {
                    $filterForm->addError('Fetching translation failed! Server response code:' . $responseData['responseCode'] . '<br /> Error description: ' . $responseData['responseData']['error']['errors'][0]['message']);
                } else {
                    $getDefaultTranslatedLanguageArray = $responseData['responseData'];
                }
            }
        }
...
//            $composite['plural'] = $isPlural = (bool) is_array($value);
            ...
            $composite['current'] = (!empty($getExistingLanguageArray) && isset($getExistingLanguageArray[$key]) && !empty($getExistingLanguageArray[$key])) ? $getExistingLanguageArray[$key] : (!empty($getDefaultTranslatedLanguageArray[$key]) ? $getDefaultTranslatedLanguageArray[$key] : $value);
...
//            }
        ...
        if ($this->getRequest()->isPost()) {
            ...
            // foreach($values as $rv => $vv)
            // {
            //     if(preg_match("/[£&¬]/", $vv))
            //     {
            //         $this->view->error = "One Or More fields have special characters (£ or & or ¬) in it";
            //         return;
            //     }
            // }
...
//            }
            ...
            $explodeStringsToArray = !empty($getDefaultTranslatedLanguageArray) ? $getDefaultTranslatedLanguageArray : $this->_ExplodeStringsToArray($path, 1);
            //$valuesArray = $explodeStringsToArray; //$explodeStringsToArray['values'];
            $valuesArray = $explodeStringsToArray['values'] ? $explodeStringsToArray['values'] : $explodeStringsToArray;
            ...
            return $this->_redirect($this->view->url(array('module' => 'siteiosapp', 'controller' => 'app-builder', 'action' => 'create', 'tab' => 5), 'admin_default', false), array('prependBase' => false));
...
//            return $this->_redirect($_SERVER['REQUEST_URI'], array('prependBase' => false));
    ...
    public function createAction() {
        ...
        if ($enabledTab == 6) {
            $this->view->subTab = $subTab = $this->_getParam('subTab', 1);
            $this->view->subsubnavigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('siteiosapp_admin_advertising', array(), $this->_advertisingEnabledTabsArray[$subTab]);
            $multiOptions = array();
        ...
        foreach ($this->_getAPPImageDetailsForUpload as $key => $values) {
            $imageType = '.png';
            if (in_array($key, $this->_dynamicImages) && isset($appBuilderParams['welcome_image_type']) && empty($appBuilderParams['welcome_image_type']))
                $imageType = '.gif';

            if (@file_exists(APPLICATION_PATH . DIRECTORY_SEPARATOR . $this->_getAPPBuilderBaseURL . DIRECTORY_SEPARATOR . $values['directoryName'] . '/' . $values['fileName'] . $imageType)) {
...
//            $dontShowDownloadLink = true;
        ...
        $this->view->dynamicImages = $this->_dynamicImages;
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (($enabledTab == 7) && (!isset($values['ios_app_rejection_confirmation']) || empty($values['ios_app_rejection_confirmation'])))
            ...
            if (isset($values['small_font_size']) && !empty($values['small_font_size'])) {
                $element = "small_font_size";
                $smallFontSize = (double) $values['small_font_size'];
                if (empty($smallFontSize)) {
                    $formError[] = $form->$element->getLabel() . ' - Please enter a valid integer';
                }
            }

            if (isset($values['normal_font_size']) && !empty($values['normal_font_size'])) {
                $element = "normal_font_size";
                $normalFontSize = (double) $values['normal_font_size'];
                if (empty($normalFontSize)) {
                    $formError[] = $form->$element->getLabel() . ' - Please enter a valid integer';
                }
            }

            if (isset($values['medium_font_size']) && !empty($values['medium_font_size'])) {
                $element = "medium_font_size";
                $mediumFontSize = (double) $values['medium_font_size'];
                if (empty($mediumFontSize)) {
                    $formError[] = $form->$element->getLabel() . ' - Please enter a valid integer';
                }
            }

            if (isset($values['large_font_size']) && !empty($values['large_font_size'])) {
                $element = "large_font_size";
                $largeFontSize = (double) $values['large_font_size'];
                if (empty($largeFontSize)) {
                    $formError[] = $form->$element->getLabel() . ' - Please enter a valid integer';
                }
            }
...
//            }
            ...
            $getHost = (isset($values['siteapi_validate_ssl']) && !empty($values['siteapi_validate_ssl'])) ? 'https://' . $_SERVER['HTTP_HOST'] : 'http://' . $_SERVER['HTTP_HOST'];
            $siteHost = $this->view->url(array(), 'home', false);
            $values['api_calling_url'] = $getHost . $siteHost . 'api/rest/';
            $splashImagesType = isset($values['welcome_image_type']) ? $values['welcome_image_type'] : 1;
...
//Start Primemessenger Code
            if ($enabledTab == 1 && isset($values['enable_primemessenger']) && !empty($values['enable_primemessenger'])) {
                $this->savePrimemessengerFiles();
            }
            //End Primemessenger Work
            ...
            try {
                ...
                if ((is_file($getAPPBuilderSettingsFilePath) && is_writable($getAPPBuilderSettingsFilePath)) ||
                    ...
                    if (!empty($values)) {
                        ...
                        if ($enabledTab == '3') {
                            $app_dashboard_menu_setting = $values['app_dashboard_menu_setting'];
                            if ($app_dashboard_menu_setting) {
                                $menusTable = Engine_Api::_()->getDbtable('menus', 'siteiosapp');
                                $select = $menusTable->select()
                                        ->from($menusTable->info('name'), array('menu_id', 'module', 'name', 'dashboard_label', 'params'))
                                        ->where("menu_id = ?", $values['secondController']);

                                $result = $select->query()->fetchALL();

                                if (!empty($result)) {
                                    $values['secondControllerName'] = $result[0]['dashboard_label'];

                                    if ($result[0]['module'] == 'sitereview') {
                                        $params = unserialize($result[0]['params']);
                                        $values['secondControllerListingTypeId'] = $params['listingtype_id'];
                                    } elseif (isset($values['secondControllerListingTypeId']))
                                        unset($values['secondControllerListingTypeId']);
                                }

                                // For Third Controller
                                $select = $menusTable->select()
                                        ->from($menusTable->info('name'), array('menu_id', 'module', 'name', 'dashboard_label', 'params'))
                                        ->where("menu_id = ?", $values['thirdController']);

                                $result = $select->query()->fetchALL();

                                if (!empty($result)) {
                                    $values['thirdControllerName'] = $result[0]['dashboard_label'];

                                    if ($result[0]['module'] == 'sitereview') {
                                        $params = unserialize($result[0]['params']);
                                        $values['thirdControllerListingTypeId'] = $params['listingtype_id'];
                                    } elseif (isset($values['thirdControllerListingTypeId']))
                                        unset($values['thirdControllerListingTypeId']);
                                }

                                $select = $menusTable->select()
                                        ->from($menusTable->info('name'), array('menu_id', 'module', 'name', 'dashboard_label', 'params'))
                                        ->where("menu_id = ?", $values['fourthController']);

                                $result = $select->query()->fetchALL();

                                if (!empty($result)) {
                                    $values['fourthControllerName'] = $result[0]['dashboard_label'];

                                    if ($result[0]['module'] == 'sitereview') {
                                        $params = unserialize($result[0]['params']);
                                        $values['fourthControllerListingTypeId'] = $params['listingtype_id'];
                                    } elseif ($values['fourthControllerListingTypeId'])
                                        unset($values['fourthControllerListingTypeId']);
                                }
                            }
                        }
                ...
                $secondControllerDefaultImage = $values["secondControllerImageDefault"];

                $thirdControllerDefaultImage = $values["thirdControllerImageDefault"];

                $fourthControllerDefaultImage = $values["fourthControllerImageDefault"];
                ...
                foreach ($this->_getAPPImageDetailsForUpload as $key => $values) {
                    ...
                    if (empty($_FILES[$key]["tmp_name"])) {
                        if (in_array($key, $this->_dynamicImages) && isset($splashImagesType) && empty($splashImagesType)) {
                            if (@file_exists(APPLICATION_PATH . DIRECTORY_SEPARATOR . $this->_getAPPBuilderBaseURL . DIRECTORY_SEPARATOR . $values['directoryName'] . '/' . $values['fileName'] . '.gif')) {
                                continue;
                            }
                        } else {
                        ...
                        if (($enabledTab != 2) && ($enabledTab != 3) && ($enabledTab != 4))
                            continue;

                        if (($enabledTab != 4) && (in_array($key, array('slideshow_slide_image_1_2'))))
                            continue;

                        // Conditions for images error in diffrent tabs.
                        if (($enabledTab != 2) && (in_array($key, array('large_app_icon', 'app_icon_1', 'app_icon_2', 'app_icon_3', 'app_icon_4', 'app_icon_5', 'app_icon_6', 'app_icon_7', 'app_icon_8', 'app_icon_9', 'app_icon_10', 'app_icon_11', 'app_icon_12', 'app_icon_13', 'app_icon_14', 'app_icon_15'))))
                            continue;

                        if (($enabledTab != 4) && (in_array($key, array('slideshow_slide_image_1_2', 'splash_portrait_2', 'splash_portrait_3', 'splash_portrait_4', 'splash_portrait_5', 'splash_portrait_6', 'splash_portrait_7', 'splash_landscape_1', 'splash_landscape_2', 'splash_landscape_3', 'splash_landscape_4'))))
                            continue;

                        // Tabs menu work 
                        if (($enabledTab == 3) && (empty($app_dashboard_menu_setting) || $app_dashboard_menu_setting == 0))
                            continue;

                        if (($enabledTab != 3) && (in_array($key, array('secondControllerImage1', 'secondControllerImage2', 'secondControllerImage3', 'thirdControllerImage1', 'thirdControllerImage2', 'thirdControllerImage3', 'fourthControllerImage1', 'fourthControllerImage2', 'fourthControllerImage3'))))
                            continue;

                        if (($enabledTab == 3) && isset($secondControllerDefaultImage) && !empty($secondControllerDefaultImage) && in_array($key, array('secondControllerImage1', 'secondControllerImage2', 'secondControllerImage3')))
                            continue;

                        if (($enabledTab == 3) && isset($thirdControllerDefaultImage) && !empty($thirdControllerDefaultImage) && in_array($key, array('thirdControllerImage1', 'thirdControllerImage2', 'thirdControllerImage3')))
                            continue;

                        if (($enabledTab == 3) && isset($fourthControllerDefaultImage) && !empty($fourthControllerDefaultImage) && in_array($key, array('fourthControllerImage1', 'fourthControllerImage2', 'fourthControllerImage3')))
                            continue;
                    ...
                    if (isset($_FILES[$key]) && !empty($_FILES[$key])) {
                        ...
                        //GIF Images Work Start
                        if (in_array($key, $this->_dynamicImages) && isset($splashImagesType) && empty($splashImagesType)) {
                            if ($imageFileType != "gif") {
                                $errors[] = $values['title'] . ': You have selected GIF image type for splash screen, so please choose GIF files.';
                                continue;
                            }
                        } else {
                            if (in_array($key, $this->_dynamicImages) && $imageFileType != "png") {
                                $errors[] = $values['title'] . ': You have selected PNG image type for splash screen, so please choose PNG files.';
                                continue;
                        ...
                        if ($_FILES[$key]["size"] > 1000000) {
                            $errors[] = $values['title'] . ': The uploaded file size has been increased, please upload the image(s) less then 1MB';
                            continue;
                        }
            ...
            if (!empty($errors)) {
                ...
                return;
            } else if ($enabledTab == 8) {
                $this->_helper->redirector->gotoRoute(array('tab' => 7));
                return;
            } else if ($enabledTab == 6 && isset($subTab) && !empty($subTab) && $subTab == 1) {
                $this->_helper->redirector->gotoRoute(array('tab' => $enabledTab, 'subTab' => ++$subTab));
                return;
            } else {
                if ($enabledTab < 5) {
    ...
    protected function validateSubscriptionPlane() {
        ...
        if (isset($getCurlResponse[$website])) {
            ...
            foreach ($getWebsitePlans as $planObj) {
                ...
                if (($planObj->title == 'Mobile Pro Plan') || ($planObj->title == 'Mobile Apps - Product Support and App Upgrade Support'))
                    $enabledPlan[] = 'pro';
                ...
                if (empty($getResult) && (($planObj->title == 'Mobile Pro Plan') || ($planObj->title == 'Mobile Apps - Product Support and App Upgrade Support') || ($planObj->title == 'Mobile Starter Plan'))) {
    ...
    private function _ExplodeStringsToArray($path, $getPluralKeys = false) {
        ...
        while (!feof($myfile)) {
            ...
            if (!empty($rowContent)) {
                ...
                $flagStrArray[1] = @str_replace('"', '', $flagStrArray[1]);
...
//                    }
    ...
    public function getmoduleAction() {
        $menusTable = Engine_Api::_()->getDbtable('menus', 'siteiosapp');
        $select = $menusTable->select()
                ->from($menusTable->info('name'), array('menu_id', 'name', 'module', 'url'))
                ->where("status = ?", 1);

        $result = $select->query()->fetchALL();
        $data = array();
        foreach ($result as $row => $value)
            $data[$value['menu_id']] = array('module' => $value['module'], 'url' => $value['url'], 'name' => $value['name']);

        echo Zend_Json_Encoder::encode($data);
        die;
    }

    public function savePrimemessengerFiles() {
        ...
        if (isset($subdomain) && !empty($subdomain)) {
            $apiURL = 'https://' . $subdomain . '.primemessenger.com/api/application-settings';
            $website = str_replace('www.', '', $apiURL);
            ...
            $getCurlResponse = ob_get_contents();
            ob_end_clean();
            $getCurlArray = Zend_Json_Decoder::decode($getCurlResponse);

            if (strstr($getCurlResponse, 'error::'))
                return $getCurlResponse;

            //Save Setting File
            if (isset($getCurlArray['firebaseSettings']['ios']) && !empty($getCurlArray['firebaseSettings']['ios'])) {
                $temp_doc_file = APPLICATION_PATH . DIRECTORY_SEPARATOR . $this->_getAPPBuilderBaseURL . DIRECTORY_SEPARATOR . 'Primemessenger';
                $content = file_get_contents($getCurlArray['firebaseSettings']['ios']);
                if (isset($content) && !empty($content)) {
                    if (!is_dir($temp_doc_file))
                        mkdir($temp_doc_file, 0777, true);

                    $fileName = $temp_doc_file . '/' . 'GoogleService-Info.plist';
                    file_put_contents($fileName, $content);
                }
            }

            //Save Language Files
            if (isset($getCurlArray['languageSettings']) && !empty($getCurlArray['languageSettings'])) {
                foreach ($getCurlArray['languageSettings'] as $key => $files) {
                    if (isset($files['android']) && !empty($files['ios'])) {
                        $temp_doc_file = APPLICATION_PATH . DIRECTORY_SEPARATOR . $this->_getAPPBuilderBaseURL . DIRECTORY_SEPARATOR . 'Primemessenger/Languages_App';
                        if (!is_dir($temp_doc_file)) {
                            mkdir($temp_doc_file, 0777, true);
                        }
                        $content = file_get_contents($files['ios']);
                        if (isset($content) && !empty($content)) {
                            $fileName = $temp_doc_file . '/' . $key . '_language_ios_mobileapp.strings';
                            file_put_contents($fileName, $content);
                        }
                    }
                }
    ...
    // public function getlistingidAction()
    // {
    //     $values = $this->_getAllParams();
    //     $menusTable = Engine_Api::_()->getDbtable('menus' , 'siteiosapp') ;
    //     $select = $menusTable->select()
    //             ->from($menusTable->info('name') , array('name' , 'params'))
    //             ->where("name = ?",$values['name'])
    //             ->where("dashboard_label = ?",$values['textname']);
    //     $result = $select->query()->fetchALL();
    //     if(!empty($result))
    //     {
    //         $params = $result[0]['params'];
    //         $params = unserialize($params);
    //         echo Zend_Json_Encoder::encode(array('listingtype_id' => $params['listingtype_id']));
    //         die; 
    //     }
    //     else
    //     {
    //         echo Zend_Json_Encoder::encode(array('status' => 'false'));
    //         die;
    //     }
    // }
}
