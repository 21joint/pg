...
<p>
    <?php echo 'This section is useful for you only if you want your app to be multi-lingual (in multiple languages), or if you want to change any of the existing English language phrases in your app. Below, you can manage a particular language’s phrases after click on its "edit phrases" link.[Note:<br>
1. Default language of your app will be the default language of your website (the one you set from <a href="admin/language/index">Language Manager</a>). <br>
2. To add a new language in the app, please add required language pack from <a href="admin/language/index">Language Manager</a>. Once you add there, same language pack will display here in this section.]'; ?>
</p>
...
<table class="admin_table admin_languages">
    ...
    <td class="admin_table_options">
        ...
        if(array_key_exists($locale, $this->getAPPLanguageDetailsForUpload)):
            echo $this->translate("edit phrases"); $languageExists = 1;
...
//        echo (array_key_exists($locale, $this->getAPPLanguageDetailsForUpload))? $this->translate("edit phrases"): $this->translate("create language for app"); 
        ...
        ?></a>
        <?php if(($locale != 'en') && empty($languageExists) && Engine_Api::_()->hasModuleBootstrap('sitetranslator')): ?>
            |<a href="<?php echo $this->url(array('action' => 'language-edit', 'locale' => $locale,'translation' => 1)) ?>">
              <?php echo $this->translate("create language for app by language translator plugin"); ?>
            </a>
        <?php endif; ?>
        <?php echo (array_key_exists($locale, $this->getAPPLanguageDetailsForUpload))? ' | ' . $this->htmlLink(array('module' => 'siteiosapp', 'controller' => 'app-builder', 'action' => 'language-delete', 'locale' => $locale), $this->translate('delete'), array('class' => 'smoothbox')): '' ?>
