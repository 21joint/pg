...
<?php endif; ?>
    ...
    en4.core.runonce.add(function () {
        if (!isPopulated) { // NOT POPULATED
            new Autocompleter.Request.JSON('to', '<?php echo $this->url(array('module' => 'siteiosapp', 'controller' => 'push-notification', 'action' => 'suggest'), 'admin_default', true) ?>', {
                'minLength': 1,
                'delay': 250,
                'selectMode': 'pick',
