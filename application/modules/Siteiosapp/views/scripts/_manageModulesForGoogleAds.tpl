    ...
    <thead>
        <tr>
          <!--<th class='admin_table_short'><input onclick='selectAll();' type='checkbox' class='checkbox' /></th>-->
            ...
            <th><?php echo $this->translate("Selected Ad Type") ?></th>
...
<td>        
        ...
        ?>
        <?php echo ( $status ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteiosapp', 'controller' => 'app-builder', 'action' => 'status', 'key' => $key), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Seaocore/externals/images/approved.gif', '', array('title' => $this->translate('Disable it'))), array('class' => 'smoothbox')) : $this->htmlLink(array('route' => 'admin_default', 'module' => 'siteiosapp', 'controller' => 'app-builder', 'action' => 'status', 'key' => $key), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Seaocore/externals/images/disapproved.gif', '', array('title' => $this->translate('Enable it'))), array('class' => 'smoothbox')) ) ?>
</td>
<td>        
        <?php
        $ad_type = isset($this->appBuilderParams['Ads'][$key]['module_ad_type']) ? $this->appBuilderParams['Ads'][$key]['module_ad_type'] : $this->appBuilderParams['adv_type'];
...
<td>
        <?php
        echo $this->htmlLink(
                array('route' => 'admin_default', 'module' => 'siteiosapp', 'controller' => 'app-builder', 'action' => 'edit-google-ad-modules', 'key' => $key), $this->translate("edit"), array('class' => 'smoothbox'))
        ?>
</td>
</tr>
<?php endforeach; ?>
...
<div class="clr" style="padding-top: 10px;">
    <button name="submit" id="submit" type="submit" onclick="window.location.href = '<?php echo $this->url(array('tab' => 8), 'admin_default', false); ?>'">Save Changes and Continue</button>
</div>