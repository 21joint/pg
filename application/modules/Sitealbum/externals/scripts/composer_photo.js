...
//    $$('.compose-container').find('.overTxtLabel').innerHTML = en4.core.language.translate('Say something about this photo...');
      ...
      this.options.fancyUploadEnabled = this.options.fancyUploadEnabled && hasFlash;
...
//            var diff = this.progressDate - this.startDate;
//            var c = 0;
...
//              file.addEvents({
//                'progress': opts.onProgress.bind(file)
//              });
    ...
    updateScrollBar: function () {
      ...
      this.elements.formFancyList.getParent().setStyle('width', ((li[0].getSize().x + 11) * li.length) + this.elements.formFancyFile.getSize().x + 10);
