...
INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('sitealbum', 'Advanced Photo Albums', 'Advanced Photo Albums Plugin', '4.9.4p4', 1, 'extra') ;
--
