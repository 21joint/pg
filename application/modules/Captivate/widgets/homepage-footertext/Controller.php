 ...
 */
class Captivate_Widget_HomepageFootertextController extends Engine_Content_Widget_Abstract {
    ...
    public function indexAction() {
        ...
        $captivate_landing_page_footertext = Zend_Registry::isRegistered('captivate_landing_page_footertext') ? Zend_Registry::get('captivate_landing_page_footertext') : null;
        if (empty($captivate_landing_page_footertext)) {
