...
<?php if (!$this->viewer()->getIdentity()): ?>
    <h3>
        <?php echo $this->translate("_CAPTIVATE_FOOTER_TITLE"); ?>
    </h3>

    <p class="desc-text">
        <?php echo $this->translate("_CAPTIVATE_FOOTER_DESCRIPTION"); ?>
    </p>
    ...
    <div class="signupblock">
        ...
        <?php else: ?>
            <a href="<?php echo $this->url(array(), "user_signup", true) ?>"><?php echo $this->translate("_CAPTIVATE_FOOTER_BUTTON_TEXT"); ?></a>
        <?php endif; ?>
    </div>
<?php endif; ?>
