 ...
 */
class Captivate_Form_Admin_Layout extends Engine_Form {
    ...
    public function init() {
        ...
        $page_id = Engine_Api::_()->captivate()->getBackupHomePageId();
...
[<strong>Recommendation</strong>: You need to place widgets related to content from ‘Layout Editor’, to beautifying your demo like us.]",
                ...
                'value' => $coreSettings->getSetting('captivate.landing.page.layout', 0)
            ));
