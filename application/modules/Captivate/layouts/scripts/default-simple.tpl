 ...
 * @version    $Id: default-simple.tpl 2015-06-04 00:00:00Z SocialEngineAddOns $
...
<?php echo $this->headScript()->captureStart(Zend_View_Helper_Placeholder_Container_Abstract::PREPEND) ?>
            ...
            en4.core.loader = new Element('img', {src: en4.core.staticBaseUrl + 'application/modules/Seaocore/externals/images/core/loading.gif'});
