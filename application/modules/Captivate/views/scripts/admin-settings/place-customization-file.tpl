...
<form method="post" class="global_form_popup">
    <div>
        ...
        <p>
            <?php
            echo $this->translate("You are about to create a new file “customization.css file” over here '/application/themes/captivate/'. Are you sure you want to create this file?");
            ?>		
        </p>
        <br />
        <p>
