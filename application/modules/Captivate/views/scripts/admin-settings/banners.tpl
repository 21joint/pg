            ...
            <ul id='menu_list'>
                <?php foreach ($this->list as $item): ?>
                    <li id="content_<?php echo $item->getIdentity(); ?>" class="admin_table_bold item_label">
                        ...
                        <div class="center" style="width:30%;text-align:center;">
                            <?php
                            $iconSrc = Engine_Api::_()->captivate()->displayPhoto($item->icon_id, 'thumb.icon');
                            if (!empty($iconSrc)):
                                ?>
                        ...
                        <div class="center" style="width:8%;text-align:center;">
                            <a href='<?php echo $this->url(array("module" => "captivate", "controller" => "settings", "action" => 'enabled-banners', 'id' => $item->getIdentity()), "admin_default", true) ?>' >
                        ...
                        <div class="center" style="width:8%;text-align:center;">
                            <a href='<?php echo $this->url(array("module" => "captivate", "controller" => "settings", "action" => 'delete-banners', 'id' => $item->getIdentity()), "admin_default", true) ?>' class="smoothbox"><?php echo "Delete"; ?></a>
                        </div>
