...
<br />
<p>
    <a href='<?php echo $this->url(array("module" => "captivate", "controller" => "settings", "action" => 'add-images'), "admin_default", true) ?>' class="smoothbox buttonlink seaocore_icon_add"><?php echo $this->translate("Add New Image"); ?></a>
</p>
            ...
            <ul id='menu_list'>
                <?php foreach ($this->list as $item): ?>
                    <li id="content_<?php echo $item->getIdentity(); ?>" class="admin_table_bold item_label">
                        ...
                        <div class="center" style="width:8%;text-align:center;">
                            <a href='<?php echo $this->url(array("module" => "captivate", "controller" => "settings", "action" => 'enabled', 'id' => $item->getIdentity()), "admin_default", true) ?>' >
                        ...
                        <div class="center" style="width:8%;text-align:center;">
                            <a href='<?php echo $this->url(array("module" => "captivate", "controller" => "settings", "action" => 'delete', 'id' => $item->getIdentity()), "admin_default", true) ?>' class="smoothbox"><?php echo "Delete"; ?></a>
                        </div>
