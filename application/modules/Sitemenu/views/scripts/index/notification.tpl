...
<div class="seocore-pulldown-header">
  <span class="seocore-pulldown-heading"><?php echo $this->translate("Notifications") ?></span>
</div>

<div class='seocore_pulldown_item_list'>
<?php if( $this->notifications->getTotalItemCount() > 0 ): $temp_flag = 1;  ?>
	<div id="sitemenu_notification_main_right_content_area">
    <div id="sitemenu_notification_scroll_main_right_content" class="sitemenu_scroll_content">
...
<div class="seocore-pulldown-footer">
   ...
   <a href="javascript:void(0)" onclick="advancedMenuMarkNotificationsAsRead();" class="fright ui-link">
...
<script type="text/javascript">
  en4.core.runonce.add(function(){
		new SEAOMooVerticalScroll('sitemenu_notification_main_right_content_area', 'sitemenu_notification_scroll_main_right_content', {});
    $('notifications_main').addEvent('click', function(event){
      event.stop(); //Prevents the browser from following the link.
      advancedMenuNotificationClick(event);
    });
  });
</script>