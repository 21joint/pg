    ...
    public function indexAction() {
        ...
        if (empty($viewer_id)) {
            $tempClassArray = array(
                ...
                'Sitesubscription_Plugin_Signup_Subscription',
        ...
        $isSitemagentoEnabled = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitemagento');
        ...
        if ($isSitemagentoEnabled) {
            $cartInfo = Engine_Api::_()->sitemagento()->getCartInfo();
            $this->view->productCount = !empty($cartInfo['items_qty'])?$cartInfo['items_qty']:0;
