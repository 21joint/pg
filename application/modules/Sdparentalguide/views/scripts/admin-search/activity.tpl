...
<div class="admin_table_form sd_layout_middle">
    <table class='admin_table'>
        <thead>
            <tr>
                <th><a href="javascript:void(0);" onclick="changeOrder(this, 'search_text','<?php echo $this->order ;?>')"><?php echo $this->translate("Search Activity") ?></a></th>
                <th><a href="javascript:void(0);" onclick="changeOrder(this, 'gg_user_created', '<?php echo $this->order ;?>')"><?php echo $this->translate("User") ?></a></th>
                ...
                ?>
                    <tr>
                        ...
                        <td class='admin_table_bold'>
                            <?php echo $this->string()->truncate($user->getTitle(), 10); ?>
                        </td>
