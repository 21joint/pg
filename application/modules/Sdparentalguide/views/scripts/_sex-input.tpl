<div class="container p-0" id="family-information"> 
    <div class="row add-child-form d-block mx-0 border-0">
        <div class="col-12 d-flex add-gender p-0 mb-4" id="add-gender"> 
            <div class="col-3 col-xl-2 col-lg-2 mr-1 p-0 text-center male small add-gender-items <?php if($this->subject()->gg_gender == 1): ?> selected<?php endif; ?>">
            ...
            <div class="col-3 col-xl-2 col-lg-2  mr-1 p-0 p-0 text-center female small add-gender-items <?php if($this->subject()->gg_gender == 2): ?> selected<?php endif; ?>">
            ...
            <div class="col-3 col-xl-2 col-lg-2 mr-1 p-0 text-center d-flex align-items-center small not-to-answer add-gender-items <?php if($this->subject()->gg_gender == 3): ?> selected<?php endif; ?>">
                <a href="javascript:void(0)" onclick="selectGender(3, this)" class="d-block p-2">
                    <?= $this->translate('Prefer Not to Answer'); ?>
                </a>
            </div>
            <input type="hidden" name="profile_gender" id="profile_gender" value="<?= $this->subject()->gg_gender; ?>"/>
            <input type="hidden" name="<?= $this->name; ?>" id="<?= $this->name; ?>" class="field_container" value="<?= $this->subject()->gg_gender; ?>">
        </div>
