<div id="<?= $this->name; ?>-wrapper" class="form-group-heading" style="margin-bottom: 1rem;">
    <span class="field_container">
        <?= $this->translate('Tell us about your kids'); ?>
    </span>
</div>
...
<div class="container p-0 col-12 col-sm-12" id="family-information">
    ...
    <?php foreach($families as $item): ?>
        <div class="row d-flex align-items-center my-4 mx-0" id="<?= $item->getIdentity(); ?>">
            ...
            <input type="hidden" name="family_<?= $item->getIdentity(); ?>[gender]" id="field-gender" value="<?= $item->gender; ?>">
            <input type="hidden" name="family_<?= $item->getIdentity(); ?>[birthday]" id="field-birthday" value="<?= $item->dob; ?>">
