...
<div class="container p-0 col-12 col-sm-12" id="family-information">
    ...
    <div class="row add-child-form add-another-child my-5 mx-0 py-4" id="add-child-form">
        ...
        <div class="col-12 d-flex add-gender p-0 mb-4" id="add-gender">
            <div class="col-2 mr-1 p-0 text-center male small add-gender-items add-gender-items-family">
            ...
            <div class="col-2 mr-1 p-0 p-0 text-center female small add-gender-items add-gender-items-family">
            ...
            <div class="col-2 mr-1 p-0 text-center d-flex align-items-center small not-to-answer add-gender-items add-gender-items-family">
