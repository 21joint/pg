...
<div class="holder-familyMember mt-0 mt-sm-5">
    ...
    <div class="bg-white mb-2">
        <div class="holder p-5">
            <h1 class="text-primary font-weight-light mb-3">
                <?= $this->translate('Tell Us About You and Your Family'); ?>
            </h1>
            <p class="desc font-weight-light small">
                <?= $this->translate('Sdparentalguide_Form_Signup_FAMILY_Description'); ?>
            </p>
        </div>
    </div>
    ...
    <div class="bg-white p-4 mb-2">
        <div class="form-group-heading ">
            <h5 class="pb-2 mb-4"><?= $this->translate('Tell Us About Yourself'); ?></h5>
        </div>
        <!-- Gender holder -->
        <div class="form-group p-4">
            <div class="form-element">
                <div class="form-group-heading  ">
                    <h6 class="pb-2 d-flex align-items-center"> <?= $this->translate('Gender'); ?></h6>
                </div>
                        ...
                        <div class="col-12 col-xl-12 col-lg-12 d-flex add-gender p-0 mb-4" id="add-gender"> 
                            ...
                            <div class="col-sm-3 col-xl-2 col-lg-2 mr-1 p-0 text-center d-flex align-items-center small not-to-answer add-gender-items">
                                <a href="javascript:void(0)" onclick="selectGender(3, this)" class="d-block p-2 text-center">
                                    <?= $this->translate('Prefer Not to Answer'); ?>
                                </a>
                            </div>
        ...
        <div class="form-group p-4">
            <div class="form-element">
                <div class="form-group-heading  ">
                    <h6 class="pb-2 d-flex  align-items-center"> <?= $this->translate('Age Range'); ?><p class="text-muted "> (<?= $this->translate('if you don\'t want to tell us your actual birthday');?>) </p>  </h6>
                </div>
    ...
    <div class="bg-white p-4 mb-2">
        <div class="form-group">
            ...
            <div class="form-group-heading h5 pb-2 text-muted">
                <h5><?= $this->translate('Do you have any children?'); ?></h5>
            </div>
                    ...
                    <div class="row add-child-form add-another-child my-5 mx-0 py-4" id="add-child-form">
                        ...
                        <div class="col-6 p-0">
                            <p class="font-weight-normal">
                                <?= $this->translate('Tell us their gender'); ?>
                            </p>
                        </div>
                        ...
                        <div class="col-12 p-0">
                            <span class="font-weight-normal">
                                <?= $this->translate('What is their age'); ?> 
                                <span class="text-muted small">(<?= $this->translate('This helps us to better provide and recommend products and content'); ?>)</span>
                            </span>
                        </div>
                        ...
                        <div class="col-12 d-flex justify-content-center add-child py-3 px-0">
                            <div class="add-child-holder">
                                <a href="javascript:void(0);" onclick="addChild(0)" class="text-muted" id="add-child-button">
                                    ...
                                    <?= $this->translate('Add another child'); ?>
                                </a>
                            </div>
                        </div>
...
function setupFamilyMember() {
    ...
    if(gender == 3) {
        ...
        genderType = '<?= $this->translate("Unknown"); ?>';
    } else if ( gender == '1' ) {
        ...
        genderType = '<?= $this->translate("Male"); ?>';
    } else if ( gender == '2' ) {
        ...
        genderType = '<?= $this->translate("Female"); ?>';
    }
