...
<div class="leaderboard d-flex flex-column justify-content-center align-items-center">
  ...
  <a id="seeMore" class="btn-large btn-success text-white text-capitalize font-weight-bold mt-5 mb-4 px-5 py-3">See
    More</a>
</div>
<div class="mvps">
...
<div class="faq_main my-5 py-5 d-flex flex-column align-items-center justify-content-center ">
  ...
  <div class="faq_content w-100">
    <div class="faq_item mt-4 pb-4">
      ...
      <p class="faq_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum pretium scelerisque
