<header class="border-bottom py-3 extfox-header">
    <div class="container">
        <div class="row d-flex align-items-center">
            ...
            <div class="col-4 p-0 mini-menu" id="core_menu_mini_menu_extfox">

                <ul class="list-inline profile-items w-100 d-flex justify-content-end align-items-center">
