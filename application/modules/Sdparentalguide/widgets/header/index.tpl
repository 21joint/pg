...
<header class="border-bottom py-3 extfox-header">
    <div class="container">
        ...
        <div class="row d-flex align-items-center">
          <div class="holder-logo col-lg-2 col-md-4 col-5">
            ...
            <div class="col-lg-4 offset-lg-2  p-0 search d-none d-sm-block">
            ...
            <div class=" col-lg-3 col-md-6 col-6  p-0 mini-menu" id="core_menu_mini_menu_extfox">
