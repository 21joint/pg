                ...
                <ul class="list-inline profile-items w-100 d-flex justify-content-sm-end  align-items-center">
                    ...
                    <li class="line-inline-item pr-4 position-relative notifications">
                        <a href="javascript:void(0)" class="core_mini_update updates_toogle">
                            ...
                            <span class="tip-notifications position-absolute">
                                <span>
                            ...
                            <div class="pulldown_contents_wrapper">
                                ...
                                <div class="pulldown_contents">
                                    <ul class="notifications_menu" id="notifications_menu">
                                        <div class="notifications_loading d-flex justify-content-center align-items-center font-weight-light small py-4" id="notifications_loading">
                    ...
                    <li class="list-inline-item profile-img">
...
<script type='text/javascript'>
  ...
  // profile options
  let profile_options = document.getElementById('profile_options');
  let menu_dropdown = document.getElementById('menu_dropdown');

  profile_options.addEventListener('click', function() {
      showDropdownItem(menu_dropdown);
  });
