<header class="extfox-header">

  <div class="border-bottom py-3 top-menu">
    <div class="container">
                ...
                <ul class="list-inline profile-items w-100 d-flex justify-content-sm-end justify-content-center align-items-center">
                    ...
                    <li class="list-inline-item name d-none d-sm-block position-relative">
                        ...
                        <div class="item-profile-dropdown position-absolute" id="profile-dropdown-menu">
                          <ul>
                            <div class="items-profile-info border-bottom px-4 py-3">
  ...
  <div class="border-bottom bottom-menu d-sm-block d-none parental-mobile-menu-holder" id="parental-mobile-menu-holder">
      ...
      <div class="row d-flex align-items-center justify-content-center">
          ...
          <div class="d-flex align-items-center">
            <ul class="list-inline">
              ...
              <li class="list-inline-item">
                <a href="<?php echo $this->baseUrl(); ?>/reviews/home">
              ...
              <li class="list-inline-item">
                <a href="<?php echo $this->url(array(), 'listing_struggles', true); ?>">
              ...
              <li class="list-inline-item">
                <a href="<?php echo $this->baseUrl(); ?>/community/home">
                  <?php echo $this->translate('Our Community'); ?>
                </a>
              </li>
