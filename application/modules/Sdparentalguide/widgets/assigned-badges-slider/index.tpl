  ...
  <ul class="seaocore_photo_strips slides">
    <?php foreach ($this->assignedBadges as $badge): ?>
      <li class="thumb_photo">
        <?= $this->itemPhoto(
          $badge, 'thumb.profile', $badge->getTitle(),
          array('title' => $badge->getTitle(), 'class' => 'thumb_img')
        ); ?>
      </li>
    <?php endforeach; ?>
  </ul>
...
<?= $this->headLink()->appendStylesheet(
  $this->layout()->staticBaseUrl
  .'application/modules/Sdparentalguide/externals/scripts/flexslider/flexslider.css'
); ?>
<script type="text/javascript" src="<?= $this->layout(
)->staticBaseUrl; ?>application/modules/Sdparentalguide/externals/scripts/flexslider/jquery.min.js"></script>
<script type="text/javascript">var sdjq = $.noConflict();</script>
<script type="text/javascript" src="<?= $this->layout(
)->staticBaseUrl; ?>application/modules/Sdparentalguide/externals/scripts/flexslider/jquery.flexslider-min.js"></script>
