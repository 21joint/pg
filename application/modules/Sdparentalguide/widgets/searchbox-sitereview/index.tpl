...
<script type="text/javascript">
  ...
  {
    var item_count = 0;
    $("title").addEvent((Browser.Engine.trident || Browser.Engine.webkit) ? 'keydown' : 'keypress',function(e){
        if(e.key == 'enter') {
            e.preventDefault();
            setTimeout(function(){ contentAutocomplete.request.cancel(); },350);
            setTimeout(function(){ contentAutocomplete.request.cancel(); },500);  
            loadAjaxListings();
