...
<?php else: ?>
  ...
  <?php foreach ($this->listings as $sitereview): ?>
    ...
    <div class="seaocore_list_wrapper" style="width:<?= $this->params['itemWidth'] ?>px;">
      <div class="seaocore_board_list b_medium <?= $sitereview->featured; ?>_featured" style="width:<?= $this->params['itemWidth'] - 18 ?>px;">
        <div>
          <?php if ($sitereview->featured): ?>
            <span class="seaocore_list_featured_label sd_featured_img" title="<?= $this->translate('Featured'); ?>"><img src='<?= $this->layout()->staticBaseUrl; ?>application/modules/Sdparentalguide/externals/images/featured_small2.png'/></span>
	    ...
	    <?= $this->itemPhoto($sitereview, ($this->params['itemWidth']>300)?'thumb.main':'thumb.profile', '', $options); ?>
          ...
          <div class="seaocore_board_list_btm">
            ...
            <div class="o_hidden seaocore_stats seaocore_txt_light">
              <?php if ($this->postedby): ?>
                <b><?= $this->htmlLink($sitereview->getOwner()->getHref(), $sitereview->getOwner()->getTitle()) ?></b><br />
              <?php endif; ?>
  ...
  <?php if (!$this->autoload && !$this->is_ajax_load): ?>
    ...
    <div class="seaocore_loading dnone" id="seaocore_loading_<?= $this->identity ?>" >
      <img src="<?= $this->layout()->staticBaseUrl; ?>application/modules/Seaocore/externals/images/core/loading.gif" style="margin-right: 5px;">
