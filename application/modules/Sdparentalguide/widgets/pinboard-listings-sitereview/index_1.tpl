...
<?php else: ?>
  ...
  <?php foreach ($this->listings as $sitereview): ?>
    ...
    <div class="seaocore_list_wrapper" style="width:<?php echo $this->params['itemWidth'] ?>px;">
      <div class="seaocore_board_list b_medium <?php echo $sitereview->featured; ?>_featured" style="width:<?php echo $this->params['itemWidth'] - 18 ?>px;">
        <div>
          <?php if ($sitereview->featured): ?>
            <span class="seaocore_list_featured_label sd_featured_img" title="<?php echo $this->translate('Featured'); ?>"><img src='<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Sdparentalguide/externals/images/featured_small2.png'/></span>
