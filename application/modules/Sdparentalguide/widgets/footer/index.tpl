    ...
    <defs>
      <symbol id="prgLogo" viewBox="0 0 480.81 171.45">
        ...
        <path d="M967,566.67a16.93,16.93,0,0,1-1.36,6.77,17.37,17.37,0,0,1-3.72,5.51,17.68,17.68,0,0,1-5.53,3.71,17.48,17.48,0,0,1-13.53,0,17.31,17.31,0,0,1-9.22-9.22,16.92,16.92,0,0,1-1.36-6.77V540.61H941v26.07a8.37,8.37,0,0,0,.68,3.36,8.72,8.72,0,0,0,4.63,4.62,8.71,8.71,0,0,0,6.75,0,8.72,8.72,0,0,0,4.63-4.62,8.37,8.37,0,0,0,.68-3.36V540.61H967Z"
              transform="translate(-720 -453.29)" fill="#90847a"></path>
        <path d="M985.67,584H977V540.61h8.69Z" transform="translate(-720 -453.29)" fill="#90847a"></path>
      ...
      <symbol id="prgSearch" viewBox="0 0 22 22">
        <path d="M20.855,19.231l-4.979-4.979a.487.487,0,0,0-.349-.144h-.541a8.529,8.529,0,1,0-.878.878v.541a.5.5,0,0,0,.144.349l4.979,4.979a.493.493,0,0,0,.7,0l.927-.927A.493.493,0,0,0,20.855,19.231ZM8.531,15.093a6.562,6.562,0,1,1,6.562-6.562A6.56,6.56,0,0,1,8.531,15.093Z"></path>
      </symbol>
    </defs>
  </svg>
</div>