                ...
                <div class="section-two col-sm-11 col-md-3 mb-4 mb-md-0">
                    ...
                    <div class="description-holder">
                        <ul>
                            ...
                            <li class="mb-2">
                                <a class="font-weight-light" href="http://www.guidanceguide.com/about.php"
                                   target="_blank">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <a href="javascript:void(0);">
                                    <svg width="12px" height="12px" aria-hidden="true" data-prefix="fab"
                            ...
                            <li class="list-inline-item">
                                <a href="javascript:void(0);">
                                    <svg width="12px" aria-hidden="true" data-prefix="fab" data-icon="twitter"
                            ...
                            <li class="list-inline-item">
                                <a href="javascript:void(0);">
                                    <svg height="13px" aria-hidden="true" data-prefix="fab" data-icon="pinterest-p"
