...
<div class="container px-0">
    <div class="d-flex justify-content-between align-items-start">
        <div class="search_results_filter bg-white px-3 py-3 mr-2">
            ...
            <input id="search_type_reviews" type="radio" name="search_type" value="reviews" checked/>Reviews<br/>
            <!-- Write IF ELSE in Ajax -->
            <input id="search_type_questions" type="radio" name="search_type" value="questions"/>Struggles
        </div>
...
<script type="text/javascript">
    ...
    document.getElementById('search_again').addEventListener('click', function(){
        ...
        loadSearchResults(search_again, search_type);
    });
    ...
    function loadSearchResults(search_param, search_type = "reviews"){
