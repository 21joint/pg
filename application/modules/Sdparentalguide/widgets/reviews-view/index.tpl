                  ...
                  <ul class="d-flex flex-wrap list-unstyled">
                    <li class="col-4 p-1">
                      <div class="embed-responsive embed-responsive-1by1"
                           style="background-position: center; background-image: url(https://via.placeholder.com/246x246);">
                        <img class="position-absolute w-100 h-100 hidden"
                             src="https://via.placeholder.com/246x246"
                             alt="">
                      </div>
                    </li>
                    <li class="col-4 p-1">
