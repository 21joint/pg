...
<div class="prg-review--single">
  ...
  <div class="prg-review--single---hero position-relative">
    <div class="prg-review--single---image"
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="prg-review--single---stars">
            <div class="card-stars text-center">
          ...
          <div class="prg-review--single---action">
            <button type="button" class="btn bg-white rounded-circle"><i class="fa-comment-dots"></i></button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="prg-review--single---content">
    <div class="container">
      <div class="row">
        <div class="col-sm-9">
          <h1 class="prg-review--single---title text-primary font-weight-bold mb-5">Twisted Mustard Seed Heartbreaker
            Bag</h1>
          <div class="prg-review--single---descr">
            <p>We love our gorgeous Twisted Mustard Seed Diaper Bag! It is absolutely beautiful. The pop of color is so
              fun
              and adds a lot to your everyday wardrobe. :) What I love most is how it is functional but doesn't even
              look like
              a diaper bag because it is so pretty. This bag truly is designed for moms!
            </p>
            <p>
              I love that it is simple in design. There's not too many pockets and not too much going on on the outside
              either. It does what it needs to and is gorgeous. It is definitely a timeless diaper bag!
            </p>
            <p>The exterior is made from genuine cowhide leather in a super gorgeous turquoise blue color. The inside is
              black
              with white polka dots and is such a fun contrast! I always love getting out my changing pad. This diaper
              bag is
              just soo classy and pretty with some gold accents on the lettering and feet. <3
            </p>
            <p>Probably the greatest part about it is the way it looks because it means that even after you are finished
              with
            ...
            <p>
              ...
              strap. I
              personally love using messenger straps so that is always what I do! It also came with a changing pad and
              stroller straps.
