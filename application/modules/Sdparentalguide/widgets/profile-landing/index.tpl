        ...
        <div class="holder p-4">
          <div class="top border-bottom border-gray pb-3">
            <h5 class="text-primary font-weight-bold">
                <?= $this->subject->gg_contribution; ?>
            </h5>
            <p class="desc text-dark">
                <?= $this->translate('Contribution points'); ?>
            </p>
          </div>
          ...
          <div class="bottom row pt-4">
            ...
            <div class="col-sm col-5 col-xl-3 col-lg-3 text-center border-left">
              <h5 class="text-primary font-weight-bold">
                  <?= $this->subject->member_count; ?>
              </h5>
              <p class="desc text-dark">
                  <?= $this->translate('Struggles'); ?>
              </p>
            </div>
          </div>
          ...
          <div class="bottom row pt-4">
            ...
            <div class="col-2 text-center">
              <div class="col-sm px-0 platinium">
                <div class="badge-holder d-flex align-items-center justify-content-center font-weight-bold text-white">
                    <?= $this->subject->gg_platinum_count; ?>
                </div>
              </div>
            ...
            <div class="holder p-4">
                ...
                <div class="holder text-left">
                  <p class="desc title text-dark">
                    ...
                    <span class="total text-primary">
                                    <?= $this->friends->getTotalItemCount(); ?>
                                    </span>
                  </p>
                </div>
                <div class="holder text-right">
              ...
              <div class="row pt-4 bottom followers">
                  ...
                  <?php foreach ($this->friends as $membership):
                      ...
                      ?>
                    <div class="col-sm-4 m-2 py-3 item-holder" id="user_friend_<?= $member->getIdentity() ?>">
                      <div class=" text-center">
                          <?= $this->htmlLink($member->getHref(), $this->itemPhoto($member, 'thumb.icon'), array('class' => 'profile_friends_icon')) ?>

                      </div>
                        <?= $this->htmlLink($member->getHref(), $member->getTitle(), array('class' => 'text-center w-100 d-block font-weight-bold')) ?>
                    </div>
                  <?php endforeach; ?>
              </div>
            </div>
      ...
      <div class="latest-review bg-white mb-4 widget">
        <div class="holder p-4">
          ...
          <div class="d-flex justify-content-between border-bottom pb-3">
            <div class="holder text-left">
              <p class="desc title text-dark">
                  <?= $this->translate('Latest Reviews'); ?>
              </p>
            </div>
            <div class="holder text-right">
              <a href="javascript:void(0)" class="text-primary"> <?= $this->translate('view all'); ?> </a>
            </div>
          </div>

          <div class="bottom small text-muted pt-4">
              <?= $this->translate('“Coming Soon”'); ?>
          </div>
      ...
      <div class="latest-strugles bg-white widget">
        ...
        <div class="holder p-4">
          ...
          <div class="d-flex justify-content-between border-bottom pb-3">
            <div class="holder text-left">
              <p class="desc title text-dark">
                  <?= $this->translate('Latest Struggles'); ?>
              </p>
            </div>
            <div class="holder text-right">
              <a id="pokusaj"
                 class="text-primary"
                 href="javascript:void(0)"> <?php echo $this->translate('view all'); ?></a>
            </div>
          </div>
...
<script>
  ...
  en4.core.runonce.add(function () {
    ...
    for (var i = 0; i < liElements.length; i++) {
      let getParam = '<?= $this->profileSettings; ?>';
