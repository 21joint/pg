...
$this->headScript()->appendFile(
  ...
  .'application/modules/Ggcommunity/externals/scripts/swiper.min.js'
);
      ...
      <div class="contribution bg-white mb-4 widget">
        <div class="holder p-4">
          ...
          <div class="bottom row pt-4">
            <div
              class="col-sm col-5 col-xl-3 col-lg-3  text-center border-right">
              <h5 class="text-primary font-weight-bold">
                  ...
                  <?php foreach ($this->specialBadges as $special): ?>
                    <div class="swiper-slide mb-0">
                      <a href="javascript:void(0)">
                        <?php echo $this->itemPhoto(
                          $special, 'thumb.normal'
                        ); ?>
                      </a>
                    </div>
                  <?php endforeach; ?>
      ...
      <div class="latest-reviews bg-white mb-4 widget">
        <div class="holder p-4">
          ...
          <div class="d-flex justify-content-between border-bottom pb-3">
            ...
            <div class="holder text-right">
              <a href="javascript:void(0)"
                 class="text-primary"> <?php echo $this->translate(
                  'view all'
                ); ?> </a>
            </div>
          </div>
...
<script>
  ...
  function loadQuestionResults() {
    ...
    var request = new Request.JSON({
      ...
      method: 'get',
      data: requestData,
      onRequest: function () { /*loader.inject($("sd-response"));*/
        ...
        if (responseJSON.status_code == 200) {
          ...
          document.querySelectorAll('.avatar_halo').forEach(function (avatar_halo) {
            if (avatar_halo.dataset.halo == "true") {
              ...
              ); ?>/application/themes/guidanceguide/assets/images/border.png') 20 20 20 20 fill";
            }
          });
