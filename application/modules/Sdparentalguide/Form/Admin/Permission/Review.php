...
class Sdparentalguide_Form_Admin_Permission_Review extends Authorization_Form_Admin_Level_Abstract {
    ...
    public function init() {
        ...
        if ($listingTypeCount > 1) {
            $this->addElement('Select', 'listingtype_id', array(
                ...
                'multiOptions' => array_merge(array('0' => 'All Listing Types'),$listingTypes),
                'value' => '0'
            ));
        }
        ...
        if (!$this->isPublic()) {
            ...
            $rate_product_element = "rate_product_listtype_$listingtype_id";
            $this->addElement('Radio', "$rate_product_element", array(
                'label' => 'Allow Product Rating',
                'description' => 'Do you want to let members to rate their reviews?',
                'multiOptions' => array(
                    1 => 'Yes, allow members to rate their own reviews.',
                    0 => 'No, do not allow members to rate their reviews.',
                ),
                'value' => 1,
            ));
            
            $rate_author_element = "rate_author_listtype_$listingtype_id";
            $this->addElement('Radio', "$rate_author_element", array(
                'label' => 'Allow Author Rating?',
                'description' => 'Do you want to let members to rate author reviews?',
                'multiOptions' => array(
                    1 => 'Yes, allow members to rate their author reviews.',
                    0 => 'No, do not allow members to rate author reviews.',
                ),
                'value' => 1,
            ));
            
            $flat_element = "flag_listtype_$listingtype_id";
            $this->addElement('Radio', "$flat_element", array(
                'label' => 'Allow Flag?',
                'description' => 'Do you want to let members to flag reviews?',
                'multiOptions' => array(
                    1 => 'Yes, allow members to flag reviews.',
                    0 => 'No, do not allow members to flag reviews.',
                ),
                'value' => 1,
            ));
