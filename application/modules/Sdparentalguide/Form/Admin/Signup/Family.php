...
class Sdparentalguide_Form_Admin_Signup_Family extends Engine_Form
{
  public function init()
  {
    ...
    // Custom
    $this->setTitle($this->getView()->translate('%1$s: Family Members', $stepString));
    
    // Element: enable
    $this->addElement('Radio', 'enable', array(
      'label' => 'Family Members',
      'description' => 'SDPARENTALGUIDE_FORM_ADMIN_SIGNUP_FAMILY_ENABLE_DESCRIPTION',
      'multiOptions' => array(
        '1' => 'Yes, include the "Family Members" step during signup.',
