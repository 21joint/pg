...
class Album_IndexController extends Siteapi_Controller_Action_Standard {
    ...
    public function browseAction() {
        ...
        if (isset($userId) && !empty($userId) && $userId == $viewer_id) {
    ...
    public function uploadAction() {
        ...
        if ($this->getRequest()->isGet()) {
            ...
            if (!isset($values['album_id']) && isset($_REQUEST['album_id']) && !empty($_REQUEST['album_id']))
            ...
            try {
                ...
                if ($action != null) {
                    Engine_Api::_()->getDbtable('actions', 'activity')->attachActivity($action, $album);
                }
