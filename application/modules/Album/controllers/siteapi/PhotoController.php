...
//            return;
    ...
    public function listAction() {
        ...
        if (empty($_FILES) && $this->getRequest()->isGet()) {
            ...
            $params['order'] = $this->getRequestParam('order', null);
...
//                        );
            ...
            $bodyResponse['totalPhotoCount'] = 0;
            if (isset($bodyResponse['photos']) && !empty($bodyResponse['photos']))
                $bodyResponse['totalPhotoCount'] = count($bodyResponse['photos']);
