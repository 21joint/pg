 ...
 */
class Sitepage_Api_MobilelayoutCore extends Core_Api_Abstract {
    ...
    public function setWithoutTabContent($page_id, $sitepage_layout_cover_photo) {
        ...
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('advancedactivity')) {
            ...
            Engine_Api::_()->sitepage()->setDefaultDataWidget($contentTable, $contentTableName, $page_id, 'widget', 'activity.feed', $middle_id, 6, 'Updates', 'true');
        }
        ...
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitevideo')) {
            $this->setDefaultInfoWithoutTab('sitevideo.contenttype-videos', $page_id, 'Videos', 'true', '111');
        }
        ...
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('document')) {
            $this->setDefaultInfoWithoutTab('document.contenttype-documents', $page_id, 'Documents', 'true', '115');
        }
        ...
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding')) {
            $this->setDefaultInfoWithoutTab('sitecrowdfunding.contenttype-projects', $page_id, 'Projects', 'true', '125');
        }
    }
    ...
    public function setTabbedLayoutContent($page_id, $sitepage_layout_cover_photo) {
        ...
        //INSERTING EVENT WIDGET 
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitevideo')) {
            $this->setContentDefaultInfo('sitevideo.contenttype-videos', $page_id, 'Videos', 'true', '111');
        }
        ...
        //INSERTING DOCUMENT WIDGET 
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('document')) {
            $this->setContentDefaultInfo('document.contenttype-documents', $page_id, 'Documents', 'true', '115');
        }
        ...
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding')) {
            $this->setContentDefaultInfo('sitecrowdfunding.contenttype-projects', $page_id, 'Projects', 'true', '125');
        }
    }
    ...
    public function setContentDefaultLayout($page_id) {
        ...
        foreach ($admintableinfo as $value) {
            $mainContainer = $contentTable->createRow();
            $mainContainer->mobilecontentpage_id = $page_id;
            $mainContainer->type = 'container';
        ...
        //SELECT ADMIN CONTENT
        $admincontentselected = $admincontentTable->select()->where('page_id =?', $corepageinfo->page_id)->where('type =?', 'widget')->where('name =?', 'sitemobile.container-tabs-columns');
        ...
        foreach ($admintableinfo as $values) {
            ...
            $mainWidgets->mobilecontentpage_id = $page_id;
                            ...
                            if (!empty($check_sitedocument)) {
                                ...
                                foreach ($results as $value) {
                                    ...
                                    $select
                                            ...
                                            ->where('type = ?', 'widget')
                                            ->where('name = ?', 'sitepageintegration.profile-items')
                                            ->where('params = ?', '{"title":"Documents","resource_type":"document_0","nomobile":"0","name":"sitepageintegration.profile-items"}');
                                    $info = $select->query()->fetch();
                                    if (empty($info)) {
                                        ...
                                        $db->insert('engine4_core_content', array(
                                            ...
                                            'parent_content_id' => $middle_id,
                                            'order' => 999,
                                            'params' => '{"title":"Documents","resource_type":"document_0","nomobile":"0","name":"sitepageintegration.profile-items"}',
                                        ));
                                    }
                                }
                            }
                            ...
                            if (!empty($check_sitegroup)) {
                                ...
                                foreach ($results as $value) {
                                    ...
                                    $select
                                            ...
                                            ->where('type = ?', 'widget')
                                            ->where('name = ?', 'sitepageintegration.profile-items')
                                            ->where('params = ?', '{"title":"Groups","resource_type":"sitegroup_group_0","nomobile":"0","name":"sitepageintegration.profile-items"}');
                                    $info = $select->query()->fetch();
                                    if (empty($info)) {
                                        ...
                                        $db->insert('engine4_core_content', array(
                                            ...
                                            'parent_content_id' => $middle_id,
                                            'order' => 999,
                                            'params' => '{"title":"Groups","resource_type":"sitegroup_group_0","nomobile":"0","name":"sitepageintegration.profile-items"}',
                                        ));
                                    }
                                }
                            }
                            ...
                            if (!empty($check_sitebusiness)) {
                                ...
                                foreach ($results as $value) {
                                    ...
                                    $select
                                            ...
                                            ->where('type = ?', 'widget')
                                            ->where('name = ?', 'sitepageintegration.profile-items')
                                            ->where('params = ?', '{"title":"Businesses","resource_type":"sitebusiness_business_0","nomobile":"0","name":"sitepageintegration.profile-items"}');
                                    $info = $select->query()->fetch();
                                    if (empty($info)) {
                                        ...
                                        $db->insert('engine4_core_content', array(
                                            ...
                                            'parent_content_id' => $middle_id,
                                            'order' => 999,
                                            'params' => '{"title":"Businesses","resource_type":"sitebusiness_business_0","nomobile":"0","name":"sitepageintegration.profile-items"}',
                                        ));
                                    }
                                }
                            }
                            ...
                            if (!empty($check_list)) {
                                ...
                                foreach ($results as $value) {
                                    ...
                                    $select
                                            ...
                                            ->where('type = ?', 'widget')
                                            ->where('name = ?', 'sitepageintegration.profile-items')
                                            ->where('params = ?', '{"title":"Listings","resource_type":"list_listing_0","nomobile":"0","name":"sitepageintegration.profile-items"}');
                                    $info = $select->query()->fetch();
                                    if (empty($info)) {
                                        ...
                                        $db->insert('engine4_core_content', array(
                                            ...
                                            'parent_content_id' => $middle_id,
                                            'order' => 999,
                                            'params' => '{"title":"Listings","resource_type":"list_listing_0","nomobile":"0","name":"sitepageintegration.profile-items"}',
                                        ));
                                    }
                                    //}
                                }
