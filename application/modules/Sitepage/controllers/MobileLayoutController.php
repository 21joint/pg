...
//     $cont->setStorage($storage);
  ...
  public function updateAction() {
    ...
    try {
      ...
      //GET STRUCTURE
      $trimStructure = $this->_getParam('structure');
