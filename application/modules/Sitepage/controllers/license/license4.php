...
if ($PRODUCT_TYPE != 'sitepage') {
    include APPLICATION_PATH . "/application/modules/Sitepage/controllers/license/sitepage_plugin_check.php";
    if (empty($sitepage_version_correct))
        return;
}
$calling_from = 0;
$core_final_url = '';
