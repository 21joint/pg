...
<script type="text/javascript">
  ...
  var saveChanges = function()
  {
    ...
    var url = '<?php echo $this->url(array('action' => 'update', 'controller' => 'layout', 'module' => 'sitepage'), 'admin_default', true)?>';
  ...
  var openWidgetParamEdit = function(name, element) {
    ...
    var url = '<?php echo $this->url(array('action' => 'widget', 'controller' => 'layout', 'module' => 'sitepage'), 'admin_default', true)?>';
  ...
  var saveCurrentPageInfo = function(formElement) {
    var url = '<?php echo $this->url(array('action' => 'save', 'controller' => 'layout', 'module' => 'sitepage'), 'admin_default', true)?>';
...
<h2><?php echo $this->translate('Page Profile Layout Editor'); ?></h2>
<p>
...
<script type="text/javascript">
	...
	var widgetshowhide = function(widgetname, option) {
		  ...
		  $('backgroundimage_' + widgetname).innerHTML = '<div class="form-label"></div><div  class="form-element"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepage/externals/images/loading.gif" /></center></div>';
			var url = '<?php echo $this->url(array('action' => 'show-hide-widget', 'controller' => 'layout', 'module' => 'sitepage'), 'admin_default', true)?>';
    var request = new Request.HTML({
      'url' : url,
      'data' : {
        'format' : 'html',
