 ...
 * @version    $Id: _facyUpload.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
$this->headTranslate(array(
    ...
    '{name} could not be added, amount of {fileSitepageMax} files exceeded.',
    '{name} ({size}) is too big, overall filesize of {fileSitepageSizeMax} exceeded.',
...
<script type="text/javascript">
  ...
  window.addEvent('domready', function() { // wait for the content
    ...
    var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
       ...
       *
       * This example creates a sitepage of error elements directly in the file sitepage, which
       * hide on click.
       */
      ...
      onFileRemove: function(file) {
        ...
        request = new Request({
          //'format' : 'json',
          'url' : '<?php echo $this->url(Array('action' => 'remove'), 'sitepage_imagephoto_specific') ?>',
          'data': {
            'photo_id' : file_id,
            'album_id' : album_id,
            'page_id' : page_id,
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('Click "Add Photos" to select one or more photos from your computer. After you have selected the photos, they will begin to upload right away. When your upload is finished, click the button below your photo to save them to your page album.'); ?>
  </div>
  <div>
