 ...
 * @version    $Id: AdminBadgeController.php 2017-03-08 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitecredit_AdminBadgeController extends Core_Controller_Action_Admin {

    public function indexAction() {
        // get general badge setting
        $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
                ->getNavigation('sitecredit_admin_main', array(), 'sitecredit_admin_main_badge');

        $this->view->navigationSubMenu = $navigation = Engine_Api::_()->getApi('menus', 'core')
                ->getNavigation('sitecredit_admin_main_badge', array(), 'sitecredit_admin_badge_general');

        $this->view->form = $form = new Sitecredit_Form_Admin_Badge_General();
    ...
    public function addBadgeAction() {
        // add badge 
        $this->view->form = $form = new Sitecredit_Form_Admin_Badge_Addbadge();
