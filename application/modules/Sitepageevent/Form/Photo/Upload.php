 ...
 */
class Sitepageevent_Form_Photo_Upload extends Engine_Form {
  ...
  public function init() {
    ...
    $this
            ...
            ->setAttrib('class', 'global_form sitepageevent_form_upload')
    ...
    $this->addElement('Hidden', 'fancyuploadfileids',array( 'order' => 950,));
