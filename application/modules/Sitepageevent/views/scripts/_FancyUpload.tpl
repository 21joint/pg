 ...
 * @version    $Id: _FancyUpload.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
    ...
    var up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
      ...
      onFileRemove: function(file) {
        ...
        request = new Request.JSON({
          'format' : 'json',
          'url' : '<?php echo $this->url(Array('module' => 'sitepageevent', 'controller' => 'photo', 'action' => 'remove'), 'default') ?>',
          'data': {
            'photo_id' : file_id,
            'event_id': event_id,
            'photoremove': 1
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('Click "Add Photos" to select one or more photos from your computer. After you have selected the photos, they will begin to upload right away. When your upload is finished, click the button below your photo list to save them to your page event profile.'); ?>
  </div>
  <div>
