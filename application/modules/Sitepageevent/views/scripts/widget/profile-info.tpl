...
<div id='sitepageevent_stats'>
  <ul>
    ...
    <?php if (!empty($this->subject()->location)): ?>
      <li>
        <?php $this->translate('Location:'); ?> <?php echo $this->subject()->location; ?> [<?php echo $this->htmlLink('https://maps.google.com/?q=' . urlencode($this->subject()->location), $this->translate('map'), array('target' => 'blank')) ?>]
      </li>
    <?php endif; ?>
