      ...
      ?>
    	...
    	<?php if( !empty($this->sitepageevent_subject->location) ): ?>
    		<tr valign="top">
      		...
      		<td><?php echo $this->sitepageevent_subject->location; ?> <?php echo $this->htmlLink('https://maps.google.com/?q='.urlencode($this->sitepageevent_subject->location), $this->translate('Map'), array('target' => 'blank')) ?></td>
    		</tr>
    	<?php endif ?>
