	...
	<?php if( !empty($this->getIsEvent) ) { ?>
		<?php if( $this->eventCount > 0) :?>
			<div class="sitepage_event_profile_links">
				<a href="javascript:void(0);" onclick="Mypageevents('upcomingevent');" id='select_upcomingevent' class="selected"><?php echo $this->translate('Upcoming Events')?></a>
				|
				<a href="javascript:void(0);" onclick="Mypageevents('pastevent');" id='select_pastevent'><?php echo $this->translate('Past_Events');?></a>		
				<?php if($this->can_create): ?>
				|
				<a href="javascript:void(0);" onclick="Mypageevents('myevent');" id='select_myevent'><?php echo $this->translate('My_Events');?></a>
				<?php endif; ?>	
			</div>
		<?php endif; ?>
	<?php } ?>
