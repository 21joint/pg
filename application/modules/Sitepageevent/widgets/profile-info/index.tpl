  ...
  <ul>
    ...
    <?php if (!empty($this->subject()->location)): ?>
      <li>
        ...
        <div class="sitepageevent_stats_content"><?php echo $this->subject()->location; ?> <?php echo $this->htmlLink('https://maps.google.com/?q=' . urlencode($this->subject()->location), $this->translate('Map'), array('target' => 'blank')) ?></div>
      </li>
    <?php endif; ?>
