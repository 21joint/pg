...
//     }
        ...
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding')) {
            $this->setContentDefaultInfoWithoutTab('sitecrowdfunding.contenttype-projects', $group_id, 'Projects', 'true', '125');
        }
    }
...
// 	  }
        ...
        //INSERTING CROWDFUNDING PROJECT WIDGET
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding')) {
            $this->setDefaultInfo('sitecrowdfunding.contenttype-projects', $group_id, 'Projects', 'true', '125');
        }
}
