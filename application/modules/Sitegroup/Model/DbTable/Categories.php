...
class Sitegroup_Model_DbTable_Categories extends Engine_Db_Table {
  ...
  public function getSubCategories($category_id) {
    ...
    $select = $this->select()->from($this->info('name'), array('category_name', 'category_id', 'cat_order', 'cat_dependency', 'subcat_dependency'))->where('cat_dependency = ?', $category_id)->order('cat_order');
