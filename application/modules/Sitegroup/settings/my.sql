...
('sitegroup', 'Groups / Communities', 'Groups / Communities', '4.9.4p11', 1, 'extra');
...
INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('sitegroupalbum', 'Groups / Communities - Albums', 'Groups / Communities - Albums', '4.9.4', 1, 'extra');
...
INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('sitegroupmember', 'Groups / Communities - Group Members', 'Groups / Communities - Group Members', '4.9.4', 1, 'extra') ;
