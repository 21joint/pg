...
<style type="text/css">
  #panel-content-area {
    ...
    /*View Map*/
#global_group_sitegroup-index-view-map{
	padding:0px;
	margin:0px;
}
#global_group_sitegroup-index-view-map #global_content_simple{
	overflow:visible;
}
</style>
...
//           };
  ...
  var getDirection=function(){
		$("panel").innerHTML="<center><img src='"+en4.core.staticBaseUrl+"application/modules/Seaocore/externals/images/loading.gif' alt='' /></center>";
