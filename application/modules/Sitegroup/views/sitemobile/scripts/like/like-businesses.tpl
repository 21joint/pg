...
//	
//	//var url = sm4.core.baseUrl + 'sitegroup/index/likesitegroup';// URL where send ajax request.
//	var url = '<?php echo $this->url(array('action' => 'like-groups'), 'sitegroup_like', true);?>'; 
//	function show_myfriend () {
//		$('sitegroups_popup_content').innerHTML = '<center><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/sitegroup/externals/images/spinner.gif" /></center>';
...
//		$('sitegroups_popup_content').innerHTML = '<center><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/spinner.gif" alt="" class="mtop10" /></center>';
//      sm4.core.request.send(new Request.HTML({
//        'url' : url,
//        'data' : {
//          'format' : 'html',
