...
<script type="text/javascript">
	...
	{
		var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'admin-claim', 'action' => 'getmember'), 'default', true) ?>', {
			'postVar' : 'text',
			'minLength': 1,
			'selectMode': 'pick',
