 ...
 */
?>
<div class="global_form_popup sitegroup_claim_action_popup">
	<div class="settings">
	  <form class="global_form" method="POST">
	    <div>
	      <?php
	      $url = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('group_url' => Engine_Api::_()->sitegroup()->getGroupUrl($this->sitegroup_id)), 'sitegroup_entry_view');
	      $sitegroup_title = "<a href='$url' target='_blank'>$this->sitegroup_title</a>";
	      ?>
	      ...
	      <?php else: ?>	
	        ...
	        <p><?php echo $this->translate("Please take an appropriate action on the claim for this group: ") ?><?php echo $sitegroup_title; ?></p>
	      ...
	      <div class="form-wrapper">
	        <div class="form-label">
	          <label><?php echo $this->translate("About Claimer and Group:") ?></label>
	        </div>
	        <div class="form-element">
