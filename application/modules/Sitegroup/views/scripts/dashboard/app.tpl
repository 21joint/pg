        ...
        <div class="sitegroup_edit_content">
            ...
            <ul class="sitegroup_getstarted">
                ...
                <?php if ($this->can_create_doc): ?>
                    ...
                    <li> <?php $canShowMessage = false; ?>
                        <div class="sitegroup_getstarted_num">
                            <?php echo $this->htmlLink(array('route' => 'document_create', 'parent_id' => $this->group_id, 'parent_type' => 'sitegroup_group', 'tab' => $this->documenttab_id), '<i class="icon_app_document"></i>') ?>
                        </div>	
                        <div class="sitegroup_getstarted_des">
                            <b><?php echo $this->translate('Documents'); ?></b>
                            <p><?php echo $this->translate('Add and showcase documents on your group.'); ?></p>
                ...
                <?php if ($this->can_create_project): ?>
                    <li> <?php $canShowMessage = false; ?>
                        <div class="sitegroup_getstarted_num">
                            <?php echo $this->htmlLink(array('route' => 'sitecrowdfunding_project_general', 'group_id' => $this->group_id, 'tab' => $this->projecttab_id, 'parent_type' => 'sitegroup_group', 'parent_id' => $this->group_id), '<i class="icon_app_music"></i>') ?>
                        </div>
                        <div class="sitegroup_getstarted_des">
                            <b><?php echo $this->translate('Projects'); ?></b>
                            <p><?php echo $this->translate('Add project for this group.'); ?></p>
                            <div class="sitegroup_getstarted_btn">
                                <a href='<?php echo $this->url(array('action'=>'create','group_id' => $this->group_id, 'tab' => $this->projecttab_id, 'parent_type' => 'sitegroup_group', 'parent_id' => $this->group_id), 'sitecrowdfunding_project_general', true) ?>'><?php echo $this->translate('Add Project'); ?></a>
                                <?php echo $this->htmlLink($this->sitegroup->getHref(array('tab' => $this->projecttab_id)), $this->translate('Manage Project')) ?>
                            </div>
                        </div>
                    </li>       
                <?php endif; ?>
