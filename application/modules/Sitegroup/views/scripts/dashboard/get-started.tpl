...
<div class="generic_layout_container layout_core_content">
    ...
    <ul class="sitegroup_getstarted">
      ...
      <?php if ($this->can_create_project): ?>
		<li> <?php $canShowMessage = false; ?>
         	<div class="sitegroup_getstarted_num">
	     		<div><?php echo $i; $i++;?></div>
      		</div>
            <div class="sitegroup_getstarted_des">
                <b><?php echo $this->translate('Projects'); ?></b>
                <p><?php echo $this->translate('Add projects for this group.'); ?></p>
                <div class="sitegroup_getstarted_btn">
                    <a href='<?php echo $this->url(array('action' => 'create', 'parent_type' => 'sitegroup_group', 'parent_id' => $this->group_id,), 'sitecrowdfunding_project_general', true) ?>'><?php echo $this->translate('Add Project'); ?></a>
                    <?php echo $this->htmlLink($this->sitegroup->getHref(array('tab' => $this->projecttab_id)), $this->translate('Manage Projects')) ?>
                </div>
            </div>
        </li>
      <?php endif; ?>
