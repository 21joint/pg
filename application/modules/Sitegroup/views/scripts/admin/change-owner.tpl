 ...
 * @version    $Id: changeowner.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<script type="text/javascript">
  ...
  {
    var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'admin', 'action' => 'get-owner', 'group_id' => $this->group_id), 'default', true) ?>', {
      'postVar' : 'text',
      'minLength': 1,
      'selectMode': 'pick',
      'autocompleteType': 'tag',
      'className': 'sitegroup_categories-autosuggest',
      'customChoices' : true,
      'filterSubset' : true,
      'multiple' : false,
