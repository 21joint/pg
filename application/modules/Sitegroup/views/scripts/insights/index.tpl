...
<div class="layout_middle">
  ...
  <div id="show_tab_content">
		<div class="sitegroup_edit_insights_table">
	    <table>
				<thead>
					<tr>
		...
		<div class="sitegroup_edit_insights">
			<div>
		    <h4><?php echo $this->translate("Group Insights") ?></h4>
		    <p>
		      <?php echo $this->translate("Use the below filter to observe various metrics of your group over different time periods.") ?>
		    </p>
				<div class="sitegroup_edit_insights_search">
					<?php echo $this->filterForm->render($this) ?>
				</div>	
		    <div class="sitegroup_statistics">
		      <div class="sitegroup_edit_insights_nav">
						<a id="admin_stats_offset_previous"  class='icon_previous' onclick="processStatisticsGroup(-1);"><?php echo $this->translate("Previous") ?></a>
						<a id="admin_stats_offset_next"   class='icon_next' onclick="processStatisticsGroup(1);" style="display: none;"><?php echo $this->translate("Next") ?></a>
		      </div>
			      ...
			      <script type="text/javascript">
							...
							var processStatisticsGroup = function(count) {
