...
<div class="sitegroup_claim_turms">
  <b><?php echo $this->translate('Terms of claiming a Group') ?></b>
  <ol>
    <li><?php echo $this->translate('GROUP_TERMS_CLAIM_1') ?></li>		
    <li><?php echo $this->translate('GROUP_TERMS_CLAIM_2') ?></li>
  </ol>
  <br />
