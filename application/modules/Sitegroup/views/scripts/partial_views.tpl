...
<div class='seaocore_browse_list_info'>
    ...
    <?php endif;?>
		...
		<div class="seaocore_browse_list_info_date">
			...
			<?php  echo $this->translate("Price: "); echo Engine_Api::_()->sitegroup()->getPriceWithCurrency($item->price); ?><?php endif; ?><?php if((!empty($item->location) && $this->enableLocation) && (!empty($item->price ) && $this->enablePrice)): ?><?php  echo $this->translate(", "); ?><?php endif; ?><?php if(!empty($item->location) && $this->enableLocation): ?>
