...
<script type="text/javascript">
  ...
  var saveChanges = function()
  {
    ...
    var url = '<?php echo $this->url(array('action' => 'update', 'controller' => 'mobile-layout', 'module' => 'sitegroup'), 'default', true)?>';
  ...
  var openWidgetParamEdit = function(name, element) {
    ...
    var url = '<?php echo $this->url(array('action' => 'widget', 'controller' => 'mobile-layout', 'module' => 'sitegroup', 'group_id'=> $this->sitegroup->group_id), 'default', true)?>';
  ...
  var saveCurrentGroupInfo = function(formElement) {
    <?php if($this->adminDriven):?>
      ...
      return false;
    <?php endif;?>
    var url = '<?php echo $this->url(array('action' => 'save', 'controller' => 'mobile-layout', 'module' => 'sitegroup'), 'default', true)?>';
  ...
  {
    if( element.hasClass('grouplayout_content_widget_sitemobile.container-tabs-columns') ) {
  ...
  var deleteCurrentGroup = function() {
    ...
    var url = '<?php echo $this->url(array('action' => 'delete', 'controller' => 'mobile-layout', 'module' => 'sitegroup'), 'default', true)?>';
...
<?php if(Engine_Api::_()->sitegroup()->checkEnableForMobile('sitegroup')):?>
	<div class='tabs'>
		<ul class="navigation">
			<li >
				<?php echo $this->htmlLink(array('route'=>'default','module'=>'sitegroup','controller'=>'layout','action'=>'layout', 'group_id' => $this->sitegroup->group_id), $this->translate('Edit Group Profile Layout'), array())
				?>
			</li>
			
			<li class="active">
				<?php
				echo $this->htmlLink(array('route'=>'default','module'=>'sitegroup','controller'=>'mobile-layout','action'=>'layout', 'group_id' => $this->sitegroup->group_id), $this->translate('Edit Group Profile Layout for Mobile / Tablet'), array())
				?>
			</li>
...
<p>
	<?php echo $this->translate('Use the layout editor given below to configure the content which appears on main profile of your Group. You can drag and drop the colored "blocks" to arrange the content in the way you want them to appear at profile group. Drag blocks from or to the "Available Blocks" area to add or remove them from your group. Use "HTML Block" if you want to drop in raw HTML or other content.'); ?>
	<?php if (Engine_Api::_()->sitegroup()->hasPackageEnable()) : ?>
		<?php echo $this->translate('Note: Some blocks won\'t appear if their corresponding apps or features are not available in your group\'s package.'); ?>
	<?php else : ?>
...
<div id='grouplayout_cms_wrapper'>
		<?php $url = $this->url(array('action' => 'set-user-driven-layout', 'controller' => 'mobile-layout', 'module' => 'sitegroup', 'group_id' => $this->sitegroup->group_id), 'default', true)?>
		<?php if($this->adminDriven):?>
			<div class="tip" id="admin_driven_tip"><span><?php echo $this->translate('Below is the default layout which has been set by the site admin for all the groups. If you want to modify anything in this layout or want to add / remove any blocks on your group, then please %1$sClick here%2$s.', "<a href='$url' class='smoothbox'>", "</a>");?></span></div>
		<?php endif;?>
