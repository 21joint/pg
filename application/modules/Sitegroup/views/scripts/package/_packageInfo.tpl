...
<div class="sitegroup_package_stat">
    <?php if (in_array('price', $packageInfoArray)): ?>
        <span>
            ...
            <?php if ($item->price > 0):echo Engine_Api::_()->sitegroup()->getPriceWithCurrency($item->price);  
...
<?php if (in_array('ads', $packageInfoArray)): ?>
            ...
            <span>
                ...
                <?php
                if ($item->ads == 1 && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.communityads', 1))
                    echo $this->translate("Yes");
                else
                    echo $this->translate("No");
                ?>
...
<?php endif; ?> 
    ...
    <?php endif; ?> 
    <?php if (false && in_array('foursquarebutton', $packageInfoArray)): ?><span>
