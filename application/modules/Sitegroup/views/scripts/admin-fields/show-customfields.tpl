...
<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'importlisting'), $this->translate('Back to Import Groups from a CSV file'), array('class' => 'buttonlink seaocore_icon_back')) ?>
<br /><br />
...
<div class="importlisting_form">
    ...
    <p>
     ...
     <a href='<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'manage'), "admin_default", true) ?>' target="_blank"><?php echo $this->translate("clicking here."); ?></a>
    </p>
    <ul class="importlisting_form_sitegroup">
      <li>
      ...
      <li>
        <?php echo $this->translate('For creating accurate groups from the CSV file, it is recommended that you fill all the required fields in the file to be imported.');?>
      </li>
      <li>
        ...
        <div>
          ...
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'country')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Ethnicity');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'ethnicity')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Occupation');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'occupation')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Education');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'education_level')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Relationship Status');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'relationship_status')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Looking For');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'looking_for')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Weight');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'weight')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Religion');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'religion')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Political Views');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'political_views')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Income');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'income')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Interested In');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'partner_gender')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Zodiac');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'zodiac')) ?>" class="smoothbox bold">?</a>]
        </div>
        <div>
          - <?php echo $this->translate('Date');?>
          [<a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'show-fields','field' => 'date')) ?>" class="smoothbox bold">?</a>]
        </div>
      </li>	
    </ul>
		  <br />
    <form method="post" class="global_form_box" id="customfield" action="<?php echo $this->url(array('action' => 'show-customfields')) ?><?php echo '?path=' . urlencode('example_group_import.csv');?>" width="100%">
      <?php foreach($this->topLevelOptions as $key => $profile):?>
        ...
        <?php $this->secondLevelMaps = Engine_Api::_()->getApi('core', 'sitegroup')->getsecondLevelMaps($key);?>
        ...
        <?php endif;?>
        <ul class="admin_fields sitegroup_custom_fields">
          <?php foreach ($this->secondLevelMaps as $map): ?>
            <?php if(!empty($map->option_id)):?>
              <?php $profileTypeLabel = Engine_Api::_()->getApi('core', 'sitegroup')->getProfileTypeName($map->option_id);?>
            <?php endif;?>
      ...
      <?php if(empty($this->import_id)):?>
        <a href="javascript:void(0);" onclick="showErrorMessage(); return false;" class="buttonlink icon_sitegroups_download_csv"><?php echo $this->translate('Download New CSV Template File')?></a> &nbsp;&nbsp;&nbsp;
      <?php else:?>
        <div class="tip">
          <span>     
            <?php echo $this->translate("You have already imported a csv file. To generate a new csv template file from here, please delete the existing imported file by ");?><a href='<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'manage'), "admin_default", true) ?>' target="_blank"><?php echo $this->translate("clicking here."); ?></a>
          </span>
        </div>
      <?php endif;?>
      <a href="<?php echo $this->url(array('module' => 'sitegroup', 'controller' => 'importlisting', 'action' => 'download')) ?><?php echo '?path=' . urlencode('previous_group_import.csv');?>" class="buttonlink icon_sitegroups_download_csv"><?php echo $this->translate('Download Previous CSV Template File')?></a>  
    </form>
	 </div>
</div>
