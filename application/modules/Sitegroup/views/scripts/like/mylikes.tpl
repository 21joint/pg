				...
				<li>
					...
					<div class='seaocore_browse_list_info'>
						...
						<?php if((!empty($sitegroup->location) && $this->enableLocation) || (!empty($sitegroup->price) && $this->enablePrice) ): ?>
							<div class="seaocore_browse_list_info_date"><?php if(!empty($sitegroup->price) && $this->enablePrice): ?><?php echo $this->translate("Price: "); echo Engine_Api::_()->sitegroup()->getPriceWithCurrency($sitegroup->price);   ?><?php endif; ?><?php if((!empty($sitegroup->location) && $this->enableLocation) && (!empty($sitegroup->price ) && $this->enablePrice)): ?><?php echo $this->translate(", "); ?>
                <?php endif; ?>
