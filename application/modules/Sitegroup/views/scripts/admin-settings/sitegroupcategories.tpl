 ...
 * @version    $Id: sitegroupcategories.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
  ...
  <div class='global_form'>
    <div>
      <div>
        ...
        <h4 class="description"><?php echo $this->translate("Below, you can add and manage the various categories, sub-categories and 3%s level categories for the groups on your site. Sub-categories are very useful as they allow you to further categorize and organize the groups on your site beyond the superficial categories.","<sup>rd</sup>") ?></h4>
        <a href='javascript:addcat();' class="buttonlink" style="background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/plus_icon.png);"><?php echo $this->translate("Add Category") ?></a>
        <br />
        <div id='categories' class="admin_sitegroup_categories">
          <!--{section name=cat_loop loop=$categories}-->
          <?php foreach ($this->categories as $value): ?>
            <div id="cat_<?php echo $value['category_id']; ?>" class="admin_sitegroup_cat">
              ...
              <?php // echo "<div><img src='". $this->layout()->staticBaseUrl . "application/modules/Sitegroup/externals/images/folder_open_yellow.gif' border='0' class='sitegroup_subcat_handle handle_cat' ><span id='cat_" . $value['category_id'] . "_span'>$link</span></div>" ?>
              <div class="admin_file">
								<?php echo "<img src='".$this->layout()->staticBaseUrl."application/modules/Sitegroup/externals/images/folder_open_yellow.gif' border='0' class='seaocore_subcat_handle handle_cat' ><span id='cat_" . $value['category_id'] . "_span'>$link</span>" ?>
								...
								<?php if(!empty($value['file_id'])):?>
									<span class="categories-image-preview seaocore_file_preview_wrapper">
										...
										|
									<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'settings', 'action' => 'edit-icon', 'category_id' => $value['category_id']), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
										| 
									<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'settings', 'action' => 'delete-icon', 'category_id' => $value['category_id']), $this->translate('Delete'), array(
										'class' => 'smoothbox',
									)) ?> 

								<?php else:?>
									<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'settings', 'action' => 'add-icon', 'category_id' => $value['category_id']), $this->translate('Add'), array('class' => 'smoothbox')) ?>
								<?php endif;?>
							</div>
              <?php $subcate = $this->translate("Sub Categories") . " - <a href='javascript:addsubcat(" . $value['category_id'] . ",0)'> " . $this->translate("[Add New]") . "</a>" ?>
              <?php echo "<div class='sitegroup_add_new_cat'>$subcate</div>" ?>
              <?php echo "<br />"; ?>
              <script type="text/javascript">
                <!-- 
              ...
              <div id="subcats_<?php echo $value['category_id']; ?>" class="pad_left_20">
                <?php foreach ($value['sub_categories'] as $subcategory): ?>
                  <div id="cat_<?php echo $subcategory['sub_cat_id']; ?>" class="pad_left_20">
                    ...
                    <?php // echo "<div><img src='". $this->layout()->staticBaseUrl . "application/modules/Sitegroup/externals/images/folder_open_green.gif' border='0' class='sitegroup_subcat_handle handle_subcat_" . $value['category_id'] . "'><span id='cat_" . $subcategory["sub_cat_id"] . "_span'>$subcats [" . $subcategory["count"] . "]</span></div>" ?>
                  
                    <div class="admin_file">
											<?php echo "<img src='".$this->layout()->staticBaseUrl."application/modules/Sitegroup/externals/images/folder_open_green.gif' border='0' class='seaocore_subcat_handle handle_subcat_" . $value['category_id'] . "'><span id='cat_" . $subcategory["sub_cat_id"] . "_span'>$subcats [" . $subcategory["count"] . "]</span>" ?>
											...
											<?php if(!empty($subcategory['file_id'])):?>
												<span class="categories-image-preview seaocore_file_preview_wrapper">
													...
													|
												<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'settings', 'action' => 'edit-icon', 'category_id' => $subcategory['sub_cat_id']), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
													| 
												<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'settings', 'action' => 'delete-icon', 'category_id' => $subcategory['sub_cat_id']), $this->translate('Delete'), array(
													'class' => 'smoothbox',
												)) ?> 

											<?php else:?>
												<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'settings', 'action' => 'add-icon', 'category_id' => $subcategory['sub_cat_id']), $this->translate('Add'), array('class' => 'smoothbox')) ?>
											<?php endif;?>
                    ...
                    <?php echo "<div class='sitegroup_add_new_cat'>$treesubcate</div>" ?>
                    <script type="text/javascript">
                      <!--
                    ...
                    <div id="treesubcats_<?php echo $subcategory['sub_cat_id']; ?>" class="pad_left_20">
                      <?php if(isset($subcategory['tree_sub_cat'])):?>
                        ...
                        <input type="hidden" id="cat_<?php echo $treesubcategory['tree_sub_cat_id']; ?>_input_count" value="<?php echo $treesubcategory['count'] ?>">
                          ...
                          <?php // echo "<div><img src='". $this->layout()->staticBaseUrl . "application/modules/Sitegroup/externals/images/folder_open_green.gif' border='0' class='sitegroup_subcat_handle handle_treesubcat_" . $subcategory['sub_cat_id'] . "'><span id='cat_" . $treesubcategory["tree_sub_cat_id"] . "_span'>$treesubcats [" . $treesubcategory["count"] . "]</span></div>" ?>
                        
                        <div class="admin_file">
														<?php echo "<img src='".$this->layout()->staticBaseUrl."application/modules/Sitegroup/externals/images/folder_open_green.gif' border='0' class='seaocore_subcat_handle handle_treesubcat_" . $subcategory['sub_cat_id'] . "'><span id='cat_" . $treesubcategory["tree_sub_cat_id"] . "_span'>$treesubcats [" . $treesubcategory["count"] . "]</span>" ?>
														...
														<?php if(!empty($treesubcategory['file_id'])):?>
															<span class="categories-image-preview seaocore_file_preview_wrapper">
																...
																|
															<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'settings', 'action' => 'edit-icon', 'category_id' => $treesubcategory['tree_sub_cat_id']), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
																| 
															<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'settings', 'action' => 'delete-icon', 'category_id' => $treesubcategory['tree_sub_cat_id']), $this->translate('Delete'), array(
																'class' => 'smoothbox',
															)) ?> 

														<?php else:?>
																<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitegroup', 'controller' => 'settings', 'action' => 'add-icon', 'category_id' => $treesubcategory['tree_sub_cat_id']), $this->translate('Add'), array('class' => 'smoothbox')) ?>
														<?php endif;?>
...
<script type="text/javascript">
  ...
  // THIS FUNCTION ADDS A CATEGORY INPUT TO THE GROUP
  function addcat() 
  {
    var catarea = $('categories');
    var newdiv = document.createElement('div');
    newdiv.id = 'cat_new';
    newdiv.className="admin_sitegroup_cat";
    newdiv.innerHTML ='<div><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/folder_open_yellow.gif" border="0" class="sitegroup_subcat_handle handle_cat"><span id="cat_new_span"><input type="text" id="cat_new_input" maxlength="100" onBlur="savecat(\'new\', \'\', \'\',\'\')" onkeypress="return noenter_cat(\'new\', event)"></span></div>';
    ...
    if(catinput.value == "" && catid == "new") {		
      ...
      if(cat_dependency == 0) {
        <?php //if(!Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitegroupreview')):?>
         // show_delete_category_message = '<?php //echo $this->string()->escapeJavascript($this->translate("Are you sure you want to delete this category? NOTE: If you are deleting a main category, all subcategories and 3rd level categories will be deleted as well. Group profile category can also affected after deleting this category !"));?>';
				Smoothbox.open('<?php echo $baseurl ?>' +'/admin/sitegroup/settings/mapping-category/catid/'+catid+'/cat_dependency/'+cat_dependency+'/cat_title/'+encodeURIComponent(catinput.value)+'/subcat_dependency/'+subcat_dependency+'/oldcat_title/'+oldcat_title);
        <?php //else:?>
          //show_delete_category_message = '<?php //echo $this->string()->escapeJavascript($this->translate("Are you sure you want to delete this category? NOTE: If you are deleting a main category, all subcategories and 3rd level categories will be deleted as well. Group profile category and Review category mapping can also affected after deleting this category !"));?>';
        <?php //endif;?>
      } else {
        if(cat_dependency != '0' && subcat_dependency == 0) {
          show_delete_category_message = '<?php echo $this->string()->escapeJavascript($this->translate("Are you sure you want to delete this subcategory? NOTE: If you are deleting a subcategory then all the corresponding 3rd level categories will be deleted as well. Group profile subcategory can also affected after deleting this subcategory !"));?>';
        }
        else {
          show_delete_category_message = '<?php echo $this->string()->escapeJavascript($this->translate("Are you sure you want to delete this 3rd level category?"));?>';
				...
				if(confirm(show_delete_category_message) && cat_dependency != '0') {
					$('ajaxframe').src = '<?php echo $baseurl ?>'+'/admin/sitegroup/settings/sitegroupcategories?task=savecat&cat_id='+catid+'&cat_dependency='+cat_dependency+'&cat_title='+encodeURIComponent(catinput.value)+'&subcat_dependency='+subcat_dependency;
				} else {
  ...
  // THIS FUNCTION REMOVES A CATEGORY FROM THE GROUP
  function removecat(catid) {
    var catdiv = $('cat_'+catid); 
    var catarea = catdiv.parentNode;
    catarea.removeChild(catdiv);
    window.location.href='<?php echo $baseurl ?>'+'/admin/sitegroup/settings/sitegroupcategories';
  }
  ...
  function savecat_result(old_catid, new_catid, cat_title, cat_dependency, subcat_dependency)
  {
    ...
    if(old_catid == 'new') {
      if(cat_dependency == 0) {
        catdiv.innerHTML += '<div class="sitegroup_add_new_cat"><?php echo $this->translate('Sub Categories')?> - <a href="javascript:addsubcat(\''+new_catid+'\', \''+cat_dependency+'\');">[Add New]</a></div>';
        ...
        catdiv.innerHTML += '<div class="sitegroup_add_new_cat"><?php echo $this->translate('3%s Level Category', "<sup>rd</sup>")?> - <a href="javascript:addtreesubcat(\''+new_catid+'\', \''+cat_dependency+'\');">[Add New]</a></div>';
  ...
  function changeorder(sitegrouporder, divId) 
  {
    $('ajaxframe').src = '<?php echo $baseurl ?>'+'/admin/sitegroup/settings/sitegroupcategories?task=changeorder&sitegrouporder='+sitegrouporder+'&divId='+divId;
  }
  ...
  function addsubcat(catid, subcatdependency)
  {
    ...
    newdiv.innerHTML = '<div><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/folder_open_green.gif" border="0" class="sitegroup_subcat_handle handle_subcat_'+catid+'"><span id="cat_new_span"><input type="text" id="cat_new_input" maxlength="100" onBlur="savecat(\'new\', \'\', \''+catid+'\', \''+subcatdependency+'\')" onkeypress="return noenter_cat(\'new\', event)"></span></span></div>';
    catarea.appendChild(newdiv);
    var catinput = $('cat_new_input');
    catinput.focus();
  }
  ...
  function addtreesubcat(catid, subcat_dependancy)
  {
    ...
    newdiv.innerHTML = '<div><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/folder_open_green.gif" border="0" class="sitegroup_subcat_handle handle_treesubcat_'+catid+'"><span id="cat_new_span"><input type="text" id="cat_new_input" maxlength="100" onBlur="savecat(\'new\', \'\', \''+catid+'\', \''+catid+'\')" onkeypress="return noenter_cat(\'new\', event)"></span></span></div>';
    catarea.appendChild(newdiv);
    var catinput = $('cat_new_input');
    catinput.focus();
  }
