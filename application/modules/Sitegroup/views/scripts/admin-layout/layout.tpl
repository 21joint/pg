...
<script type="text/javascript">
  ...
  var saveChanges = function()
  {
    ...
    var url = '<?php echo $this->url(array('action' => 'update', 'controller' => 'layout', 'module' => 'sitegroup'), 'admin_default', true)?>';
    var group_reload = '<?php echo Zend_Controller_Front::getInstance()->getRequest()->getParam('group_reload', 1);?>';
    var reload_count = '<?php echo round($this->totalGroups / 300);?>';
  ...
  var openWidgetParamEdit = function(name, element) {
    ...
    var url = '<?php echo $this->url(array('action' => 'widget', 'controller' => 'layout', 'module' => 'sitegroup'), 'admin_default', true)?>';
  ...
  var saveCurrentGroupInfo = function(formElement) {
    var url = '<?php echo $this->url(array('action' => 'save', 'controller' => 'layout', 'module' => 'sitegroup'), 'admin_default', true)?>';
...
<h2><?php echo $this->translate('Group Profile Layout Editor'); ?></h2>
<p>
...
<script type="text/javascript">
	...
	var widgetshowhide = function(widgetname, option) {
		  ...
		  $('backgroundimage_' + widgetname).innerHTML = '<div class="form-label"></div><div  class="form-element"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitegroup/externals/images/loading.gif" /></center></div>';
			var url = '<?php echo $this->url(array('action' => 'show-hide-widget', 'controller' => 'layout', 'module' => 'sitegroup'), 'admin_default', true)?>';
    var request = new Request.HTML({
      'url' : url,
      'data' : {
        'format' : 'html',
