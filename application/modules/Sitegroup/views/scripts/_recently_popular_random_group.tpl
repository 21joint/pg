        ...
        <?php if (count($this->sitegroupsitegroup)): ?>
            ...
            <?php endif; ?>
                            ...
                            <?php if (!empty($sitegroup->price) && $this->enablePrice): ?>
                                ...
                                echo Engine_Api::_()->sitegroup()->getPriceWithCurrency($sitegroup->price); 
                                ?>
                                </div>
                            <?php endif; ?>						
            <?php
                ...
                if (!empty($sitegroup->location) && $this->enableLocation && !empty($this->showlocation)):
                    ...
                    ?>
                            ...
                            <?php 
                                ...
                                $this->subject = $sitegroup;
                                include APPLICATION_PATH . '/application/modules/Seaocore/views/scripts/_shareGroupButtons.tpl';
...
<?php if ($this->enableLocation && $this->map_view): ?>
    ...
    <?php foreach ($this->locations as $location) : ?>
        ...
        <?php if ($this->sitegroup[$location->group_id]->price && $this->enablePrice): ?>
            ...
            echo Engine_Api::_()->sitegroup()->getPriceWithCurrency($this->sitegroup[$location->group_id]->price); ?>" +
                            '</div>' +
        <?php endif; ?>
                '<div class="sitegroups_locationdetails_info_date">' +
