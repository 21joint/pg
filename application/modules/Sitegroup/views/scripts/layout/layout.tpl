...
<div id='grouplayout_cms_wrapper'>
		...
		<?php if($this->adminDriven):?>
			<div class="tip" id="admin_driven_tip"><span><?php echo $this->translate('Below is the default layout which has been set by the site admin for all the groups. If you want to modify anything in this layout or want to add / remove any blocks on your group, then please %1$sClick here%2$s.', "<a href='javascript:void(0);' onclick='OpenSmoothbox();'>", "</a>");?></span></div>
		<?php endif;?>
