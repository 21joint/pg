    ...
    <div class="sp_coverinfo_buttons">
      ...
      <?php if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitegroupmember')) : ?>
				...
				if (empty($joinMembers) && in_array('joinButton', $this->showContent) && $this->viewer_id != $this->sitegroup->owner_id && !empty($this->allowGroup)): ?>
					<div>
					<?php if (!empty($this->viewer_id) && empty($this->sitegroup->restricted)) : ?>
						<?php if (!empty($this->sitegroup->member_approval)): ?>
							<a class="sitegroup_button" href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array( 'action' => 'join', 'group_id' => $this->sitegroup->group_id), 'sitegroup_profilegroupmember', true)); ?>'); return false;" ><i class="fa plus_icon"></i><span><?php echo $this->translate("Join Group"); ?></span></a>
						<?php else: ?>
							<a class="sitegroup_button" href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array( 'action' => 'request', 'group_id' => $this->sitegroup->group_id), 'sitegroup_profilegroupmember', true)); ?>'); return false;" ><i class="fa plus_icon"></i><span><?php echo $this->translate("Join Group"); ?></span></a>
						<?php endif; ?>
					<?php endif; ?>
					</div>
				<?php endif; ?>
        ...
        if (!empty($hasMembers) && in_array('leaveButton', $this->showContent) && $this->viewer_id != $this->sitegroup->owner_id && !empty($this->allowGroup)): ?>
            ...
            <?php if ($this->viewer_id) : ?>
							<a  class="sitegroup_button" href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array( 'action' => 'leave', 'group_id' => $this->sitegroup->group_id), 'sitegroup_profilegroupmember', true)); ?>'); return false;" ><i class="fa plus_icon"></i><span><?php echo $this->translate("Leave Group"); ?></span></a>
            <?php endif; ?>
					</div>
				<?php endif; ?>
				...
				<?php if (in_array('addButton', $this->showContent)): ?>
					...
					<div>
						<a class="sitegroup_button" href="javascript:void(0);" onclick="showSmoothBox('<?php echo $this->escape($this->url(array( 'action' => 'invite-members', 'group_id' => $this->sitegroup->group_id), 'sitegroup_profilegroupmember', true)); ?>'); return false;" ><i class="fa add_people"></i><span><?php echo $this->translate("Add People"); ?></span></a>	
					</div>
