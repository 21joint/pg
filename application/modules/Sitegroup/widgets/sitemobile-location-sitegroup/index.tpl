    ...
    <div class="layout_middle">
      <?php if (!empty($this->sitegroup->location) && !empty($this->MainLocationObject)) : ?>
        <div class='profile_fields sitegroup_location_fields sitegroup_list_highlight'>
          ...
          <div class="map_canvas_sitegroup_browse" id="map_canvas_<?php echo $this->subject()->getGuid() . "_" . $this->MainLocationObject->location_id ?>" ></div>
        </div>
        <div class="sm_ui_item_profile_details sitegroup_location_fields_details">
          <table>
            <tbody>
              <tr valign="top">
...
-<b>
                      <?php echo $this->htmlLink('https://maps.google.com/?q=' . urlencode($this->MainLocationObject->location), $this->translate("Get Directions"), array('target' => '_blank')); ?>
                    </b>
      ...
      <?php foreach ($this->location as $item): ?>
        <div class='profile_fields sitegroup_location_fields'>
          ...
          <div class="map_canvas_sitegroup_browse" id="map_canvas_<?php echo $this->subject()->getGuid() . "_" . $item->location_id ?>" ></div>
        </div>
              ...
              <tr valign="top">
                ...
                <td><b><?php echo $item->location; ?></b> 
                 - <span class="location_get_direction"><b>
                     <?php echo $this->htmlLink('https://maps.google.com/?q=' . urlencode($item->location), $this->translate("Get Directions"), array('target' => '_blank')); ?>
...
<?php else: ?>
  ...
  <div id='id_<?php echo $this->content_id; ?>'>
    ...
    <div class='profile_fields'>
          <div class="map_canvas_sitegroup_browse" id="map_canvas_<?php echo $this->subject()->getGuid() . "_" . $this->MainLocationObject->location_id ?>"></div><br />
      <h4>
 ...
 - <b>
                 <?php echo $this->htmlLink('https://maps.google.com/?q=' . urlencode($this->location->location), $this->translate("Get Directions"), array('target' => '_blank')); ?>
                </b>
              </td>
