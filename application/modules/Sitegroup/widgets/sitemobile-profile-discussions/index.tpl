...
<?php if ($this->canPost): ?>
    ...
    echo $this->htmlLink(array(
        ...
        'resource_id' => $this->subject->getIdentity(),
            ...
            array(
					'class' => 'buttonlink icon_sitegroup_post_new','data-role' => "button", 'data-icon' => "plus", "data-iconpos" => "left", "data-inset" => 'false', 'data-mini' => "true", 'data-corners' => "true", 'data-shadow' => "true"))
    ?>
  </div>
<?php endif; ?>
<div class="sm-content-list" id="profile_sitegroupdiscussions">
      ...
      <?php endforeach;?>
		...
		<?php if ($this->paginators->count() > 1): ?>
			...
			echo $this->paginationAjaxControl(
							$this->paginators, $this->identity, "profile_sitegroupdiscussions");
			?>
		<?php endif; ?>
   </div>
<?php else: ?>
