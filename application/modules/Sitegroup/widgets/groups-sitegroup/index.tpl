          ...
          <?php endif; ?>
            ...
            <?php endif; ?>
						<?php if((!empty($sitegroup->location) && $this->enableLocation) || (!empty($this->showprice) && !empty($sitegroup->price) && $this->enablePrice) ): ?>
							<div class="seaocore_browse_list_info_date"><?php if(!empty($this->showprice) && !empty($sitegroup->price) && $this->enablePrice): ?><?php echo $this->translate("Price: "); echo Engine_Api::_()->sitegroup()->getPriceWithCurrency($sitegroup->price); ?><?php endif; ?><?php if((!empty($sitegroup->location) && $this->enableLocation) && (!empty($this->showprice) && !empty($sitegroup->price ) && $this->enablePrice)): ?><?php //echo $this->translate(", "); ?>
              <?php endif; ?>
       ...
       <?php if (Engine_Api::_()->getDbtable( 'modules' , 'core' )->isModuleEnabled('sitegroupmember') && is_array($this->statistics) && !empty($this->statistics) && in_array('memberCount', $this->statistics)) :?>
          ...
          <?php endif; ?>
					...
					<?php if(!empty($this->showprice) && !empty($sitegroup->price) && $this->enablePrice): ?>
						<div class='sitegroup_browse_thumb_stats seaocore_txt_light'>
							<?php  echo $this->translate("Price: "); echo Engine_Api::_()->sitegroup()->getPriceWithCurrency($sitegroup->price); ?>
						</div>
					<?php  endif;?>
					<?php
            ...
            <?php endif; ?>
                 '</div>'+
                  ...
                  <?php if(!empty($this->showprice) && $this->sitegroup[$location->group_id]->price && $this->enablePrice): ?>
                    '<div class="sitegroups_locationdetails_info_date">'+
            "<?php  echo  $this->string()->escapeJavascript($this->translate("Price: ")); echo  Engine_Api::_()->sitegroup()->getPriceWithCurrency($this->sitegroup[$location->group_id]->price); ?>"+
           '</div>'+
                  <?php endif; ?>
           '<div class="sitegroups_locationdetails_info_date">'+
