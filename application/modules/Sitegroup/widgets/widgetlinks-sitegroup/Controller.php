            ...
            case 'sitevideo.contenttype-videos':
                ...
                case 'sitecrowdfunding.contenttype-projects':
                    ...
                    if ($enable_projects) {
                        ...
                        $projectCreate = Engine_Api::_()->sitegroup()->isManageAdmin($sitegroup, 'sprcreate');
                        if (empty($projectCreate) && empty($projectCount)) {
                            break;
                        }
                        //PACKAGE BASE PRIYACY START
                        if (Engine_Api::_()->sitegroup()->hasPackageEnable()) {
                            if (!Engine_Api::_()->sitegroup()->allowPackageContent($sitegroup->package_id, "modules", "sitecrowdfunding")) {
                                break;
                            }
                        } else {
