 ...
 */
class Sitegroup_Widget_SocialshareSitegroupController extends Engine_Content_Widget_Abstract {

  public function indexAction() {

		//SHARING IS ALLOWED OR NOT
    $sharingAllow = Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.socialshare', 1);
    ...
    $this->view->code = Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroup.code.share', $social_share_default_code);
