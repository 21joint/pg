...
<script>
  ...
  var browsetagparams = {
            ...
            responseContainer: $$('.layout_sitegroup_tagcloud_sitegroup'),
  ...
  en4.sitegroup.ajaxTab.sendReq(browsetagparams);
...
<?php if($this->showcontent):?>
    ...
    <form id='filter_form_tag' class='global_form_box' method='get' action='<?php echo $this->url(array('action' => 'index'), 'sitegroup_general', true) ?>' style='display: none;'>
      <input type="hidden" id="tag" name="tag"  value=""/>
    </form>

    <h3><?php echo $this->translate('Popular Group Tags'); ?> (<?php echo $this->count_only ?>)</h3>
    <ul class="sitegroup_sidebar_list">
      <li>
        ...
        <?php endforeach; ?>
        <br/>
        <b class="explore_tag_link"><?php echo $this->htmlLink(array('route' => 'sitegroup_tags', 'action' => 'tagscloud','category_id' => $this->category_id), $this->translate('Explore Tags &raquo;')) ?></b>
      </li>
    </ul>
<?php endif;?>
