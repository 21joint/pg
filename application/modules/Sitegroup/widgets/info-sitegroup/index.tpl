...
<div class='profile_fields'>
    ...
    <li>
      ...
      <span><?php echo Engine_Api::_()->sitegroup()->getPriceWithCurrency($this->sitegroup->price); ?></span>
    </li>
    <?php endif; ?>
...
<script type="text/javascript">
  ...
  {	
     ...
     if(group_showtitle != 0 ) {
			if($('profile_status')) {
				$('profile_status').innerHTML = "<h2><?php echo $this->string()->escapeJavascript(empty($this->sitegroup)?'':$this->sitegroup->getTitle())?></h2>";
			}	  
			if($('layout_info')) {
