 ...
 */
class Sitegroup_Api_LayoutCore extends Core_Api_Abstract {
  ...
  public function setWithoutTabContent($group_id, $sitegroup_layout_cover_photo) {
    ...
    //INSERTING TITLE WIDGET
      ...
      Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.group-profile-breadcrumb', $middle_id, 1, '', 'true');

			//INSERTING PAGE PROFILE PAGE COVER PHOTO WIDGET
      if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitegroupmember')) {
				Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroupmember.groupcover-photo-sitegroupmembers', $middle_id, 2, '', 'true');
      }

			Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.title-sitegroup', $middle_id, 3,'','true');

			//INSERTING LIKE WIDGET 
			Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'seaocore.like-button', $middle_id, 4,'','true');

			//INSERTING FACEBOOK LIKE WIDGET
			if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('facebookse')) {
				Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'Facebookse.facebookse-sitegroupprofilelike', $middle_id, 5,'','true');
			}

			//INSERTING MAIN PHOTO WIDGET 
			Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.mainphoto-sitegroup', $left_id, 10,'','true');

    } else {
			//INSERTING PAGE PROFILE PAGE COVER PHOTO WIDGET
			Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.group-cover-information-sitegroup', $middle_id, 1, '', 'true');
    }

    //INSERTING CONTACT DETAIL WIDGET
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.contactdetails-sitegroup', $middle_id, 5,'','true');

//     //INSERTING PHOTO STRIP WIDGET   
//     if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitegroupalbum')) {
//       Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.photorecent-sitegroup', $middle_id, 6,'','true');
//     }
    ...
    if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('advancedactivity')) {
      ...
      Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'advancedactivity.home-feeds', $middle_id, 6, 'Updates', 'true',$advanced_activity_params);
    } else {
      Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'activity.feed', $middle_id, 6, 'Updates', 'true');
    }

    //INSERTING INFORAMTION WIDGET
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.info-sitegroup', $middle_id, 7, 'Info', 'true');

    //INSERTING OVERVIEW WIDGET
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.overview-sitegroup', $middle_id, 8, 'Overview', 'true');

    //INSERTING LOCATION WIDGET
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.location-sitegroup', $middle_id, 9, 'Map', 'true');

    //INSERTING LINKS WIDGET  
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'core.profile-links', $middle_id, 125, 'Links', 'true');

    //INSERTING MAIN PHOTO WIDGET 
   // Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.mainphoto-sitegroup', $left_id, 10,'','true');

    //INSERTING WIDGET LINK WIDGET 
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.widgetlinks-sitegroup', $left_id, 11,'','true');

    //INSERTING OPTIONS WIDGET 
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.options-sitegroup', $left_id, 12,'','true');

    //INSERTING WRITE SOMETHING ABOUT WIDGET 
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.write-group', $left_id, 13,'','true');

    //INSERTING INFORMATION WIDGET 
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.information-sitegroup', $left_id, 10, 'Information', 'true');

    //INSERTING LIKE WIDGET 
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'seaocore.people-like', $left_id, 15,'','true');

    //INSERTING RATING WIDGET 	
    if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitegroupreview')) {
      Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroupreview.ratings-sitegroupreviews', $left_id, 16, 'Ratings', 'true');
    }

    //INSERTING BADGE WIDGET 
    if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitegroupbadge')) {
      Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroupbadge.badge-sitegroupbadge', $left_id, 17, 'Badge','true');
    }
    ...
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.socialshare-sitegroup', $left_id, 19, 'Social Share','true', $social_share_default_code);

//    //INSERTING FOUR SQUARE WIDGET 
//    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.foursquare-sitegroup', $left_id, 20, '','true');

    //INSERTING INSIGHTS WIDGET 
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.insights-sitegroup', $left_id, 22, 'Insights','true');

    //INSERTING FEATURED OWNER WIDGET 
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.featuredowner-sitegroup', $left_id, 23, 'Owners','true');
    ...
    if ($sitegroupAlbumEnabled) {
      Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.albums-sitegroup', $left_id, 24, 'Albums','true');
      $this->setDefaultInfoWithoutTab('sitegroup.photos-sitegroup', $group_id, 'Photos', 'true', '110');
    }

    //INSERTING LINKED GROUPS WIDGET
    Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.favourite-group', $left_id, 26, 'Linked Groups','true');
    
    if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitegroupmusic')) {
      Engine_Api::_()->sitegroup()->setDefaultDataContentWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.profile-player', $left_id, 25, '','true');
    }
    ...
    if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding')) {
        $this->setDefaultInfoWithoutTab('sitecrowdfunding.contenttype-projects', $group_id, 'Projects', 'true', '125');
    }
}
   ...
   * @param int $group_id
   */
  public function setTabbedLayoutContent($group_id) {
    ...
    if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding')) {
      $this->setContentDefaultInfo('sitecrowdfunding.contenttype-projects', $group_id, 'Projects', 'true', '125');
    }
}
  ...
  public function setContentDefaultLayout($group_id) {
    ...
    //FETCH
    $coregroupsinfo = Engine_Api::_()->sitegroup()->getWidgetizedGroup();

    //SELECT ADMIN CONTENT
    $admincontentselected = $admincontentTable->select()->where('group_id =?', $coregroupsinfo->page_id)->where('type =?', 'container');
    ...
    //SELECT ADMIN CONTENT
    $admincontentselected = $admincontentTable->select()->where('group_id =?', $coregroupsinfo->page_id)->where('type =?', 'widget')->where('name =?', 'core.container-tabs');
    ...
    foreach ($admintableinfo as $values) {
      ...
      $mainWidgets->contentgroup_id = $group_id;
              ...
              if (!empty($check_sitepage)) {
                ...
                foreach ($results as $value) {
                  ...
                  $select
                          ...
                          ->where('type = ?', 'widget')
                          ->where('name = ?', 'sitegroupintegration.profile-items')
													->where('params = ?', '{"title":"Pages","resource_type":"sitepage_page_0","nomobile":"0","name":"sitegroupintegration.profile-items"}');
                  $info = $select->query()->fetch();
                  if (empty($info)) {
                    ...
                    $db->insert('engine4_core_content', array(
                        ...
                        'parent_content_id' => $middle_id,
                        'order' => 999,
                        'params' => '{"title":"Pages","resource_type":"sitepage_page_0","nomobile":"0","name":"sitegroupintegration.profile-items"}',
                    ));
                  }
                  //}
                }
              ...
              if (!empty($check_sitebusiness)) {
                ...
                foreach ($results as $value) {
                  ...
                  $select
                          ...
                          ->where('type = ?', 'widget')
                          ->where('name = ?', 'sitegroupintegration.profile-items')
													->where('params = ?', '{"title":"Businesses","resource_type":"sitebusiness_business_0","nomobile":"0","name":"sitegroupintegration.profile-items"}');
                  $info = $select->query()->fetch();
                  if (empty($info)) {
                    ...
                    $db->insert('engine4_core_content', array(
                        ...
                        'parent_content_id' => $middle_id,
                        'order' => 999,
                        'params' => '{"title":"Businesses","resource_type":"sitebusiness_business_0","nomobile":"0","name":"sitegroupintegration.profile-items"}',
                    ));
                  }
                  //}
                }
                ...
                foreach ($results as $value) {
                  ...
                  if (empty($info)) {
                    ...
                    $db->insert('engine4_core_content', array(
                        ...
                        'parent_content_id' => $middle_id,
                        'order' => 999,
                        'params' => '{"title":"Documents","resource_type":"document_0","nomobile":"0","name":"sitegroupintegration.profile-items"}',
                    ));
                  }
                  //}
                }
