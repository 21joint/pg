...
class Sitegroup_Api_Siteapi_Core extends Core_Api_Abstract {
     ...
     * @return array
     */
    public function getForm($sitegroup = null, $package_id = 0, $edit = 0) {
        ...
        try {
            ...
            if (!empty($sitegroupUrlEnabled) && !empty($sitegroup) && !empty($show_url) && !empty($edit_url)) {
                $createForm[] = array(
                    'type' => 'Text',
                    'name' => 'group_uri',
            ...
            if (isset($sitegroup->category_id) && !empty($sitegroup->category_id) && isset($subcategoryData[$sitegroup->category_id]['form']) && !empty($subcategoryData[$sitegroup->category_id]['form'])) {
...
// CLOSE / OPEN AN PAGE
        ...
        if (_CLIENT_TYPE && ((_CLIENT_TYPE == 'android' && _ANDROID_VERSION >= '1.6.3') || _CLIENT_TYPE == 'ios' && _IOS_VERSION >= '1.5.1')) {
            ...
            if (Engine_Api::_()->sitegroup()->canShowPaymentLink($subject->group_id)) {
                ...
                $menus[] = array(
                    ...
                    'url' => $getHost . '/' . $baseUrl . "/" . $routeStartP . "/payment?token=" . $getOauthToken['token'] . "&group_id=" . $subject->group_id . "&disableHeaderAndFooter=1"
                );
            }
        }
        ...
        if (!empty($viewer_id) && !empty($owner_id) && $owner_id == $viewer_id && $isEnabledPackage && (_CLIENT_TYPE && ((_CLIENT_TYPE == 'android' && _ANDROID_VERSION >= '1.8.7') || _CLIENT_TYPE == 'ios' && _IOS_VERSION >= '1.8.0'))) {
            $menus[] = array(
