...
//            Engine_Api::_()->sitegroup()->setDefaultDataWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.foursquare-sitegroup', $left_id, 20, '', 'true');
            ...
            if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding')) {
              Engine_Api::_()->getDbtable('admincontent', 'sitegroup')->setAdminDefaultInfo('sitecrowdfunding.contenttype-projects', $group_id, 'Projects', 'true', '125');
           }
...
//          Engine_Api::_()->sitegroup()->setDefaultDataWidget($contentTable, $contentTableName, $group_id, 'widget', 'sitegroup.foursquare-sitegroup', $left_id, 20, '', 'true');
          ...
          if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding')) {
              Engine_Api::_()->getDbtable('admincontent', 'sitegroup')->setAdminContentDefaultInfoWithoutTab('sitecrowdfunding.contenttype-projects', $group_id, 'Projects', 'true', '125');
          }
