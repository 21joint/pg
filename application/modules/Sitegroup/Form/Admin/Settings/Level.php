...
//                 )
      ...
      if ($sitecrowdfundingEnabled && (Engine_Api::_()->hasModuleBootstrap('sitecrowdfundingintegration') && Engine_Api::_()->getDbtable('modules', 'sitecrowdfunding')->getIntegratedModules(array('enabled' => 1, 'item_type' => 'sitegroup_group', 'item_module' => 'sitegroup')))) {
        $this->addElement('Radio', 'sprcreate', array(
            ...
            'description' => 'Do you want Crowdfunding projects to be available to Groups created by members of this level? This setting will also apply to ability of users of this level to create Projects in Groups.',
            'multiOptions' => array(
                1 => 'Yes',
                0 => 'No',
            ),
        ...
        $this->addElement('MultiCheckbox', 'auth_sprcreate', array(
            ...
            'description' => 'Your users can choose from any of the options checked below when they decide who can create the projects in their groups. If you do not check any options, everyone will be allowed to create.',
            'multiOptions' => $privacy_array
        ));
      }
