 ...
 */
class Sitegroup_Form_Admin_Changecategory extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setDescription('Select a category, sub-category and 3<sup>rd</sup> level category for this group from the list of categories and corresponding sub-categories given below and then click on "Save Changes" to save them.');
