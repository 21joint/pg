 ...
 */
class Sitegroup_Form_Admin_Item extends Engine_Form {

  protected $_field;

  public function init() {
    $this->setMethod('post');
    $this->setTitle('Add a Group of the Day')
            ->setDescription('Select a start date and end date below and the corresponding Group from the auto-suggest Group field. The selected Group will be displayed as "Group of the Day" for this duration and if more than one groups are found to be displayed in the same duration then they will be dispalyed randomly one at a time.');
    ...
    // init to
		$this->addElement('Hidden', 'resource_id', array('order' => 8000,));
