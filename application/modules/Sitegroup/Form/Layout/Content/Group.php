 ...
 */
class Sitegroup_Form_Layout_Content_Group extends Engine_Form {

  public function init() {

    $this
            ->setMethod('post')
            ->setAction(Zend_Controller_Front::getInstance()->getRouter()->assemble(array('action' => 'save', 'controller' => 'layout', 'module' => 'sitegroup'), 'default', true))
    ...
    $this->addElement('Hidden', 'contentgroup_id', array(
        'order' => 9999,
        'validators' => array(
            array('NotEmpty'),
            array('Int'),
