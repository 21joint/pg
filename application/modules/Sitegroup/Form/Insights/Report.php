 ...
 * @version    $Id: Report.php 2011-05-05 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitegroup_Form_Insights_Report extends Engine_Form {

  public function init() {
    $this
            ->setAttrib('id', 'report_form')
            ->setTitle("Group Reports")
            ->setDescription("You can view performance reports of your group over multiple durations and time intervals. The generated reports include statistics like views, likes, comments and active users. You can also export and save the reports.")
