 ...
 * @version    $Id: Claimgroup.php 2011-05-05 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitegroup_Form_Claimgroup extends Engine_Form {

  public function init() {

    $this->setTitle("Claim this Group")
            ->setdescription('Below, you can file a claim for this group on this community that you believe should be owned by you. Your request will be sent to the administration.')
