...
class Pgservicelayer_ApiBootstrap {
    ...
    protected function getModuleBootstrap() {
        if (self::$_bootstrap === null) {
            ...
            self::$_bootstrap = new Pgservicelayer_ModulesBootstrap(Engine_Application::getInstance());
        }
    ...
    protected function _initFrontController() {
        ...
        Zend_Controller_Action_HelperBroker::addPath($modulePath . "Pgservicelayer/Controller/Action/Helper/", 'Pgservicelayer_Controller_Action_Helper');
    ...
    protected function _initManifest() {
        ...
        $file = $path . DIRECTORY_SEPARATOR . 'Pgservicelayer' . '/settings/apiroutes.php';
