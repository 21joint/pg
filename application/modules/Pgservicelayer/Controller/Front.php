...
class Pgservicelayer_Controller_Front extends Zend_Controller_Front {
    ...
    public function dispatch(Zend_Controller_Request_Abstract $request = null, Zend_Controller_Response_Abstract $response = null) {
        ...
        try {
            ...
            do {
                 ...
                 */
                try {
                    $version = $this->_request->getParam("version",'v1');
                    if(empty($version)){
                        $version = 'v1';
                    }
                    ...
                    if (!$dispatcher->isValidModule($this->_request->getModuleName())) {
                        $this->setModuleControllerDirectoryName('controllers/'.$version);
                        ...
                        if (!file_exists($moduleDir . '/controllers/'.$version.'/' . ucfirst($this->_request->getControllerName()) . 'Controller.php'))
