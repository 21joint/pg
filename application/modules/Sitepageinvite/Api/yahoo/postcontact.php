 ...
 * @version    $Id: postcontact.php 2011-05-05 9:40:21Z SocialEngineAddOns $
...
// Call Contact API
$retarr = postcontact(OAUTH_CONSUMER_KEY, OAUTH_CONSUMER_SECRET, $guid, $access_token, $access_token_secret, true, true);
