 ...
 * @version    $Id: _formcontactimport.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<div class="form-sub-heading">
  ...
  <div><a href="javascript:void(0);" onclick="show_instruction('id_yahoo');"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/admin/help.gif"></a></div>
</div>
    ...
    <div style="display:none" id="id_yahoo">
      <div class="sitepage_admin_popup">
        <div>
          ...
          <?php echo $this->translate("e) After verifying your domain successfully, you will be redirected to a success page where you will get your 'API Key' and 'Shared Secret Key'. Copy them and paste these values in your site's Yahoo contact importer settings fields."); ?>
          <br /><br />
...
<div class="form-sub-heading">
  ...
  <div><a href="javascript:void(0);" onclick="show_instruction('id_windowlive');"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/admin/help.gif"></a></div>
</div>
...
<div class="form-sub-heading">
	...
	<div><a href="<?php echo $this->url(array('module' => 'seaocore', 'controller' => 'admin-settings', 'action' => 'help-invite'), 'default', true); ?>" ><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/admin/help.gif"></a></div>
</div>
