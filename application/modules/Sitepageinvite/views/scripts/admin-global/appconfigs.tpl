...
<div class='clear'>
  <a href="<?php echo $this->url(array('module' => 'sitepageinvite', 'controller' => 'global'), 'sitepageinvite_global_global', true) ?>" class="buttonlink" style="background-image:url(<?php echo $this->layout()->staticBaseUrl;?>application/modules/Sitepageinvite/externals/images/back.png);"><?php echo $this->translate("Back to Global Settings") ?></a>
          ...
          <div class='faq' style='display: none;' id='guideline_2'>
            ...
            <div class="steps">
              ...
              <div id="yahoostep-1" style='display: none;'>
                ...
                <img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/yahst1.gif" alt="Step 1" />
              </div>
            </div>
            ...
            <div class="steps">
              ...
              <div id="yahoostep-3" style='display: none;'>
                ...
                <img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/yahst3.gif" alt="Step 3" />
              </div>
            </div>
          ...
          <div class='faq' style='display: none;' id='guideline_4'>
            ...
            <div class="steps">
              ...
              <div id="msnstep-5" style='display: none;'>
                ...
                <img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/msnst5.gif" alt="Step 5" />
              </div>
            </div>
