 ...
 * @version    $Id: aollogin.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
#sugg-aol-signin #signin-form button {
  background-image:url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/aol-signin-btn.gif);
...
<div id="sugg-aol-signin">
  <div class="top">
    <?php $image_url = $this->layout()->staticBaseUrl . "application/modules/Sitepageinvite/externals/images/aol.png"; ?>
