 ...
 * @version    $Id: inviteusers.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
$inviteUrl = ( _ENGINE_SSL ? 'https://' : 'http://' )
        ...
        . Zend_Controller_Front::getInstance()->getRouter()->assemble(array(
            'sitepage_id' => $this->pageinvite_id,
            'user_id' => $this->pageinvite_userid
                ), 'sitepageinvite_invitefriends', true);
?>
...
<?php if (empty($this->successmessage)) : ?>
  <div id="invite_form">
    <form method="post" action='<?php echo $inviteUrl ?>' class="global_form_popup global_form" enctype="application/x-www-form-urlencoded">
      <div>
        <div>
          <h3><?php echo $this->translate('Invite & Promote'); ?></h3>
          <p class="form-description"><?php echo $this->translate('Tell your friends, fans and customers about this page and make it popular. Enter up to 10 email addresses in the text fields given below.'); ?></p>
