 ...
 * @version    $Id: friendspageinvite.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<div class="sitepage_viewpages_head">
  ...
  <?php if(!empty($this->can_edit)):?>
    ...
    <?php //echo $this->htmlLink(array( 'route' => 'sitepage_entry_view', 'page_url' => Engine_Api::_()->sitepage()->getPageUrl($this->sitepage->page_id)), $this->translate('Promote')) ?>
  </h2>
</div>
<!--RIGHT AD START HERE-->
<?php if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('communityad') && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitepage.communityads', 1) && Engine_Api::_()->getApi('settings', 'core')->getSetting('sitepage.adinvite', 3) && $page_communityad_integration):?>
	<div class="layout_right" id="communityad_invite">
    <?php
			echo $this->content()->renderWidget("communityad.ads", array( "itemCount"=>Engine_Api::_()->getApi('settings', 'core')->getSetting('sitepage.adinvite', 3),"loaded_by_ajax"=>0,'widgetId'=>"page_invite")); 			 
		?>
	</div>
<?php endif;?>
<!--RIGHT AD END HERE-->
<div class="layout_middle">
	<div class="pageinvites-friends">
		<div class="page-heading"><?php echo $this->translate("Tell your friends, fans and customers about your Page"); ?></div>
		<!--<div class="page-des">
			<?php //echo $this->translate("You can use any of the tools on this page to find and connect with more friends."); ?>
		</div>-->
	</div>
	<?php if ($this->viewer()->getIdentity()) { ?>
	<div id="id_show_networkcontacts" style="display:block"  class="pageinvites-friends">
		<div class="header">	
			<div class="title">	
				<?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/webmail.png', '') ?>
			...
			<div class="webmail-options">
				...
				<div class="icons">
					<a href="javascript:void(0);" onclick="showhide('id_show_networkcontacts', 'id_csvcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/addressbook.png', '',array('title' => $this->translate('Mac Address Book'))) ?></a>
					<a href="javascript:void(0);" onclick="showhide('id_show_networkcontacts', 'id_csvcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/linkedin16.png', '',array('title' => $this->translate('LinkedIn Address Book'))) ?></a>
					<a href="javascript:void(0);" onclick="showhide('id_show_networkcontacts', 'id_csvcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/thunderbird.png', '',array('title' => $this->translate('Thunderbird Address Book'))) ?></a>
					<a href="javascript:void(0);" onclick="showhide('id_show_networkcontacts', 'id_csvcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/outlook.png', '',array('title' => $this->translate('Microsoft Outlook Address Book'))) ?></a>
					
					<a href="javascript:void(0);" onclick="showhide('id_show_networkcontacts', 'id_csvcontacts')"><?php echo $this->translate("more"); ?> <?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/plus.png', '') ?></a>
				</div>
        	<div class="help-link">
        	
						<a href="<?php echo $this->baseUrl() . '/invite';?>" >
						<?php echo $this->htmlLink(array('route' => 'sitepageinvite_invitefriends', 'sitepage_id' => $this->invitepage_id, 'user_id' => $this->invitepage_userid), $this->translate('or Add Email Addresses Manually'), array(
                'class' => 'smoothbox',
              )) ?>
			...
			<?php if( is_array($this->webmail_show) && in_array("gmail", $this->webmail_show) ) { ?>
				<div class="webacc-logos-img">
					<a href='javascript:void(0)' onclick="show_contacts_google (1);" ><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/gmail.png', '') ?></a>
				</div>	
			<?php } ?>
			...
			<?php $yahoo_apikey = Engine_Api::_()->getApi('settings', 'core')->getSetting('yahoo.apikey');
			 ...
			 if (!empty($yahoo_apikey) && !empty($yahoo_secret) && is_array($this->webmail_show) && in_array("yahoo", $this->webmail_show) ) {?>
			 	<div class="webacc-logos-img">
					<a href='javascript:void(0)' onclick="show_contacts_yahoo (1);" ><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/yahoomail.png', '') ?></a>
				</div>	
      <?php } ?>
			...
			<?php $windowlive_apikey = Engine_Api::_()->getApi('settings', 'core')->getSetting('windowlive.apikey');
			 ...
			 <div class="webacc-logos-img">
					<a href='javascript:void(0)' onclick="show_contacts_windowlive (1);" ><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/windowslive.png', '') ?></a>
				</div>	
			<?php } ?>
    	...
    	?>
    			  <div class="webacc-logos-img">  			
    					<a href='javascript:void(0)' onclick="show_contacts_Facebook(1);" ><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/facebook.png', '') ?></a>
    				</div>	
	          ...
	          $twittersettings = Engine_Api::_()->getApi('settings', 'core')->getSetting('core.twitter');
		        if (!empty($twittersettings['key']) && !empty($twittersettings['secret']) && in_array("twitter_mail", $this->webmail_show) ) {
    			 ?>
    			  <div class="webacc-logos-img">  			
    					<a href='javascript:void(0)' onclick="show_contacts_Twitter(1);" ><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/twitter.png', '') ?></a>
    				</div>	
				...
				<?php $linkedin_apikey = Engine_Api::_()->getApi('settings', 'core')->getSetting('linkedin.apikey');
				 ...
				 if (!empty($linkedin_apikey) && !empty($linkedin_secret) && in_array("linkedin_mail", $this->webmail_show) && false ) {?>
					<div class="webacc-logos-img">
				 		<a href='javascript:void(0)' onclick="show_contacts_linkedin (1);" ><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/linkedin.png', '', array('align' => 'left')) ?></a>
				 	</div>	
	      <?php } ?>
			...
			<?php if( is_array($this->webmail_show) && in_array("aol", $this->webmail_show) ) { ?>
				<div class="webacc-logos-img">
					<a href='javascript:void(0)' onclick="show_contacts_aol (1);" ><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/aol.png', '') ?></a>
				</div>	
			<?php } ?>
			</div>        
			<div class="sub-txt">
	...
	<div id="id_csvcontacts" style="display:none" class="pageinvites-friends">
		<div class="header">	
			<div class="title">
				<?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/webmail.png', '') ?>
				<?php echo $this->translate("Find Your Contacts"); ?>				
			...
			<div class="webmail-options">
				...
				<div class="icons">
					<a href="javascript:void(0);" onclick="showhide('id_csvcontacts', 'id_show_networkcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/gmail16.png', '') ?></a>
					<a href="javascript:void(0);" onclick="showhide('id_csvcontacts', 'id_show_networkcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/yahoo16.png', '') ?></a>
					<a href="javascript:void(0);" onclick="showhide('id_csvcontacts', 'id_show_networkcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/windowslive16.png', '') ?></a>
					<a href="javascript:void(0);" onclick="showhide('id_csvcontacts', 'id_show_networkcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/facebook16.png', '') ?></a>
					<a href="javascript:void(0);" onclick="showhide('id_csvcontacts', 'id_show_networkcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/twitter16.png', '') ?></a>
					<a href="javascript:void(0);" onclick="showhide('id_csvcontacts', 'id_show_networkcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/linkedin16.png', '') ?></a>
					
					<a href="javascript:void(0);" onclick="showhide('id_csvcontacts', 'id_show_networkcontacts')"><?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/aol16.png', '') ?></a>
				</div>
        <div class="help-link">
					<?php echo $this->htmlLink(array('route' => 'sitepageinvite_invitefriends', 'sitepage_id' => $this->invitepage_id, 'user_id' => $this->invitepage_userid), $this->translate('or Add Email Addresses Manually'), array(
                'class' => 'smoothbox',
		...
		<div class="help-link">
			<?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/support.png', '') ?>
			<a href="javascript:void(0);" onclick="show_services();"><?php echo $this->translate("Supported Services"); ?></a><br>
			<?php echo $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitepageinvite/externals/images/help.png', '') ?>
...
<?php } ?>
	...
	<div id="id_nonsite_success_mess" style="display:none;">
		<ul class="form-notices sitepageinvite-success-message"><li><?php echo $this->translate("Your Page invitation(s) were sent successfully."); ?></li></ul>
	</div>		
    <br />
	<div class="pageinvites-friends" style="display:none;" id="network_friends">
   ...
   <br />
	...
	<div class="pageinvites-friends" style="display:none;" id="csv_friends">
		<div id="show_contacts_csv"> </div>
	</div>		
	
<div id="pageinvite_list_box">
<?php
...
<div style="display:none" id="myid">
	<div class="pageinvites-help-popup">
		<ul>
			<li>
...
<script type="text/javascript">
var semoduletype_id = '<?php echo $this->invitepage_id ;?>';
var invitepage_userid = '<?php echo $this->invitepage_userid ;?>';
semoduletype = 'sitepage';
var semoduletype_type = 'sitepage_page';
var invite_callbackURl = "<?php echo ( _ENGINE_SSL ? 'https://' : 'http://' ) . $_SERVER['HTTP_HOST'] . Zend_Controller_Front::getInstance()->getRouter()->assemble(array('sitepage_id' => $this->invitepage_id, 'user_id' => $this->invitepage_userid), 'sitepageinvite_invite', true) ;?>";
...
function show_services() {
	 var supported_services = '<div class="pageinvites-mail-supported"> <h2><?php echo $this->string()->escapeJavascript($this->translate("Supported Services")) ?></h2><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/outlook.png" alt="" /> <?php echo $this->string()->escapeJavascript($this->translate("Microsoft Outlook")) ?> <br /><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/outlookexpress.gif" alt="" /><?php echo $this->string()->escapeJavascript($this->translate("Microsoft Outlook Express")) ?><br /><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/thunderbird.png" alt="" /><?php echo $this->string()->escapeJavascript($this->translate("Mozilla Thunderbird")) ?> <br / ><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/linkedin16.png" alt="" /> <?php echo $this->string()->escapeJavascript($this->translate("LinkedIn")) ?> <br /><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/windowslive16.png" alt="" /> <?php echo $this->string()->escapeJavascript($this->translate("Windows Address Book")) ?> <br /><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/addressbook.png" alt="" /> <?php echo $this->string()->escapeJavascript($this->translate("Mac OS X Address Book")) ?><br /><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/palm.gif" width="16" alt="" /><?php echo $this->string()->escapeJavascript($this->translate("Palm Desktop")) ?><br /><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/windowslive16.png" alt="" /> <?php echo $this->string()->escapeJavascript($this->translate("Windows Mail")) ?> <br /><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Sitepageinvite/externals/images/plus.png" alt="" /> <?php echo $this->string()->escapeJavascript($this->translate("Other")) ?><br /><br /><button onclick="javascript:close_popup();"><?php echo $this->string()->escapeJavascript($this->translate("Close")) ?></button></div>';
