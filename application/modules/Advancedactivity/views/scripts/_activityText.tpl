...
<?php if (!$this->feedOnly && !$this->onlyactivity): ?>
<ul class='feed feed_sections_<?php echo $this->feedSettings['memberPhotoStyle'] ?>' id="activity-feed">
  <?php endif ?>
  <?php
        ...
        <div class="aaf_feed_top_section_title">
          ...
          <div class="aaf_feed_top_footer">
            ...
            <?php if ($action->privacy): ?>
              ...
              <span class="aaf_icon_feed_<?php echo $privacy ?> feed_item_privacy"
                    title="<?php echo $this->translate("Shared with: %s", $this->translate($privacy_titile)) ?>">
                </span>
            <?php endif; ?>
