...
<?php if ($this->enableComposer): ?>
  ...
  <div id="aaf_feed_box_container" class="aaf_feed_box_container">
    ...
    <div class="adv_post_container nolinks adv_post_container_<?php echo $this->statusBoxDesign ?>"
         id="activity-post-container"
         style="display: none;">
      <form method="post"
            action="<?php echo $this->url(array('module' => 'advancedactivity', 'controller' => 'index', 'action' => 'post'), 'default', true) ?>"
            enctype="application/x-www-form-urlencoded"
            id="activity-form">
        <?php if ($this->statusBoxDesign == 'activator_top') : ?>
          <div class="adv_post_compose_menu adv_post_container_attachment_on_top composer_activator_collapse_more_options"
               id="adv_post_container_icons"
               data-expand-always="<?php echo (int)in_array($this->statusBoxDesign, $expandBox) ?>">
            ...
            <span id="aaf_top_expand_more_options" class="aaf_activaor_more">
              ...
              <p class="adv_post_compose_menu_show_tip adv_composer_tip">
                <?php echo $this->translate("More") ?>
                <img alt=""
                     src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Advancedactivity/externals/images/tooltip-arrow-down.png"/>
              </p>
        ...
        <?php else: ?>
          <?php if ($showAlbumLink || $showVideoLink): ?>
            <div class="compose-tray adv_post_container_attachment adv_post_container_tabs">
              <div class="compose-menu active" id="compose-status-menu-link"><a href="javascript:void(0);"
                                                                                title="<?php echo $this->translate('Update Status'); ?>"
                                                                                onclick='showAafDefaultActivator();'
                                                                                class="item_icon_update"><?php echo $this->translate("Update Status"); ?></a>
              </div>
              <?php if ($showAlbumLink): ?>
                <div class="compose-menu" id="compose-photo-menu-link">
                  ...
                  <a href="javascript:void(0);"
                     title="<?php echo $this->translate('Add Photo'); ?>"
                     onclick='showAafPhotoActivator();'
                     class="item_icon_photo"><?php echo $this->translate('Add Photo'); ?></a>
                </div>
                <div class="compose-menu">
                  <span class="aaf_media_sep seaocore_txt_light"><?php echo $this->translate('|'); ?></span>
                  <?php if (Engine_Api::_()->hasModuleBootstrap('sitealbum') && $this->settings('sitealbum.open.lightbox.upload', 1)): ?>
                    <a title="<?php echo $this->translate('Create Photo Album'); ?>"
                       href="<?php echo $this->url(array('action' => 'upload'), 'sitealbum_general', true); ?>"
                       class="seao_smoothbox item_icon_album"
                       data-SmoothboxSEAOClass="seao_add_photo_lightbox"><?php echo $this->translate('Create Photo Album'); ?></a>
                  <?php else: ?>
                    <a title="<?php echo $this->translate('Create Photo Album'); ?>"
                       href="<?php echo $this->url(array('action' => 'upload'), 'sitealbum_general', true); ?>"
                       class="item_icon_album"><?php echo $this->translate('Create Photo Album'); ?></a>
                  <?php endif; ?>
                </div>
              <?php endif; ?>
              ...
              <?php if (Engine_Api::_()->hasModuleBootstrap('sitevideo') && $showVideoLink): ?>
                ...
                <div class="compose-menu" id="compose-video-menu-link">
                  <span class="aaf_media_sep seaocore_txt_light"><?php echo $this->translate('|'); ?></span>
                  <?php if ($channel_id): ?>
                    <a title="<?php echo $this->translate('Add Video'); ?>"
                       href="<?php echo $this->url(array('action' => 'create', 'channel_id' => $channel_id), 'sitevideo_video_general', true); ?>"
                       class="seao_smoothbox item_icon_video"
                       data-SmoothboxSEAOClass="seao_add_video_lightbox"><?php echo $this->translate('Add Video'); ?></a>
                  <?php else: ?>
                    <?php if (empty($this->parentType)): ?>
                      <a title="<?php echo $this->translate('Add Video'); ?>"
                         href="<?php echo $this->url(array('action' => 'create'), 'sitevideo_video_general', true); ?>"
                         class="seao_smoothbox item_icon_video"
                         data-SmoothboxSEAOClass="seao_add_video_lightbox"><?php echo $this->translate('Add Video'); ?></a>
                    <?php else : ?>
                      <a title="<?php echo $this->translate('Add Video'); ?>"
                         href="<?php echo $this->url(array('action' => 'create', 'parent_type' => $this->parentType, 'parent_id' => $this->parentId), 'sitevideo_video_general', true); ?>"
                         class="seao_smoothbox item_icon_video"
                         data-SmoothboxSEAOClass="seao_add_video_lightbox"><?php echo $this->translate('Add Video'); ?></a>
                    <?php endif; ?>
                  <?php endif; ?>
              ...
              <?php elseif (Engine_Api::_()->hasModuleBootstrap('video') && $showVideoLink): ?>
                <div class="compose-menu" id="compose-video-menu-link">
                  ...
                  <a title="<?php echo $this->translate('Add Video'); ?>"
                     ...
                     class="seao_smoothbox item_icon_video"
                     onclick='showAafVideoActivator();'><?php echo $this->translate('Add Video'); ?></a>
                </div>
              <?php endif; ?>
            </div>
          <?php endif; ?>
        ...
        <div class="adv_post_container_box seaocore_box_sizing">
          <div class="adv_post_box">
            <div id="compose-top-tray"
                 class="compose-tray compose-top-tray adv_post_container_attachment"
                 style="display:none;"></div>
            <textarea id="advanced_activity_body"
                      cols="1"
                      rows="1"
                      name="body"
                      placeholder="<?php echo $this->escape($this->translate('Post Something...')) ?>"></textarea>
          </div>
        ...
        <?php endif; ?>
        <?php if ($this->statusBoxDesign !== 'activator_top') : ?>
          <div class="adv_post_compose_menu <?php echo in_array($this->statusBoxDesign, $expandBox) ? 'composer_activator_expand_more_options' : 'composer_activator_collapse_more_options' ?>"
               id="adv_post_container_icons"
               data-expand-always="<?php echo (int)in_array($this->statusBoxDesign, $expandBox) ?>">
        ...
        <?php if ($allowScheduledPost): ?>
          <div id="aaf_schedule_time" class="dnone">
            ...
            <div class="aaf_smoothbox_popup seaocore_box_sizing">
              <div class="aaf_smoothbox_popup_header"><h3><?php echo $this->translate("Schedule Your Post") ?></h3>
              </div>
              ...
              <div class="aaf_smoothbox_popup_buttons">
                <button type="submit"
                        class="aaf_schedule_time_schedule"><?php echo $this->translate("Schedule"); ?></button>
                <button type="button"
                        class="aaf_schedule_time_cancel"><?php echo $this->translate("Cancel"); ?></button>
              </div>
            </div>
          </div>
        <?php endif; ?>
        <div class="adv-activeity-post-container-bottom" id="advanced_compose-menu">
          <div class="advanced_compose-menu-buttons" id="advanced_compose-menu-buttons">
            ...
            <p class="adv_target_post_tip adv_composer_tip">
                    ...
                    <img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Advancedactivity/externals/images/tooltip-arrow-down.png"
                         alt=""/>
                  </p>
                   <a href="javascript:void(0);"
                      class="button_link adv_button_target_post compose-activator"
                      onclick="showHideTargetUserOptions()"><i class="fa fa-crosshairs"></i></a>
            </span>
            ...
            <p class="adv_schedule_post_tip adv_composer_tip">
                   ...
                   <a href="javascript:void(0);"
                      class="button_link adv_button_schedule_post"
                      onclick="showHideScheduleTimeOptions('aaf_schedule_time')"><i class="fa fa-calendar"></i></a>
            </span>
            ...
            <?php if ($this->showPrivacyDropdown): ?>
              ...
              <div class='advancedactivity_privacy_list' id='advancedactivity_friend_list'>
                <span class="aaf_privacy_pulldown"
                      id="pulldown_privacy_list"
                      onClick="togglePrivacyPulldown(event, this)">
    ...
    <?php // if($content !='friends' || $this->enableList):   ?>
                        <?php foreach ($availableLabels as $key => $value): ?>
                          <li class="<?php echo($key == $content ? 'aaf_tab_active' : 'aaf_tab_unactive') ?> user_profile_friend_list_<?php echo $key ?> aaf_custom_list"
                              id="privacy_list_<?php echo $key ?>"
                              onclick="setAuthViewValue('<?php echo $key ?>', '<?php echo $this->string()->escapeJavascript($this->translate($value)); ?>', 'aaf_icon_feed_<?php echo $key ?>')"
                              title="<?php echo $this->translate("Share with %s", $this->translate($value)); ?>">
                        ...
                        <?php if ($this->enableList && $this->countList): ?>
                          ...
                          foreach ($this->lists as $list):
                            ...
                            ?>
                            <li class="<?php echo((!empty($this->privacylists) && isset($this->privacylists[$list->list_id])) ? 'aaf_tab_active' : 'aaf_tab_unactive') ?> user_profile_friend_list_<?php echo $list->list_id ?> aaf_custom_list"
                                id="privacy_list_<?php echo $list->list_id ?>"
                                onclick="setAuthViewValue('<?php echo $list->list_id ?>', '<?php echo $this->string()->escapeJavascript($this->translate($list->title)) ?>', 'aaf_icon_feed_list')"
                                title="<?php echo $this->translate("Share with %s", $list->title); ?>">
                        ...
                        <?php if ($this->enableNetworkList): ?>
                          ...
                          foreach ($this->network_lists as $list):
                            ...
                            ?>
                            <li class="<?php echo((!empty($this->privacylists) && isset($this->privacylists["network_" . $list->getIdentity()])) ? 'aaf_tab_active' : 'aaf_tab_unactive') ?> user_profile_network_list_<?php echo $list->getIdentity() ?> aaf_custom_list"
                                id="privacy_list_<?php echo "network_" . $list->getIdentity() ?>"
                                onclick="setAuthViewValue('<?php echo "network_" . $list->getIdentity() ?>', '<?php echo $this->string()->escapeJavascript($this->translate($list->getTitle())) ?>', 'aaf_icon_feed_network_list')"
                                title="<?php echo $this->translate("Share with %s", $list->getTitle()); ?>">
      ...
      <?php if ($this->enableNetworkList > 1): ?>
                            <li class="sep"></li>
                            <li onclick="addMoreListNetwork();"
                                class="aaf_custom_list"
                                id="user_profile_network_list_custom"
                                title="<?php echo $this->translate("Choose multiple Networks to share with."); ?>"><i
                                class="aaf_privacy_pulldown_icon aaf_icon_feed_custom"></i><div
                        ...
                        <?php if ($this->enableList): ?>
                          <?php if ($this->countList > 1): ?>
                            ...
                            <li onclick="addMoreList();"
                                class="aaf_custom_list"
                                id="user_profile_friend_list_custom"
                                title="<?php echo $this->translate("Choose multiple Friend Lists to share with."); ?>">
            ...
            <?php else: ?>
              <input type="hidden"
                     id="auth_view"
                     name="auth_view"
                     value="<?php echo $this->settings('activity.content', 'everyone'); ?>"/>
            <?php endif; ?>
            ...
            <?php if (count($this->categoriesList)): ?>
              ...
              <div class='advancedactivity_privacy_list' id='advancedactivity_categories_list'>            
                <span class="aaf_privacy_pulldown"
                      id="pulldown_categories_list"
                      onClick="toggleCatPulldown(event, this)">
                  <p class="adv_privacy_list_tip adv_composer_tip">
                  ...
                  <div class="aaf_pulldown_contents_wrapper">
                    <div class="aaf_pulldown_contents">
                      <ul>
                        <li class="aaf_tab_active user_profile_friend_list_<?php echo 0 ?> aaf_custom_list"
                            id="category_list_<?php echo 0 ?>"
                            onclick="setAAFCategoyValue('0', '<?php echo $this->string()->escapeJavascript($this->translate('Select Category')); ?>', 'aaf_icon_feed_0')"
                            title="<?php echo $this->translate("Post in No Category"); ?>">
                        ...
                        <?php foreach ($this->categoriesList as $key => $value): ?>
                          <li class="aaf_tab_unactive user_profile_friend_list_<?php echo $value->category_id ?> aaf_custom_list"
                              id="category_list_<?php echo $value->category_id ?>"
                              onclick="setAAFCategoyValue('<?php echo $value->category_id ?>', '<?php echo $this->string()->escapeJavascript($this->translate($value->category_name)); ?>', 'aaf_icon_feed_<?php echo $value->category_id ?>')"
                              title="<?php echo $this->translate("Post in %s", $this->translate($value->category_name)); ?>">
            ...
            <div id="aaf_composer_loading" class="show_loading" style="display:none;">
      ...
      <script type="text/javascript">
        ...
        var statusBoxDesign = '<?php echo ($this->statusBoxDesign == "activator_buttons") ? true : false; ?>';
        ...
        en4.core.runonce.add(function () {
          ...
          composeInstance = new Composer('advanced_activity_body', {
            ...
            template: '<?php echo $this->statusBoxDesign; ?>',
