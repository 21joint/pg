 ...
 * @version    $Id: import-faqs.tpl 6590 2012-18-05 00:00:00Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
?>

<?php if(empty($this->show_form)):?>
	<div class="tip">
		<span>
			<?php echo $this->translate('No CSV files for importing FAQs of plugins could be found.');  ?>
		</span>
	</div>
<?php return; endif;?>
