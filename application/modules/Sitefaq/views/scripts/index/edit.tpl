 ...
 * @version    $Id: edit.tpl 6590 2012-18-05 00:00:00Z SocialEngineAddOns $
...
<div class='global_form sitefaq_form'>
	...
	<script type="text/javascript">
		...
		var totalPermitCategories = '<?php echo $this->maxCategories; ?>';
		var maxCategories = '<?php echo $this->maxCategories; ?>';
		var category_exist = '<?php echo $this->category_exist; ?>';
		var created_categories = '<?php echo $this->created_categories; ?>';
    ...
    var optionParent = $('category_id_'+count).getParent().getParent().getParent();
		...
		window.addEvent('domready', function() {
			...
			if( maxCategories == 1 || category_exist != 1 || created_categories == totalPermitCategories) {
				$('addCategoryLink').destroy();
			}
		});
