 ...
 * @version    $Id: form-search.tpl 6590 2012-18-05 00:00:00Z SocialEngineAddOns $
					...
					<li>
						...
						<div style="width:45%;" class="admin_table_centered">
							<?php if($item->display == 1):?>
								<?php   echo $this->htmlLink(array('route' => 'default', 'module' => 'sitefaq', 'controller' => 'admin-settings', 'action' => 'diplay-form', 'id' => $item->searchformsetting_id,'display'=>0), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitefaq/externals/images/approved.gif', '', array('title'=> $this->translate('Hide')))); ?>
							<?php else: ?>
								<?php   echo $this->htmlLink(array('route' => 'default', 'module' => 'sitefaq', 'controller' => 'admin-settings', 'action' => 'diplay-form', 'id' => $item->searchformsetting_id,'display'=>1), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sitefaq/externals/images/disapproved.gif', '', array('title'=> $this->translate('Display')))); ?>
							<?php endif; ?>
						</div>
					</li>
				<?php endforeach; ?>
