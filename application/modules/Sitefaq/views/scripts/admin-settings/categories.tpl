 ...
 * @version    $Id: categories.tpl 6590 2012-18-05 00:00:00Z SocialEngineAddOns $
...
<div class='clear settings'>
  <div class='global_form seaocore_categories_block'>
    <div>
      <div>
        <h3><?php echo $this->translate("FAQs Categories") ?></h3>
        <h4 class="description"><?php echo $this->translate("Below, you can add and manage the various categories, sub-categories and 3rd level categories for the FAQs on your site. Sub-categories are very useful as they allow you to further categorize and organize the FAQs on your site beyond the superficial categories. You can also add icons for categories, sub-categories and 3rd level categories. To do so, click on 'Add' option available against the categories, sub-categories and 3rd level categories. Below, you will be able to edit, delete and see preview of the icons.<br/>Note : To edit categories, sub-categories and 3rd level categories, click on their names.");?></h4>
            ...
            <div id="cat_<?php echo $value['category_id']; ?>" class="seaocore_admin_cat">
              ...
              <?php $link = "<a href='javascript:editcat(" . $value['category_id'] . ", 0, " . $value['count'] . ");' id='cat_" . $value['category_id'] . "_title'>" . $category_name . "</a> [" . $value["count"] . "]"; ?>
							...
							<div class="admin_file">
								<?php echo "<img src='".$this->layout()->staticBaseUrl."application/modules/Sitefaq/externals/images/folder_open_yellow.gif' border='0' class='seaocore_subcat_handle handle_cat' ><span id='cat_" . $value['category_id'] . "_span'>$link</span>" ?>
								...
								<?php if(!empty($value['file_id'])):?>
									<span class="categories-image-preview seaocore_file_preview_wrapper">
										...
										|
									<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitefaq', 'controller' => 'settings', 'action' => 'edit-icon', 'category_id' => $value['category_id']), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
										| 
									<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitefaq', 'controller' => 'settings', 'action' => 'delete-icon', 'category_id' => $value['category_id']), $this->translate('Delete'), array(
										'class' => 'smoothbox',
									)) ?> 

								<?php else:?>
									<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitefaq', 'controller' => 'settings', 'action' => 'add-icon', 'category_id' => $value['category_id']), $this->translate('Add'), array('class' => 'smoothbox')) ?>
								<?php endif;?>
							</div>
                ...
                <?php foreach ($value['sub_categories'] as $subcategory): ?>
                  <div id="cat_<?php echo $subcategory['sub_cat_id']; ?>" class="seaocore_sub_cat_list">
                    ...
                    <?php $subcats = "<a href='javascript:editcat(" . $subcategory["sub_cat_id"] . ", " . $value['category_id'] . ", " . $subcategory["count"] . ");' id='cat_" . $subcategory["sub_cat_id"] . "_title'>$subcatname</a>" ?>
										...
										<div class="admin_file">
											<?php echo "<img src='".$this->layout()->staticBaseUrl."application/modules/Sitefaq/externals/images/folder_open_green.gif' border='0' class='seaocore_subcat_handle handle_subcat_" . $value['category_id'] . "'><span id='cat_" . $subcategory["sub_cat_id"] . "_span'>$subcats [" . $subcategory["count"] . "]</span>" ?>
											...
											<?php if(!empty($subcategory['file_id'])):?>
												<span class="categories-image-preview seaocore_file_preview_wrapper">
													...
													|
												<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitefaq', 'controller' => 'settings', 'action' => 'edit-icon', 'category_id' => $subcategory['sub_cat_id']), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
													| 
												<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitefaq', 'controller' => 'settings', 'action' => 'delete-icon', 'category_id' => $subcategory['sub_cat_id']), $this->translate('Delete'), array(
													'class' => 'smoothbox',
												)) ?> 

											<?php else:?>
												<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitefaq', 'controller' => 'settings', 'action' => 'add-icon', 'category_id' => $subcategory['sub_cat_id']), $this->translate('Add'), array('class' => 'smoothbox')) ?>
											<?php endif;?>
                      ...
                      <?php if(isset($subcategory['tree_sub_cat'])):?>
                        ...
                        <input type="hidden" id="cat_<?php echo $treesubcategory['tree_sub_cat_id']; ?>_input_count" value="<?php echo $treesubcategory['count'] ?>">
                          ...
                          <?php $treesubcats = "<a href='javascript:editcat(" . $treesubcategory["tree_sub_cat_id"] . ", " . $subcategory['sub_cat_id'] . ", " . $treesubcategory["count"] . ");' id='cat_" . $treesubcategory["tree_sub_cat_id"] . "_title'>$treesubcatname</a>" ?>
													...
													<div class="admin_file">
														<?php echo "<img src='".$this->layout()->staticBaseUrl."application/modules/Sitefaq/externals/images/folder_open_green.gif' border='0' class='seaocore_subcat_handle handle_treesubcat_" . $subcategory['sub_cat_id'] . "'><span id='cat_" . $treesubcategory["tree_sub_cat_id"] . "_span'>$treesubcats [" . $treesubcategory["count"] . "]</span>" ?>
														...
														<?php if(!empty($treesubcategory['file_id'])):?>
															<span class="categories-image-preview seaocore_file_preview_wrapper">
																...
																|
															<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitefaq', 'controller' => 'settings', 'action' => 'edit-icon', 'category_id' => $treesubcategory['tree_sub_cat_id']), $this->translate('Edit'), array('class' => 'smoothbox')) ?>
																| 
															<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitefaq', 'controller' => 'settings', 'action' => 'delete-icon', 'category_id' => $treesubcategory['tree_sub_cat_id']), $this->translate('Delete'), array(
																'class' => 'smoothbox',
															)) ?> 

														<?php else:?>
																<?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitefaq', 'controller' => 'settings', 'action' => 'add-icon', 'category_id' => $treesubcategory['tree_sub_cat_id']), $this->translate('Add'), array('class' => 'smoothbox')) ?>
														<?php endif;?>
...
<script type="text/javascript">
  ...
  //THIS FUNCTION ADDS A CATEGORY INPUT TO THE FAQs
  function addcat() 
  {
    ...
    newdiv.innerHTML ='<div><img src="<?php echo $this->layout()->staticBaseUrl;?>application/modules/Sitefaq/externals/images/folder_open_yellow.gif" border="0" class="seaocore_subcat_handle handle_cat"><span id="cat_new_span"><input type="text" id="cat_new_input" maxlength="100" onBlur="savecat(\'new\', \'\', \'\')" onkeypress="return noenter_cat(\'new\', event)"></span></div>';
  ...
  { 
    ...
    if(catinput.value == "" && catid == "new") {		
      removecat(catid);
			...
			if(cat_dependency == 0) {
				Smoothbox.open('<?php echo $baseurl ?>'+'/admin/sitefaq/settings/mapping-category/catid/'+catid+'/cat_dependency/'+cat_dependency+'/cat_title/'+encodeURIComponent(catinput.value)+'/subcat_dependency/'+subcat_dependency+'/oldcat_title/'+oldcat_title);
			}
			else {
				if(confirm("<?php echo $this->string()->escapeJavascript($this->translate("Are you sure you want to delete this category? NOTE: If you are deleting a main category, all subcategories and 3rd level categories will be deleted as well.")); ?>" )) {
					$('ajaxframe').src = '<?php echo $baseurl ?>'+'/admin/sitefaq/settings/categories?task=savecat&cat_id='+catid+'&cat_dependency='+cat_dependency+'&cat_title='+encodeURIComponent(catinput.value)+'&subcat_dependency='+subcat_dependency;
				} else {
  ...
  //THIS FUNCTION REMOVES A CATEGORY FROM THE FAQs
  ...
  function savecat_result(old_catid, new_catid, cat_title, cat_dependency, subcat_dependency)
  {
    ...
    catspan.innerHTML = '<a href="javascript:editcat(\''+new_catid+'\', \''+cat_dependency+'\', \''+count+'\');" id="cat_'+new_catid+'_title">'+cat_title+'</a>';
      ...
      catspan.innerHTML = catspan.innerHTML + " [" + count + "]";
			var icon_element = 	'<a class="smoothbox t_normal" href="<?php echo $this->url(array('module' => 'sitefaq', 'controller' => 'settings', 'action' => 'add-icon'),"admin_default") ?>/category_id/'+new_catid+'"><?php echo $this->translate('Add');?></a>' + ' <b class="bold"><?php echo $this->translate('Icon: ') ?></b>' + '<b> | </b>';
  ...
  function changeorder(sitefaqorder, divId) 
  {
    $('ajaxframe').src = '<?php echo $baseurl ?>'+'/admin/sitefaq/settings/categories?task=changeorder&sitefaqorder='+sitefaqorder+'&divId='+divId;
  }
  ...
  function addsubcat(catid, subcatdependency)
  {
    ...
    newdiv.innerHTML = '<div><img src="<?php echo $this->layout()->staticBaseUrl;?>application/modules/Sitefaq/externals/images/folder_open_green.gif" border="0" class="seaocore_subcat_handle handle_subcat_'+catid+'"><span id="cat_new_span"><input type="text" id="cat_new_input" maxlength="100" onBlur="savecat(\'new\', \'\', \''+catid+'\', \''+subcatdependency+'\')" onkeypress="return noenter_cat(\'new\', event)"></span></span></div>';
    catarea.appendChild(newdiv);
    var catinput = $('cat_new_input');
    catinput.focus();
  }
  ...
  function addtreesubcat(catid, subcat_dependancy)
  {
    ...
    newdiv.innerHTML = '<div><img src="<?php echo $this->layout()->staticBaseUrl;?>application/modules/Sitefaq/externals/images/folder_open_green.gif" border="0" class="seaocore_subcat_handle handle_treesubcat_'+catid+'"><span id="cat_new_span"><input type="text" id="cat_new_input" maxlength="100" onBlur="savecat(\'new\', \'\', \''+catid+'\', \''+catid+'\')" onkeypress="return noenter_cat(\'new\', event)"></span></span></div>';
    catarea.appendChild(newdiv);
    var catinput = $('cat_new_input');
    catinput.focus();
  }
