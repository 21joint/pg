...
<?php if (count($this->categories)):?>
	<?php if(!$this->search_form_widget):?>
		<form id='filter_form_category' class='global_form_box' method='get' action='<?php echo $this->url(array('action' => 'browse'), 'sitefaq_general', true) ?>' style='display: none;'>
  ...
  <ul class="sitefaq_browse_category">
    <li>
      <a href="javascript:categoryAction(0,'',0,'',0,'')" <?php if ($this->category == 0): ?>class="bold"<?php endif; ?>>
      	<span class="cat_icon"><img alt=""  src='<?php echo $this->layout()->staticBaseUrl;?>application/modules/Sitefaq/externals/images/category_icons/category.png' border='0' /></span>
