...
class Sitefaq_Widget_SidebarCategoriesSitefaqsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
		...
		$this->view->search_form_widget = $sitefaq_api->existWidget('browse_categories', $this->view->identity);

		//GET DOCUMENT CATEGORY TABLE
    $this->view->categoryTable = $tableCategory = Engine_Api::_()->getDbTable('categories', 'sitefaq');
