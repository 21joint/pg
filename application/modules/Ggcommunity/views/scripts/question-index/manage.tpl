            ...
            <ul class="topic_holder">
                <?php foreach($this->paginator as $item):?>
                    <li class="struggle_holder">
                        ...
                        <div class="struggle_box_right large-3 small-5">
                            <ul class="struggle_count_info large-10 large-offset-2">
                                ...
                                <li class="count_info" id="answer_count">
                                    ...
                                    <p class="count_title <?php echo ($item->open==1 ? 'title_active' : 'title_close');?>"><?php echo $this->translate('answers');?></p>
                                </li>
