    ...
    <div class="widget_holder">
        ...
        <?php if($this->new_struggle == 1):?>
            <?php  if($this->permissions['create_question'] != 0):?>
                <a href="<?php echo $this->url(array('module'=>'ggcommunity', 'controller'=>'question-index', 'action'=>'create'),'default', true);?>" class="new_struggle_link large-3 small-6">
            ...
            <?php else: ?>
                <div class="holder-tooltip large-12">
                    ...
                    <div class="new_struggle_tooltip">
                        <?php $url=$this->url(array('module'=>'ggcommunity','controller'=>'question-index', 'action'=>'create'), 'default', true);?>
