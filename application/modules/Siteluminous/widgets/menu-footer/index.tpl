...
//  if ($navigation->uri != 'javascript:void(0)' && empty($flag)):
//    continue;
//  else:
    if ($navigation->uri == 'javascript:void(0)') :      
      ...
      if (!empty($navigation->icon)) :
        $footertempCatContent = '<div class="siteluminous_footer_block" style="background-image:url(\''. $navigation->icon. '\'); background-repeat:no-repeat;"><ul>';
      else:
        $footertempCatContent = '<div class="siteluminous_footer_block"><ul><li class="siteluminous_footer_block_head">' . $this->translate($navigation->getLabel()) . '</li>';
      endif;
    else:
