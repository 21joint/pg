...
class Sitelogin_Model_Dbtable_Vk extends Engine_Db_Table {
    ...
    function getAuthorizationCode() {
        ...
        $redirect_uri = $this->getVkRedirectUrl();
        try {
    ...
    function fetch() {
        $params = array('access_token' => $_SESSION['access_token'],'fields'=>'photo_50,first_name,last_name,bdate');
    ...
    public function getVkRedirectUrl() {
        ...
        return $domainUrl . '/sitelogin/auth/vk';
    }
