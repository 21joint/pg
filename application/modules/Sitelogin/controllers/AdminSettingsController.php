...
class Sitelogin_AdminSettingsController extends Core_Controller_Action_Admin {
    ...
    public function indexAction() {
        ...
        include_once APPLICATION_PATH . '/application/modules/Sitelogin/controllers/license/license1.php';
    ...
    public function googleAction() {
        ...
        if ($googleSettings['quickEnable'] && empty($defaultSubscriptionId) && $subscriptionEnabed) {
        ...
        include_once APPLICATION_PATH . '/application/modules/Sitelogin/controllers/license/license2.php';
    ...
    public function linkedinAction() {
        ...
        if ($linkedinSettings['quickEnable'] && empty($defaultSubscriptionId) && $subscriptionEnabed) {
            $this->view->showSubscriptionError = 1;
        }
    ...
    public function facebookAction() {
        ...
        if ($facebookSettings['quickEnable'] && empty($defaultSubscriptionId) && $subscriptionEnabed) {
            $this->view->showSubscriptionError = 1;
        }
    ...
    public function flickrAction() {
        ...
        if ($flickrSettings['quickEnable'] && empty($defaultSubscriptionId) && $subscriptionEnabed) {
            $this->view->showSubscriptionError = 1;
        }
    ...
    public function outlookAction() {
        ...
        if ($outlookSettings['quickEnable'] && empty($defaultSubscriptionId) && $subscriptionEnabed) {
            $this->view->showSubscriptionError = 1;
        }
    ...
    public function vkAction() {
        ...
        if ($vkSettings['quickEnable'] && empty($defaultSubscriptionId) && $subscriptionEnabed) {
            $this->view->showSubscriptionError = 1;
        }
