...
class Sitelogin_Form_Admin_Global extends Engine_Form {
    ...
    public function init() {
        ...
        $this->addElement('Select', 'sitlogin_signuplayout', array(
            'label' => 'Layout',
            'description' => 'Select the layout for social media buttons. <a title="Preview - Layouts" href="application/modules/Sitelogin/externals/images/layout_preview.png" target="_blank" class="seaocore_icon_view" > </a>',
            'multiOptions' => array(
                4 => 'Icon View (Circle)',
                5 => 'Icon View (Round)',
                6 => 'Icon View (Square)',
