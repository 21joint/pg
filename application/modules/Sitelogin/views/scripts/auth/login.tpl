...
<div class="prg-auth position-fixed d-flex bg-white h-100">
  <div class="container-fluid mw-100 px-0">
    <div class="row no-gutters h-100 holder-form holder-forgot">
      ...
      <div class="right-side col-xl-6 col-lg-6">
        <div id="sociallogin_signin_popup"
             class="<?php echo empty($this->inwidget) ? '' : 'sociallogin_signin_popup' ?> h-100">
          <div class="row no-gutters social-signin-layout-<?php echo $layoutPos[$position] ?> h-100 align-items-center justify-content-center">
              ...
              <?php else : ?>
                ...
                <div class="col-xl-6 col-lg-6 h-100 w-100 d-flex align-items-center pl-0">
                    <?php echo $this->form->render($this) ?>
                </div>
