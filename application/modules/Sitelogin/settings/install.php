...
class Sitelogin_Installer extends Engine_Package_Installer_Module {
    ...
    public function onPreinstall() {
        $PRODUCT_TYPE = 'sitelogin';
        $PLUGIN_TITLE = 'Sitelogin';
        $PLUGIN_VERSION = '4.9.4p5';
        $PLUGIN_CATEGORY = 'plugin';
        $PRODUCT_DESCRIPTION = 'SEAO - Social Login and Sign-up Plugin';
        $PRODUCT_TITLE = 'Social Login and Sign-up Plugin';
    ...
    function onInstall() {
        $db = $this->getDb();
        $db->query("UPDATE  `engine4_seaocores` SET  `is_activate` =  '1' WHERE  `engine4_seaocores`.`module_name` ='sitelogin';");
