...
<div data-role="popup" id="popupBasic_<?php echo $this->identity ?>_<?php echo $filter ?>" data-position-to="window" class="ui-content ui-corner-all" data-overlay-theme="a">
  ...
  <div class="change_location_form" id="dialog-form">
    <form method="post" action="" class="global_form" enctype="application/x-www-form-urlencoded" id="seaocore_change_my_location">
      <div>
        <div>
          <h3 class="font-weight-bold"><?php echo $this->translate("Change My Location"); ?></h3>
