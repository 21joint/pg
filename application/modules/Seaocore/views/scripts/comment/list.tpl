...
$this->subject->getType()?>',<?php echo $this->subject->getIdentity() ?> , '<?php echo $this->show_bottom_post ?>');
    ...
    $('comment-form_<?php echo
$this->subject->getType()?>_<?php echo $this->subject->getIdentity() ?>').getElementById('submit').style.display='none';
    
    <?php if($this->submit_post):?>
      if($('comment-form-open-li_<?php echo $this->subject->getType()?>_<?php echo $this->subject->getIdentity() ?>')){ $('comment-form-open-li_<?php echo $this->subject->getType()?>_<?php echo $this->subject->getIdentity() ?>').style.display = 'none'; } $('comment-form_<?php echo $this->subject->getType()?>_<?php
echo $this->subject->getIdentity() ?>').style.display = '';$('comment-form_<?php echo
$this->subject->getType()?>_<?php echo $this->subject->getIdentity() ?>').body.focus()
      <?php endif; ?>
    <?php endif; ?>
    });
  </script>
