 ...
 * @version    $Id: form-search.tpl 2010-07-08 9:40:21Z SocialEngineAddOns $
...
<p>
  <?php echo $this->translate('This page lists all the fields which will be displayed to the users in the search form widget at "Browse Feedbacks" and "My Feedbacks". Below, you can set the sequence of items in the order in which they should appear to users in the search form. To do so, drag-and-drop the items vertically and click on "Save Order" to save the sequence. You can also hide/display the individual fields in this search form.') ?>
</p>
								...
								<td>
									...
									<div style="width:20%;" class='admin_table_centered fleft'>
										<?php if($item->display == 1):?>
											<?php   echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'feedback', 'controller' => 'settings', 'action' => 'diplay-form', 'id' => $item->searchformsetting_id,'display'=>0), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Feedback/externals/images/feedback_approved1.gif', '', array('title'=> $this->translate('Hide')))); ?>
										<?php else: ?>
											<?php   echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'feedback', 'controller' => 'settings', 'action' => 'diplay-form', 'id' => $item->searchformsetting_id,'display'=>1), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Feedback/externals/images/feedback_approved0.gif', '', array('title'=> $this->translate('Display')))); ?>
