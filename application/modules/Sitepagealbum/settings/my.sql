...
INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('sitepagealbum', 'Page Albums', 'Sitepagealbum', '4.9.4p2', 1, 'extra');
...
('sitepagealbum_create', 'sitepagealbum', '{item:$subject} has created a page album {item:$object}.', 0, '');
