 ...
 * @version    $Id: _jsAdmin.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<script type="text/javascript">
  ...
  var urls = {
    option : {
      create : en4.core.baseUrl + 'sitepageform/siteform/option-create',
      edit :   en4.core.baseUrl + 'sitepageform/siteform/option-edit',
      remove : en4.core.baseUrl + 'sitepageform/siteform/option-delete'
    },
    field : {
      create : en4.core.baseUrl + 'sitepageform/siteform/field-create',
      edit :   en4.core.baseUrl + 'sitepageform/siteform/field-edit',
      remove : en4.core.baseUrl + 'sitepageform/siteform/field-delete'
    },

    map : {
      remove : en4.core.baseUrl + 'sitepageform/siteform/map-delete'
    },
    order : en4.core.baseUrl + 'sitepageform/siteform/order',
    index : en4.core.baseUrl + 'sitepageform/siteform/index'
  };
  ...
  var uiSmoothCreateField = function(spec) {
    ...
    url += '/option_id/' + ids.suboption_id + '/parent_id/' + ids.parent_id +'/page_id/'+page_id+'/format/smoothbox';
    Smoothbox.open(url);
  }

  var uiSmoothTopFieldCreate = function(spec) {
    var url = urls.field.create;
    url += '/option_id/' + topLevelOptionId  +'/parent_id/'+ topLevelFieldId +'/page_id/'+page_id+ '/format/smoothbox';
    Smoothbox.open(url);
  }
  ...
  var uiSmoothEditField = function(spec) {
    ...
    url += '/field_id/' + ids.child_id +'/page_id/'+ page_id + '/format/smoothbox';
    Smoothbox.open(url);
  }
