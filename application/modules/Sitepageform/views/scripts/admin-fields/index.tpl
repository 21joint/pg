...
<h2><?php echo $this->translate('Directory / Pages - Forms Extension'); ?></h2>
...
<p>
  <?php echo $this->translate('Create custom fields / questions for Page forms, which your members will be asked to fill while filling Page form. To reorder the custom questions, click on their names and drag them up or down.
Note: Page Owners can also create custom fields / questions for their Page Form, if you have enabled from the Global settings section of this plugin.') ?>
</p>
