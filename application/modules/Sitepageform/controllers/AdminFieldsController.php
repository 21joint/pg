 ...
 */
class Sitepageform_AdminFieldsController extends Fields_Controller_AdminAbstract
{
  protected $_fieldType = 'sitepageform';
  ...
  public function indexAction()
  {
    ...
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')
      ->getNavigation('sitepageform_admin_main', array(), 'sitepageform_admin_main_fields');
