 ...
 * @version    $Id: _FancyUpload.tpl.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
    ...
    . $_SERVER['HTTP_HOST'] . $this->url(array(
      ...
      onFileRemove: function(file) {
        ...
        request = new Request.JSON({
          'format' : 'json',
          'url' : '<?php echo $this->url(array('action' => 'remove-song'), 'sitepagemusic_general') ?>',
          'data': {
            'format': 'json',
            'song_id' : file_id
          },
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('_SITEPAGEMUSIC_UPLOAD_DESCRIPTION') ?>
  </div>
  <div>
    <a class="buttonlink icon_sitepagemusic_new" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Music') ?></a>
  ...
  <div class="demo-status-overall" id="demo-status-overall" style="display:none">
    ...
    <img src="<?php echo $this->layout()->staticBaseUrl . 'externals/fancyupload/assets/progress-bar/bar.gif'; ?>" class="progress overall-progress" alt="" />
  </div>
  <div class="demo-status-current" id="demo-status-current" style="display:none">
    <div class="current-title"></div>
    <img src="<?php echo $this->layout()->staticBaseUrl . 'externals/fancyupload/assets/progress-bar/bar.gif'; ?>" class="progress current-progress" alt="" />
  </div>
