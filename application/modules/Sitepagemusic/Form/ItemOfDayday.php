 ...
 */
class Sitepagemusic_Form_ItemOfDayday extends Engine_Form {

  protected $_field;

  public function init() {
    $this->setMethod('post');
    $this->setTitle('Add a Music of the Day')
            ->setDescription('Select a start date and end date below.This music will be displayed as "Music of the Day" for this duration.If more than one musics of the day are found for a date then randomly one will be displayed.');
