 ...
 */
class Sitepagemusic_Form_Sitemobile_Create extends Engine_Form {
  ...
  public function clearUploads() {
    ...
    $this->getElement('FancyUpload')->setValue('');
  }
  ...
  public function saveValues() {
      ...
      if (!empty($values['playlist_id']))
        ...
        if ($playlist->search) {
          ...
          if ($activityFeedType) {
            $action = $activity->addActivity(Engine_Api::_()->user()->getViewer(), $sitepage, $activityFeedType, null, array('count' => count($_FILES['Filedata']['name']), 'linked_music_title' => $linked_music_title));
