...
<ul class="sitepage_sidebar_list">
  <?php foreach ($this->paginator as $sitepagemusic): ?>
    <li>             
      ...
      <div class='sitepage_sidebar_list_info'>
        ...
        <div class="sitepage_sidebar_list_details"> 
					<?php echo $this->translate(array('%s like', '%s likes', $sitepagemusic->like_count), $this->locale()->toNumber($sitepagemusic->like_count)) ?>,
  ...
  <li class="sitepage_sidebar_list_seeall">
		<a href='<?php echo $this->url(array('likedmusic'=> 1), 'sitepagemusic_browse', true) ?>'><?php echo $this->translate('See All');?> &raquo;</a>
	</li>
</ul>