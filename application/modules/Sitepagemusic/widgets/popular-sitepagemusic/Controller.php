 ...
 */
class Sitepagemusic_Widget_PopularSitepagemusicController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->sitepage_subject = $sitepage_subject = Engine_Api::_()->core()->getSubject('sitepage_page');
		$popular_music = Zend_Registry::isRegistered('sitepagemusic_popular') ? Zend_Registry::get('sitepagemusic_popular') : null;
    ...
    if (empty($isManageAdmin) || empty($popular_music)) {
      return $this->setNoRender();
    }
    ...
    $params['orderby'] = 'play_count DESC';
    $params['orderby_second'] = 'view_count DESC';
    $params['zero_count'] = 'play_count';
