 ...
 */
class Sitepagemusic_Widget_CommentSitepagemusicController extends Engine_Content_Widget_Abstract {

  //ACTION FOR SHOWING THE MOST COMMENTED MUSIC ON PAGE PROFILE PAGE 
  public function indexAction() {

    //GET SITEPAGE SUBJECT
    $this->view->sitepage_subject = $sitepage_subject = Engine_Api::_()->core()->getSubject('sitepage_page');
		$comment_music = Zend_Registry::isRegistered('sitepagemusic_comment') ? Zend_Registry::get('sitepagemusic_comment') : null;
    ...
    if (empty($isManageAdmin) || empty($comment_music)) {
      return $this->setNoRender();
    }
