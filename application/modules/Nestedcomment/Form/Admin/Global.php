...
class Nestedcomment_Form_Admin_Global extends Engine_Form {
    ...
    public function init() {
        ...
        $this->addElement('Radio', 'nestedcomment_comment_public', array(
            'label' => 'Post Comment Box for Non-Logged-In Users',
            'description' => 'Do you want to show post comment / reply box to non-logged-in users?',
            'multiOptions' => array(
                1 => 'Yes',
                0 => 'No'
            ),
            'value' => $coreSettingsApi->getSetting('nestedcomment.comment.public', 1),
        ));
