      ...
      <div style="display:none;" class="sm-comments-post-comment-form"  id="hide-commentform-<?php echo $this->comment_id ?>">
        ...
        <?php if($photoEnabled || $smiliesEnabled || $taggingEnabled || $stickersEnabled):?>  
            ...
            <div id="activitypost-container-temp" action-id='<?php echo "activity-reply-form-$this->comment_id" ;?>'>
                ...
                <?php if($photoEnabled):?>
                    <div id="composer-nested-reply-options_<?php echo $this->comment_id;?>" class="sm-composer-options fleft">
                      ...
                      <!--</div>-->
                        <?php if($stickersEnabled):?>
                         <a href="javascript:void(0);" data-role="none" id="stickers-button"  class="stickers_wapper_target composer-stickers-button"  onclick="sm4.activity.composer.showReplyPluginForm(this, 'sticker', '#activity-reply-body-<?php echo $action->action_id ?>', '<?php echo $this->comment_id;?>');" data-action-id='<?php echo $this->action->action_id ?>'>
