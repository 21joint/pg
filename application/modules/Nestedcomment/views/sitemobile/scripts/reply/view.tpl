 ...
 * @version    $Id: view.tpl 2014-11-07 00:00:00 SocialEngineAddOns $
...
<?php if (!$this->page): ?>
  <div id="replies_<?php echo $this->comment_id;?>" class="ps-carousel-comments sm-ui-popup">
<?php endif; ?>
 ...
 <script type="text/javascript">
      sm4.core.runonce.add(function(){
                ...
                $("#reply-form_<?php echo $this->comment_id;?>").find('#body').autoGrow(); 
      $("#reply-form_<?php echo $this->comment_id;?>").find('textarea').attr('placeholder', sm4.core.language.translate('Write a reply...'));
      $("#reply-form_<?php echo $this->comment_id;?>").find('textarea').focus();
      });
       </script> </div>          <div class="sm-comments-post-comment-form">
  ...
  sm4.core.runonce.add(function() {
    $('.ps-close-popup').on('click', function() {
      <?php if($RemoveClassDone):?>   
       ...
       <?php endif;?>  
      $('.ps-close-popup').closest('#replypopup_' + <?php echo $this->comment_id;?>).remove();
