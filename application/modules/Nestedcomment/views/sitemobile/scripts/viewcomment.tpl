                  ...
                  <div class="comments_info">
                    ...
                    <div class="comments_body">
                     ...
                     ?> 
                      ...
                      <div class="seaocore_comments_attachment seaocore_comments_attachment_<?php echo $attachment->getType()?>" id="seaocore_comments_attachment">
...
<!--                            <span class="ui-icon ui-icon-thumbs-up-alt"><?php //echo $comment->likes()->getLikeCount();?></span>-->
    ...
    if ($canComment) :
      ...
      <div style="display:none;" class="sm-comments-post-comment-form"  id="hide-commentform-<?php echo $action->action_id ?>">
        ...
        <?php if($photoEnabled || $smiliesEnabled || $taggingEnabled || $stickersEnabled):?>
        <div class="cont-sep t_l b_medium"></div>
            <div id="activitypost-container-temp" action-id='<?php echo "activity-comment-form-$action->action_id" ;?>'>
                ...
                <?php if($photoEnabled):?>
                    <div id="composer-options" class="sm-composer-options fleft">
                      ...
                      <!--</div>-->
                        <?php if($stickersEnabled):?>
                         <a href="javascript:void(0);" data-role="none" id="stickers-button"  class="stickers_wapper_target composer-stickers-button"  onclick="sm4.activity.composer.showCommentPluginForm(this, 'sticker', '#activity-comment-body-<?php echo $action->action_id ?>');" >
                           <i class="cm-icon-reaction"></i>
                         </a>
                         <?php endif; ?>
                    </div>
                <?php endif; ?>
              ...
              <div id="comment_options_box">
                ...
                <?php endif; ?>
                <?php if($stickersEnabled):?>
                <div class="compose_sticker_box_cont ui-page-content">
