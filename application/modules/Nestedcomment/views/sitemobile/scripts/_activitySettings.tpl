...
if ($this->subject()):
    ...
    if($subjectType == 'core_comment' || $subjectType == 'activity_comment') {
      ...
      $type = $type == 'user' ? 'advancedactivity' : $type;
    }
else:
...
$stickersEnabled = ($this->settings('sitereaction.collection.active', 1) && Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitereaction'));
?>
