...
<?php
    ...
    $allowReaction = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitereaction') && $this->settings('sitereaction.reaction.active', 1) && $this->settings('sitereaction.reaction.withdislike.active', 1);
    ?>
