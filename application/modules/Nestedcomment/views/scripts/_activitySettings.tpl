...
<?php if ($row): ?>
    ...
    <?php endif; ?>
    <?php if (!$showAsLike): ?>
	<?php $this->allowReaction = $this->allowReaction && $this->settings('sitereaction.reaction.withdislike.active', 1); ?>
    <?php endif; ?>
<?php endif; ?>
...
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl. 'application/modules/Seaocore/externals/styles/style_infotooltip.css')
        ...
        ->appendStylesheet($this->layout()->staticBaseUrl. 'application/modules/Nestedcomment/externals/styles/style_nestedcomment.css');
