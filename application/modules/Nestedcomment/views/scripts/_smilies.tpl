 ...
 * @version    $Id: _smilies.tpl 2014-11-07 00:00:00 SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
?>        
<?php $SEA_EMOTIONS_TAG = unserialize(SEA_EMOTIONS_TAG);?>
<div id="emoticons-comment-icons" style="display:none;">
    <span id="emoticons-comment-button" class="adv_post_smile" onclick="setCommentEmoticonsBoard(this);" style="display:block; height:16px;width:16px;" title="<?php echo $this->translate('Insert Emoticons') ?>">
        ...
        <span id="emoticons-comment-board"  class="seaocore_comment_embox seaocore_comment_embox_closed" >
          <span class="seaocore_comment_embox_arrow"><img src="<?php echo $this->layout()->staticBaseUrl ?>application/modules/Seaocore/externals/images/tooltip_arrow_top.png" alt="" /></span>
            ...
            <?php foreach ($SEA_EMOTIONS_TAG[0] as $tag_key=>$tag):?>         
                <span class="seaocore_comment_embox_icon" onmouseover='setCommentEmotionLabelPlate("<?php echo $this->string()->escapeJavascript($this->translate(preg_replace("/__([^_]*)__([^_]*)__([^_]*)__/","$3", $tag)))?>","<?php echo $this->string()->escapeJavascript($tag_key)?>", this)' onclick='addCommentEmotionIcon("<?php echo $this->string()->escapeJavascript($tag_key)?>", this)'  title="<?php echo $this->translate(preg_replace("/__([^_]*)__([^_]*)__([^_]*)__/","$3", $tag))."&nbsp;".$tag_key; ?>">
