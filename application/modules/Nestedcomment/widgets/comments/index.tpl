...
<?php if($this->subjectSet): ?>
    ...
    <?php if($this->showContent): ?>
      <?php echo $this->action("list", "comment", "nestedcomment", array("type" => $this->subject->getType(), "id" => $this->subject->getIdentity(), "taggingContent" => $this->taggingContent, 'showAsNested' => $this->showAsNested, 'showAsLike' => $this->showAsLike, 'showDislikeUsers' => $this->showDislikeUsers, 'showLikeWithoutIcon' => $this->showLikeWithoutIcon, 'showLikeWithoutIconInReplies' => $this->showLikeWithoutIconInReplies, 'nestedCommentPressEnter' => $this->nestedCommentPressEnter, 'showSmilies' => $this->showSmilies, 'showComposerOptions' => $this->showComposerOptions, 'photoLightboxComment' => $photoLightboxComment, 'commentsorder' => $this->commentsorder)); ?>
    <?php endif;?>
 ...
 <?php if($this->showSmilies):?>
    <?php include APPLICATION_PATH . '/application/modules/Nestedcomment/views/scripts/_smiliesComment.tpl' ?>
 <?php endif;?>
