...
//    $curr_module_version = strcasecmp($is_enabled->version, $SocialEngineAddOns_version);        
      ...
      $shouldUpgrade = checkVersion_sitemailtemplates($running_version,$product_version);
...
function checkVersion_sitemailtemplates($databaseVersion, $checkDependancyVersion) {
    $f = $databaseVersion;
