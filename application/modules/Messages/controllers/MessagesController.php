...
class Messages_MessagesController extends Core_Controller_Action_User
{
  ...
  public function init()
  {
    ...
    $view = $this->view;
    $view->addHelperPath(APPLICATION_PATH . '/application/modules/Messages/View/Helper', 'Messages_View_Helper');
  }
        ...
        foreach ($recipients as $r) {
          if ($viewer_id == $r->user_id) {
            ...
            Engine_Api::_()->getDbtable('notifications', 'activity')->delete(array(
              'object_type = ?' => 'messages_conversation',
              'object_id = ?' => $r->conversation_id,
            ));
          }
        }
      }
