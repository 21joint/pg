...
class SupportCollectionTest extends TestCase
{
  ...
  public function testWhere()
  {
    ...
    $this->assertEquals(
      [['v' => 3], ['v' => '3']], $c->where('v', 3)->values()->all()
    );
    $this->assertEquals(
      [['v' => 3], ['v' => '3']], $c->where('v', '=', 3)->values()->all()
    );
    ...
    $this->assertEquals(
      [['v' => 3], ['v' => '3']], $c->where('v', 'garbage', 3)->values()->all()
    );
    $this->assertEquals(
      [['v' => 3]], $c->where('v', '===', 3)->values()->all()
    );

    $this->assertEquals(
      [['v' => 1], ['v' => 2], ['v' => 4]], $c->where('v', '<>', 3)->values()->all()
    );
    $this->assertEquals(
      [['v' => 1], ['v' => 2], ['v' => 4]], $c->where('v', '!=', 3)->values()->all()
    );
    $this->assertEquals(
      [['v' => 1], ['v' => 2], ['v' => '3'], ['v' => 4]], $c->where('v', '!==', 3)->values()->all()
    );
    $this->assertEquals(
      [['v' => 1], ['v' => 2], ['v' => 3], ['v' => '3']], $c->where('v', '<=', 3)->values()->all()
    );
    $this->assertEquals(
      [['v' => 3], ['v' => '3'], ['v' => 4]], $c->where('v', '>=', 3)->values()->all()
    );
    $this->assertEquals(
      [['v' => 1], ['v' => 2]], $c->where('v', '<', 3)->values()->all()
    );
    $this->assertEquals(
      [['v' => 4]], $c->where('v', '>', 3)->values()->all()
    );
    ...
    $this->assertEquals(
      [['v' => $object]], $c->where('v', $object)->values()->all()
    );
  }
  ...
  public function testWhereStrict()
  {
    ...
    $this->assertEquals(
      [['v' => 3]], $c->whereStrict('v', 3)->values()->all()
    );
  }
  ...
  public function testCrossJoin()
  {
    ...
    $this->assertEquals(
      [[1, 'a'], [1, 'b'], [2, 'a'], [2, 'b']], (new Collection([1, 2]))->crossJoin(['a', 'b'])->all()
    );

    // Cross join with a collection
    $this->assertEquals(
      [[1, 'a'], [1, 'b'], [2, 'a'], [2, 'b']], (new Collection([1, 2]))->crossJoin(new Collection(['a', 'b']))->all()
    );
    ...
    $this->assertEquals(
      ...
      [2, 'b', 'I'], [2, 'b', 'II'],
        ...
        new Collection(['a', 'b']), new Collection(['I', 'II'])
      )->all()
    );
  }
  ...
  public function testMapWithKeys()
  {
    ...
    $this->assertEquals(
      ['Blastoise' => 'Water', 'Charmander' => 'Fire', 'Dragonair' => 'Dragon'], $data->all()
    );
  }
  ...
  public function testSplitCollectionWithADivisableCount()
  {
    ...
    $this->assertEquals(
      [['a', 'b'], ['c', 'd']], $collection->split(2)->map(function (Collection $chunk) {
  ...
  public function testSplitCollectionWithAnUndivisableCount()
  {
    ...
    $this->assertEquals(
      [['a', 'b'], ['c']], $collection->split(2)->map(function (Collection $chunk) {
        return $chunk->values()->toArray();
      })->toArray()
    );
  }
  ...
  public function testSplitCollectionWithCountLessThenDivisor()
  {
    ...
    $this->assertEquals(
      [['a']], $collection->split(2)->map(function (Collection $chunk) {
        return $chunk->values()->toArray();
      })->toArray()
    );
  }
