...
<script type="text/javascript">
  ...
  function showlocation(option) {
    ...
    if (option == 0) {
      ...
      if ($('sitebackup_tablelock-wrapper')) {
        $('sitebackup_tablelock-wrapper').style.display = 'none';
      }
      ...
      if ($('sitebackup_tablelock-wrapper')) {
        $('sitebackup_tablelock-wrapper').style.display = 'block';
      }
