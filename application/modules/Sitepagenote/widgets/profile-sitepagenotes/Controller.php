...
class Sitepagenote_Widget_ProfileSitepagenotesController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    //TOTAL NOTE
    $noteCount = Engine_Api::_()->sitepage()->getTotalCount($sitepageSubject->page_id, 'sitepagenote', 'notes'); 
...
//    }
    ...
    //GET THE TAB ID
    $this->view->content_id = Engine_Api::_()->sitepage()->GetTabIdinfo('sitepagenote.profile-sitepagenotes', $sitepageSubject->page_id, $layout);
