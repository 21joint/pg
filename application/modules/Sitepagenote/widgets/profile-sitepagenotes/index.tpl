...
<?php if (!empty($this->show_content)) : ?>
  <?php if($this->showtoptitle == 1):?>
	...
	<div class="layout_right" id="communityad_note">
		<?php
			echo $this->content()->renderWidget("communityad.ads", array( "itemCount"=>Engine_Api::_()->getApi('settings', 'core')->getSetting('sitepage.adnotewidget', 3),"loaded_by_ajax"=>1,'widgetId'=>"page_note")); 			 
		?>
	</div>
