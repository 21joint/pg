 ...
 */
class Sitepagenote_Form_ItemOfDayday extends Engine_Form {

  protected $_field;

  public function init() {
    $this->setMethod('post');
    $this->setTitle('Add a Note of the Day')
            ->setDescription('Select a start date and end date below.This note will be displayed as "Note of the Day" for this duration.If more than one notes of the day are found for a date then randomly one will be displayed.');

    // init to
    $this->addElement('Hidden', 'resource_id', array( 'order' => 860,));
