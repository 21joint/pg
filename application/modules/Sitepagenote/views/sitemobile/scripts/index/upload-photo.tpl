 ...
 * @version    $Id: upload-photo.tpl 8871 2011-04-13 02:27:38Z jung $
 * @author     Jung
 */
?>
<?php
  $this->headScript()
    ->appendFile($this->layout()->staticBaseUrl . 'externals/tinymce/tiny_mce_popup.js')
    ->appendFile($this->layout()->staticBaseUrl . 'externals/tinymce/utils/mctabs.js')
    ->appendFile($this->layout()->staticBaseUrl . 'externals/tinymce/utils/form_utils.js')
    ->appendFile($this->layout()->staticBaseUrl . 'externals/tinymce/themes/advanced/js/image.js');
 ?>
...
<body id="image" style="display: none">
  <div class="tabs">
    <ul>
      ...
      <li id="general_tab" class="<?php if(!$this->status) echo'current'?>"><span><a href="<?php echo $this->layout()->staticBaseUrl.'externals/tinymce/themes/advanced/upload.htm';?>" onmousedown="return false;">Upload</a></span></li>
    </ul>
  </div>
