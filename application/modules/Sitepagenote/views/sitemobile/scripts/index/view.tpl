        ...
        <?php echo $this->htmlLink($this->sitepage->getHref(array('tab'=>$this->tab_selected_id)), $this->translate('Back to Page'),array('class'=>'buttonlink  icon_sitepage_back')) ?>
			...
			<?php if($this->sitepagenote->draft == 1) :?>
				...
				<li>
					...
					'class'=>'buttonlink icon_sitepagenote_delete smoothbox')) ?>
				</li>
			<?php endif; ?>
...
<?php
			echo $this->content()->renderWidget("communityad.ads", array( "itemCount"=>Engine_Api::_()->getApi('settings', 'core')->getSetting('sitepage.adnoteview', 3),"loaded_by_ajax"=>0,'widgetId'=>"page_noteview")); 			 
		?>
	</div>
<?php endif;?>
