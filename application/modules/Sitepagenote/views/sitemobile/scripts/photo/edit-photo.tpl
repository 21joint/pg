...
<?php
			echo $this->content()->renderWidget("communityad.ads", array( "itemCount"=>Engine_Api::_()->getApi('settings', 'core')->getSetting('sitepage.adnoteeditphoto', 3),"loaded_by_ajax"=>0,'widgetId'=>"page_noteeditphoto")); 			 
		?>
    </div>
  <?php endif; ?>
