...
INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('sitepagenote', 'Page Notes', 'sitepagenote', '4.9.4p1', 1, 'extra') ;
...
('sitepagenote_create', 'sitepagenote', '{item:$subject} has created a page note {item:$object}.', 0, '');
