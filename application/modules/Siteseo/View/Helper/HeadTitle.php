 ...
 * @version    $Id: HeadTitle.php 2017-03-27 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteseo_View_Helper_HeadTitle extends Zend_View_Helper_Placeholder_Container_Standalone {
    /**
    ...
    {
        if (strpos($this->toString(), $title) !== false)
            return $this;
    ...
    public function toString($indent = null, $locale = null)
    {
        ...
        $output = $this->siteseoTitle($output);
        return $indent . '<title>' . $output . '</title>';
    }

    // RETURNS FORMATTED TITLE
    public function siteseoTitle($content) {
        $page = Engine_Api::_()->siteseo()->getCurrentPageinfo();
        if (empty($page))
            return $content;
        return Engine_Api::_()->siteseo()->formatMetaTitle($content);
    }
}
