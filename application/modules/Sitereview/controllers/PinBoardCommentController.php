 ...
 */
class Sitereview_PinBoardCommentController extends Core_Controller_Action_Standard {
...
//      }
    ...
    $this->view->body = $this->view->action('list', 'pin-board-comment', 'sitereview', array(
        'type' => $this->_getParam('type'),
