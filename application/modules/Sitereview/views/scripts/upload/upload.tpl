...
<div><br/>
  <a class="buttonlink" href="javascript:startUpload();" id="demo-upload" style='display:none; background-image: url(<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Album/externals/images/add.png);'><?php echo $this->translate('Post Video'); ?></a>
</div>
