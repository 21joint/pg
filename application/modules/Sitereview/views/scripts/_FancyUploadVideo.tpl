 ...
 * @version    $Id: _FancyUploadVideo.tpl 6590 2013-04-01 00:00:00Z SocialEngineAddOns $
...
window.addEvent('domready', function() { // wait for the content
	...
	up = new FancyUpload2($('demo-status'), $('demo-sitereview'), { // options object
    ...
    // url is read from the form, so you just have to change one place
		 ...
		 *
		 * This example creates a sitereview of error elements directly in the file sitereview, which
		 * hide on click.
		 */
		...
		onFileRemove: function(file) {
		  ...
		  file_id = file.photo_id;
                  ...
                  var demositereview = document.getElementById("demo-sitereview");
                  var demosubmit = document.getElementById("upload-wrapper");
		...
		onSelectSuccess: function(file) {
                  $('demo-sitereview').style.display = 'block';
...
<ul id="demo-sitereview"></ul>

<div><br/>
  <a class="buttonlink" href="javascript:startUpload();" id="demo-upload" style='display:none; background-image: url(<?php echo $this->layout()->staticBaseUrl ?>application/modules/Video/externals/images/video_add.png);'><?php echo $this->translate('Post Video');?></a>
</div>
