...
// $this->headLink()
//  ->appendStylesheet(
//    $this->baseUrl() . '/externals/fancyupload/fancyupload.css'
//  );
$this->headTranslate(
  array(
      ...
      onFileSuccess: function (file, response) {
        ...
        if (json.get('status') == '1') {
          ...
          file.info.set('html', '<span><?php echo $this->string()
            ->escapeJavascript(
              $this->translate('Upload complete.')
            ); ?></span>');
          //var fileids = document.getElementById('fancyuploadfileids');
          ...
          var error = '<span><?php echo $this->string()->escapeJavascript(
      ...
      onFail: function (error) {
        switch (error) {
          case 'hidden': // works after enabling the movie and clicking refresh
            alert('<?php echo $this->string()->escapeJavascript(
              $this->translate(
...
<input type="hidden" name="<?php echo $this->name; ?>" id="fancyuploadfileids"
       value=""/>
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate(
      'Click "Add Video" to select a video from your computer. After you have selected video, click on Post Video at the bottom to begin uploading the file. Please wait while your video is being uploaded. When your upload is finished, your video will be processed - you will be notified when it is ready to be viewed.'
    ); ?>
  </div>
  <div>
...
<div><br/>
  <a class="buttonlink" href="javascript:startUpload();" id="demo-upload"
     style='display:none; background-image: url(application/modules/Album/externals/images/add.png);'><?php echo $this->translate(
      'Post Video'
    ); ?></a>
</div>
