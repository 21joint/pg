 ...
 * @version    $Id: _composePhoto.tpl 9800 2012-10-17 01:16:09Z richard $
 * @author     John
 */
...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    ...
    composeInstance.addPlugin(new Composer.Plugin.Photo({
      ...
      requestOptions : {
        'url'  : en4.core.baseUrl + 'albums/compose-upload/type/'+type
      },
      fancyUploadOptions : {
        'url'  : en4.core.baseUrl + 'albums/compose-upload/format/json/type/'+type,
