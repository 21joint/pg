...
<script type="text/javascript">
  ...
  var saveChanges = function()
  {
    ...
    var url = '<?php echo $this->url(array('action' => 'update', 'controller' => 'content', 'module' => 'sitemobile'), 'admin_default', true)?>';
  ...
  var openWidgetParamEdit = function(name, element) {
    ...
    var url = '<?php echo $this->url(array('action' => 'widget', 'controller' => 'content', 'module' => 'sitemobile'), 'admin_default', true)?>';
  ...
  var saveCurrentPageInfo = function(formElement) {
    var url = '<?php echo $this->url(array('action' => 'save', 'controller' => 'content', 'module' => 'sitemobile'), 'admin_default', true)?>';
  ...
  var deleteCurrentPage = function() {
    ...
    var url = '<?php echo $this->url(array('action' => 'delete', 'controller' => 'content', 'module' => 'sitemobile'), 'admin_default', true)?>';
    var request = new Request.JSON({
      'url' : url,
      'data' : {
        'format' : 'json',
...
<!--<h3><?php echo $this->translate('Mobile Layout Editor'); ?></h3>-->
<p>
  <?php echo $this->translate('Use the layout editor to decide what content appears on specific mobile pages or in your site-wide mobile header and footer. Click and drag the colored "blocks" to arrange the content you want on each page. Drag blocks to and from the "Available Blocks" area to add or remove them from your page. Use "HTML Blocks" if you want to drop in raw HTML or other content.'); ?>
</p>
<?php
//$settings = Engine_Api::_()->getApi('settings', 'core');
//if( $settings->getSetting('user.support.links', 0) == 1 ) {
//	echo 'More info: <a href="http://support.socialengine.com/questions/207/Admin-Panel-Layout-Layout-Editor" target="_blank">See KB article</a>';	
//} 
?>
<br/>
<div class="tip">
  <span>
   <?php echo $this->htmlLink(array('route'=>'admin_default', 'module'=>'sitemobile', 'controller'=>'content', 'action'=>'manage-widget'),
            'Click here', array(
 )) ?> to manage the settings which will affect all the widgets of Mobile Layouts.
  </span>
</div>
...
<div id='admin_cms_wrapper'>
  ...
  <div class="admin_layoutbox_wrapper">
    ...
    <div class="admin_layoutbox_sub_menu">
      <h3>
        <?php echo $this->translate('Mobile Page Block Placement') ?>
      </h3>
      <ul>
  ...
  <div class="admin_layoutbox_pool_wrapper">
    <h3><?php echo $this->translate("Mobile Available Blocks") ?></h3>
