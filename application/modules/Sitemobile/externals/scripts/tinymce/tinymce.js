 ...
 * information about the theme for example in the about/help dialog.
 *
 * @method getInfo
 * @return {Object} Returns an object with meta information about the theme the current items are
 ...
 *             cm.setActive('example', e.element.nodeName == 'IMG');
 *         });
 *     }
 * });
 *
...
/**
 * Meta info method, this method gets executed when TinyMCE wants to present information about the plugin
 * for example in the about/help dialog.
 *
 * @method getInfo
 * @return {Object} Returns an object with meta information about the plugin the current items are longname,
 * author, authorurl, infourl and version.
 * @example
 * // Creates a new plugin class
 * tinymce.create('tinymce.plugins.ExamplePlugin', {
 *     // Meta info method
 ...
 *             infourl: 'http://www.tinymce.com/wiki.php/Plugin:Plugins/example',
 *             version: "1.0"
 *         };
 *     }
 * });
	...
	return function(editor) {
		...
		self = {
			...
			add: function(level) {
				...
				editor.fire('AddUndo', {level: level, lastLevel: lastLevel});
				editor.isNotDirty = 0;
...
define("tinymce/ui/Control", [
	...
	var Control = Class.extend({
		 ...
		 * @param {String} name Name of the event to fire.
		 * @param {Object} args Optional arguments to pass to the event.
		 * @param {Boolean} bubble Optional value to control bubbeling. Defaults to true.
		 * @return {tinymce.ui.Control} Current control object.
		 */
		...
		/**
		 * Sets/gets the disabled for the control.
		 *
		 * @method disabled
		 * @param {Boolean} state Value to set to control.
		 * @return {Boolean/tinymce.ui.Control} Current control on a set operation or current state on a get.
...
define("tinymce/WindowManager", [
	...
	return function(editor) {
		...
		self.close = function() {
			if (windows.length) {
				windows[window.length - 1].win.close();
			}
		};
	};
});
...
// Included from: js/tinymce/classes/ui/CheckboxGroup.js
 ...
 * ..
 *
 * @class tinymce.ui.CheckboxGroup
 * @extends tinymce.ui.Container
 */
define("tinymce/ui/CheckboxGroup", [
	"tinymce/ui/Container"
], function(Container) {
	"use strict";
...
// Included from: js/tinymce/classes/ui/RadioGroup.js
 ...
 * ..
 *
 * @class tinymce.ui.RadioGroup
 * @extends tinymce.ui.Container
 */
define("tinymce/ui/RadioGroup", [
	"tinymce/ui/Container"
], function(Container) {
	"use strict";
