...
(function () { // START NAMESPACE
    ...
    en4.activity = {
        ...
        hideNotifications: function (reset_text) {
            ...
            $('updates_toggle').getElement('.notifications-count').set('html', '0');
            /*
        ...
        showNotifications: function (responseJSON) {
            if (responseJSON.notificationCount > 0) {
                $('updates_toggle').getElement('.notifications-count').getElement('span').set('html', responseJSON.notificationCount);
            }
        },
