...
//                $activityFeedArray['feed']['subject']["url"] = $getHost . $action->getSubject()->getHref();
                ...
                if (isset($activityFeedArray['feed']['subject']["creation_ip"]) && !empty($activityFeedArray['feed']['subject']["creation_ip"]))
                    unset($activityFeedArray['feed']['subject']["creation_ip"]);

                if (isset($activityFeedArray['feed']['subject']["lastlogin_ip"]) && !empty($activityFeedArray['feed']['subject']["lastlogin_ip"]))
