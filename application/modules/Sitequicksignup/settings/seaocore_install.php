...
$path = APPLICATION_PATH . '/application/modules/Seaocore/settings/license/install.php';
if( empty($moduleInfo['package']['sku']) && file_exists($path) ) {
  require_once $path;
} else {

  class Seaocore_License_Installer extends Engine_Package_Installer_Module
  {
