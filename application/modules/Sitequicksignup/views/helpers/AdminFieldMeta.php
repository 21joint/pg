 ...
 * @version    $Id: AdminFieldMeta.php 2017-03-16 9:40:21Z SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Sitequicksignup_View_Helper_AdminFieldMeta extends Zend_View_Helper_Abstract {
  ...
  <li id="admin_field_{$key}" class="{$contentClass}">
    <span class='{$containerClass}'>
      ...
      <div class='item_options'>
         <a style="display:none;" href='javascript:void(0);' onclick='void(0);' onmousedown="void(0);">{$translate->_('disable')}</a>
  ...
  <li id="admin_field_{$key}" class="{$contentClass}">
    <span class='{$containerClass}'>
      ...
      <div class='item_options'>
         ...
         <a  style="display:none;" href='javascript:void(0);' onclick='void(0);' onmousedown="void(0);">{$translate->_('enable')}</a>
      </div>
      <div class='item_title'>
        {$label}
        <span>({$typeLabel})</span>
