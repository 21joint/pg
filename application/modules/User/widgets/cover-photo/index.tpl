      ...
      <div class="holder container">
        <div class="row">
          ...
          <div class="p-0 col-sm-6 col-xl-6 col-lg-6 d-flex align-items-end  flex-sm-row flex-column justify-content-end user-options">
            ...
            <div class="item item-edit d-sm-block px-sm-0 px-5 d-flex justify-content-end mt-sm-0 mt-3">
              <a class="btn btn-success text-white px-sm-5 px-4 py-2 " href="javascript:void(0);" onclick="showEditContent(this)">
