...
?>',
      ...
      onFileRemove: function(file) {
        uploadCount -= 1;
        sticker_id = file.sticker_id;
        request = new Request.JSON({
          'format': 'json',
          'url': '<?php echo $this->url(array('controller' => 'sticker', 'action' => 'delete')) ?>',
          'data': {
        ...
        fileids.value = fileids.value.replace(sticker_id, "");
      },
      ...
      onFileSuccess: function(file, response) {
        ...
        if (json.get('status') == '1') {
          ...
          var fileids = document.getElementById('fancyuploadfileids');
          fileids.value = fileids.value + json.get('sticker_id') + " ";
          file.sticker_id = json.get('sticker_id');
...
<div id="demo-status" class="hide">
  <div>
    <?php echo $this->translate('Click "Add Stickers" to select one or more stickers from your computer. After you have selected the stickers, they will begin to upload right away. When your upload is finished, click the button below your sticker list to save them to your collection.') ?>
  </div>
  <div>
    <a class="buttonlink seaocore_icon_upload" href="javascript:void(0);" id="demo-browse"><?php echo $this->translate('Add Stickers') ?></a>
