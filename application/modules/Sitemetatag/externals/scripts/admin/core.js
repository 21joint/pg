...
var InlineEdit = new Class({
	...
	addClickEvents: function() {
	    var self = this;
	    var editIconPath = 'application/modules/Sitemetatag/externals/images/admin/edit.png';
	...
	showEditBox: function(target) {
		...
		var saveIconPath = 'application/modules/Sitemetatag/externals/images/admin/save.png';
