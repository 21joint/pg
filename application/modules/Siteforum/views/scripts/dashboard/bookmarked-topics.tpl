 ...
 * @version    $Id: bookmarked-topics.tpl 6590 2015-12-23 00:00:00Z SocialEngineAddOns $
...
<div class="siteforum_dashboard_content">
                ...
                <li class="siteforum_nth_<?php echo $i % 2 ?>">
                    ...
                    <div class="siteforum_topics_info">
                        <div class="siteforum_topics_title">
                            <h3<?php if ($topic->closed): ?> class="closed"<?php endif; ?>>
                    ...
                    <div class="siteforum_topics_stats">
    ...
    <?php else: ?>
        <div class="tip">
            <span>
                <?php echo $this->translate('You haven\'t any sticky topic yet.') ?>
            </span>
        </div>
    <?php endif; ?>
    <div class="siteforum_header_pages">
