...
class Siteadvsearch_AdminManageController extends Core_Controller_Action_Admin {
  ...
  public function showTabAction() {
    ...
    $modules_include = array('sitealbum', 'feedback', 'group', 'event', 'blog', 'classified', 'poll', 'video', 'music', 'album', 'document', 'recipe', 'list', 'sitepage', 'sitebusiness', 'sitegroup', 'sitestore', 'sitestoreproduct', 'siteevent', 'sitefaq', 'sitetutorial', 'sitereview', 'sitereviewlistingtype', 'sitevideo', 'sitenews');
