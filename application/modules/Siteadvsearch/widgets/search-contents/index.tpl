...
<?php if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitenews')): ?>

    <?php
    $this->headLink()
            ->appendStylesheet($baseUrl . 'application/modules/Sitenews/externals/styles/style_sitenews.css');
    ?>
    <?php $this->headScript()->appendFile($baseUrl . 'application/modules/Sitenews/externals/scripts/core.js'); ?>
<?php endif; ?>

<?php if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('document')): ?>

    <?php
    $this->headLink()
            ->appendStylesheet($baseUrl . 'application/modules/Document/externals/styles/style_document.css');
    ?>

    <?php $this->headScript()->appendFile($baseUrl . 'application/modules/Document/externals/scripts/core.js'); ?>
<?php endif; ?>
<?php if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding')): ?>

    <?php
    $this->headLink()
            ->appendStylesheet($baseUrl . 'application/modules/Sitecrowdfunding/externals/styles/style_sitecrowdfunding.css');
    ?>
    <?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Seaocore/externals/scripts/favourite.js'); ?>
    <?php $this->headScript()->appendFile($this->layout()->staticBaseUrl . 'application/modules/Seaocore/externals/scripts/like.js'); ?>
...
<?php if (count($this->items) > 1): ?>
    <div class="" id="">
        <div class="" style="display: none;" id="">
            <img alt="Loading" src="<?php echo $baseUrl ?>application/modules/Seaocore/externals/images/core/loading.gif" align="left" />
        </div>
