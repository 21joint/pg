 ...
 * @version    $Id: ConflictThirdPartySemodsLoader.php 2014-08-06 00:00:00 SocialEngineAddOns $
 * @author     SocialEngineAddOns
 */
class Siteadvsearch_ConflictThirdPartySemodsLoader extends Semods_Loader {

  static $_hooked = false;
  var $_trampolines = array('Core_Api_Search' => 'Siteadvsearch_Api_Search');
  var $_loader;
