 ...
 */
class Sitegroupmember_Form_Announcement_Create extends Engine_Form {

  public function init() {

    $this->setTitle('Post New Announcement')
            ->setDescription('Please compose a new announcement for your group below.');
    ...
    if (Engine_Api::_()->getApi('settings', 'core')->getSetting('sitegroupmember.tinymceditor', 1)) {
      $upload_url = "";
      ...
      if (!empty($isManageAdmin)) {
        $upload_url = Zend_Controller_Front::getInstance()->getRouter()->assemble(array('action' => "upload-photo", 'group_id' => $group_id, 'special' => 'announcements'), 'sitegroup_dashboard', true);
      }
      // Overview
    ...
    $this->addElement('Checkbox', 'status', array(
        ...
        'label' => 'Yes, activate this announcement for my group.',
        'value' => 1,
    ));
