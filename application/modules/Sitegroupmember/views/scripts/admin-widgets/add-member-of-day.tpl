 ...
 * @version    $Id: add-member-of-day.tpl 2013-03-18 00:00:00Z SocialEngineAddOns $
...
<script type="text/javascript">
  en4.core.runonce.add(function() {
    var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'sitegroupmember', 'controller' => 'widgets', 'action' => 'getitem'), 'admin_default', true) ?>', {
      'postVar' : 'text',
      'minLength': 1,
      'selectMode': 'pick',
    ...
    contentAutocomplete.addEvent('onSelection', function(element, selected, value, input) {
      document.getElementById('member_id').value = selected.retrieve('autocompleteChoice').id;
    });
