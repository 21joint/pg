...
<script type="text/javascript">
	...
	$(document).ready(function() {
		sm4.core.Module.autoCompleter.attach("user_ids", '<?php echo $this->url(array('module' => 'sitegroupmember', 'controller' => 'index', 'action' => 'getmembers', 'group_id' => $this->group_id), 'default', true) ?>', {'singletextbox': false, 'limit':10, 'minLength': 1, 'showPhoto' : false, 'search' : 'text'}, 'toValues'); 
	});
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
   // if( !isPopulated ) { 
      new Autocompleter.Request.JSON('user_ids', '<?php //echo $this->url(array('module' => 'sitegroupmember', 'controller' => 'index', 'action' => 'getmembers', 'group_id' => $this->group_id), 'default', true) ?>', {
      'postVar' : 'user_ids',
      'postData' : false,
			'minLength': 1,
			'delay' : 250,
...
<div class="global_form_popup sitegroup_add_members_popup" >
