...
<script type="text/javascript">
  ...
  sm4.core.runonce.add(function() {
    if(document.getElementById('date-minute')) {
      document.getElementById('date-minute').style.display= 'none';
    }
    if(document.getElementById('date-ampm')) {
      document.getElementById('date-ampm').style.display= 'none';
    }
    if(document.getElementById('date-hour')) {
      document.getElementById('date-hour').style.display= 'none';
    }
  });
