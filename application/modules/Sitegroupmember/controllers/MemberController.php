...
class Sitegroupmember_MemberController extends Seaocore_Controller_Action_Standard {
  ...
  public function joinAction() {
	...
	if($sitegroup->restricted)
      return $this->_forwardCustom('success', 'utility', 'core', array(
        'messages' => array(Zend_Registry::get('Zend_Translate')->_('You can not join a restricted group.')),
  ...
  public function requestAction() {
	...
	if($sitegroup->restricted)
      return $this->_forwardCustom('success', 'utility', 'core', array(
        'messages' => array(Zend_Registry::get('Zend_Translate')->_('You can not request membership of a restricted group.')),
        'layout' => 'default-simple',
        'parentRefresh' => true,
      ));
