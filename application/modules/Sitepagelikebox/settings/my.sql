...
INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('sitepagelikebox', 'Directory / Pages - Embeddable Badges', ' Directory / Pages - Embeddable Badges, Like Box Extension', '4.9.4p2', 1, 'extra') ;
