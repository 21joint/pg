	...
	<label for="border_color" class="optional"><?php echo $this->translate('Border Color'); ?>
		<a href="javascript:void(0);" class="sitepagelikebox_show_tooltip_wrapper"> [?]
			<span class="sitepagelikebox_show_tooltip">
				<img src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Sitepage/externals/images/tooltip_arrow.png"><?php echo $this->translate('Border color of the embeddable badge. Choose color code of your choice by clicking on the rainbow.'); ?>
			</span>
		</a>
	</label>
	<div id="border_color-element" class="form-element">
		<input type="text" value="" style="width:80px; max-width:80px;" onblur="setLikeBox()" />
		<input name="border_color_rainbow" id="border_color_rainbow" src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Sitepage/externals/images/rainbow.png" link="true" type="image" />
