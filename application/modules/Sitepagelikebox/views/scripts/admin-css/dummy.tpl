	...
	<div class="splb_content">
		<div class="splb_content_top">
			<a href="javascript:void(0);">
				<img class="thumb_icon item_photo_sitepage_page thumb_icon" alt="" src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/Sitepage/externals/images/nophoto_sitepage_thumb_icon.png" title="Page Profile Photo">
			</a>
			<div class="splb_act">
	...
	<div class="splb_fanbox_heading" title="<?php echo $this->translate('Number of Likes'); ?>">
		...
		<div class="splb_fanbox_items_list">
			<div class="splb_fanbox_items">
				<img height='48' width='48' src="<?php echo $this->layout()->staticBaseUrl; ?>application/modules/User/externals/images/nophoto_user_thumb_icon.bak.png" title="<?php echo $this->translate('Users who like this page'); ?>" />
