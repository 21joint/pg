 ...
 */
class Siteandroidapp_Plugin_Menus {
    ...
    public function appBuildUrls($row) {
        ...
        return array(
            'uri' => $view->url(array('module' => 'siteandroidapp', 'controller' => 'app-builder', 'action' => 'create', 'tab' => $params['tab'],'subTab' => $params['subTab']), 'admin_default', false)
        );
    }
