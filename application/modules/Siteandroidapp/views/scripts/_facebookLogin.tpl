...
<div class="form-wrapper" id="facebook_app_id-wrapper">
    ...
    <div class="form-element" id="facebook_app_id-element">
        ...
        <?php if(!empty($isSelected)): ?>
            <input type="checkbox" value="1" id="facebook_app_id" name="facebook_app_id" checked="checked">
        <?php else: ?>
            <input type="checkbox" value="1" id="facebook_app_id" name="facebook_app_id">
        <?php endif; ?>      
