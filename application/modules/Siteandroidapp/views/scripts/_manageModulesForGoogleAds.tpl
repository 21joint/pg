...
<div class="clr" style="padding-top: 10px;">
    <button name="submit" id="submit" type="submit" onclick="window.location.href = '<?php echo $this->url(array('tab' => 7), 'admin_default', false); ?>'">Save Changes and Continue</button>
</div>