...
<div class="admin_seaocore_files_wrapper">
    <ul class="admin_seaocore_files seaocore_faq">
        ...
        <li>
            <?php 
                echo '<p>After filling ALL the App Submission Details, please save the form and if you see "Download" button in the "Download Tar" tab then your form is complete.</p>';
            ?>
        </li>
        <li>
