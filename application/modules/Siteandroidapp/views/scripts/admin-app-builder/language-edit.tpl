...
<p>
    <?php echo $this->translate("The language phrases in this pack are show below. If you're looking for a specific phrase, use the search box below to find it. Be sure to click 'Save Changes' before moving to the next page of phrases if you want to keep your changes. Beneath each phrase, you'll see the original phrase for your reference. This is useful if you've lost or accidentally deleted a phrase. Some phrases are in plural form - you'll see examples of numbers used for these phrases in italics.<br> <span style='color:#a7244c;'>Special Characters like (&amp;,&Dagger;,&rdquo;) are not allowed . </span> "); ?>
</p>
...
<?php if (!empty($this->paginator)): ?>
    <form action="<?php echo $url ?>" method="post">
        <div>
                    ...
                    <?php foreach ($this->paginator as $item): ?>
                            ...
                            <li>
                                ...
                                if($item['key']=='app_name')
                                    $string = " ('".$item['original']."' is a default app name , you have to add your app name here)";
            ...
            <?php echo $this->escape($item['original'].$string) ?>
                                </span>
                            </li>
                        <?php else: ?>
