...
<script type="text/javascript">
  function showReviewTab(){
    if($('main_tabs')) {
      ...
      ShowContent('<?php echo $this->content_id; ?>', execute_Request_Review, '<?php echo $this->content_id ?>', 'review', 'sitepagereview', 'profile-sitepagereviews', page_showtitle,'<?php echo Engine_Api::_()->sitepage()->getPageUrl($this->sitepage->page_id)?>', review_ads_display, page_communityad_integration, adwithoutpackage);
    }
    if($('profile_status')) {
