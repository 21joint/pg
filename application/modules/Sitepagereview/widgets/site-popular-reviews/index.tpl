    ...
    <li class="sitepagereview_show_tooltip_wrapper">
      ...
      <div class='sitepage_sidebar_list_info'>
        ...
        <div class='sitepage_sidebar_list_details'>
          ...
          <?php echo $this->translate("on ") . $this->htmlLink(Engine_Api::_()->sitepage()->getHref($review->page_id, $review->owner_id, $review->getSlug()), $page_title, array('title' => $review->page_title)) ?>
        </div>
