 ...
 */
class Sitepagereview_Widget_SearchSitepagereviewController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    //FORM CREATION
    $this->view->form = $form = new Sitepagereview_Form_Searchwidget(array('type' => 'sitepage_page'));
    $populateValue = 0;
