...
<div class="tabs">
  <ul class="navigation">
    <li class="active">
      <a href="<?php echo $this->baseUrl() . '/admin/sitepagereview/settings/readme' ?>" ><?php echo $this->translate('Please go through these important points and proceed by clicking the button at the bottom of this page.') ?></a>
...
<script type="text/javascript" >
  ...
  function form_submit() {
    ...
    var url='<?php echo $this->url(array('module' => 'sitepagereview', 'controller' => 'settings'), 'admin_default', true) ?>';
