 ...
 * @version    $Id: add-day-item.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<script type="text/javascript">
  ...
  { 
    var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'sitepagereview', 'controller' => 'settings', 'action' => 'get-day-item'), 'admin_default', true) ?>', { 
      'postVar' : 'text',
      'minLength': 1,
      'selectMode': 'pick',
