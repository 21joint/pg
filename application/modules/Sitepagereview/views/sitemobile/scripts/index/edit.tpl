...
<div class="layout_middle">
	<form id="sitepage_review_edit" enctype="application/x-www-form-urlencoded" class="global_form" action='<?php echo $this->url(array('action'=>'edit'));?>' method="post">
		<div>
			<div>
        <?php if (!Engine_Api::_()->sitemobile()->isApp()) :?>
