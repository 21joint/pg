...
//    $curr_module_version = strcasecmp($is_enabled->version, $SocialEngineAddOns_version);        
      ...
      $shouldUpgrade = checkVersion_sitecontentcoverphoto($running_version,$product_version);
...
function checkVersion_sitecontentcoverphoto($databaseVersion, $checkDependancyVersion) {
    $f = $databaseVersion;
