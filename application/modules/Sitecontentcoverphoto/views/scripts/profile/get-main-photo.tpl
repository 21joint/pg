...
switch ($moduleName) {
    ...
    case "album":
        ...
        break;
    case "sitecrowdfunding":
        include APPLICATION_PATH . '/application/modules/Sitecontentcoverphoto/views/scripts/content-main/_mainPhotoCoverContentSitecrowdfunding.tpl';
        break;
    case $moduleName:
