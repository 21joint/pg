...
class Sitecontentcoverphoto_Api_Core extends Core_Api_Abstract {
    ...
    public function showContentOptions($key) {
        ...
        //$KEY DO NOT GIVES SITEREVIEW_REVIEW FOR MULTIPLE LISTING MODULE, SO WE HAVE TO WORK LIKE THIS
        if(substr($key, 0, 19) == 'sitereview_listing_') {
            $crowdfundingEnable = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding'); 
            if (($crowdfundingEnable && Engine_Api::_()->hasModuleBootstrap('sitecrowdfundingintegration') && Engine_Api::_()->getDbtable('modules', 'sitecrowdfunding')->getIntegratedModules(array('enabled' => 1, 'item_type' => $key, 'item_module' => 'sitereview')))) {
                $showContent_timeline = array_merge($showContent_timeline, array("backButton" => "Back Button")); 
                return $showContent_timeline;
            } 
        }
        switch ($key) {
            case 'album':
                $showContent_timeline = array("mainPhoto" => "Album Profile Photo", "title" => "Album Title", "owner" => "Album Owner", 'description' => "Description", "totalPhotos" => "Total Photos", "viewCount" => "Total Views", "likeCount" => "Total Likes", "commentCount" => "Total Comments", "location" => "Location", "CategoryLink" => "Category", 'creationDate' => 'Creation Date', 'updateDate' => "Update Date", "rating" => "Rating", "optionsButton" => "Options Button (Edit, Delete, etc.)", "shareOptions" => "Share Options (Facebook, Linkedin, Twitter, etc.)", "uploadPhotos" => "Add New Photos");
                break;
            case 'sitevideo_channel':
                $showContent_timeline = array("mainPhoto" => "Channel Profile Photo", "title" => "Channel Title", "owner" => "Channel Owner", 'description' => "Description", "totalVideos" => "Total Videos", "likeCount" => "Total Likes", "commentCount" => "Total Comments", "subscribe" => "Total Subscribe", "CategoryLink" => "Category", 'creationDate' => 'Creation Date', 'updateDate' => "Update Date", "rating" => "Rating", "optionsButton" => "Options Button (Edit, Delete, etc.)", "shareOptions" => "Share Options (Facebook, Linkedin, Twitter, etc.)", "uploadVideos" => "Upload Videos");
                break; 
            case 'sitepage_page':
            ...
            case 'sitebusiness_business':
                ...
                $crowdfundingEnable = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding'); 
                if (($crowdfundingEnable && Engine_Api::_()->hasModuleBootstrap('sitecrowdfundingintegration') && Engine_Api::_()->getDbtable('modules', 'sitecrowdfunding')->getIntegratedModules(array('enabled' => 1, 'item_type' => 'sitebusiness_business', 'item_module' => 'sitebusiness')))) {
                    $showContent_timeline = array_merge($showContent_timeline, array("backButton" => "Back Button"));
                }
                break;
            case 'sitegroup_group':
                ...
                $crowdfundingEnable = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding'); 
                if (($crowdfundingEnable && Engine_Api::_()->hasModuleBootstrap('sitecrowdfundingintegration') && Engine_Api::_()->getDbtable('modules', 'sitecrowdfunding')->getIntegratedModules(array('enabled' => 1, 'item_type' => 'sitegroup_group', 'item_module' => 'sitegroup')))) {
                    $showContent_timeline = array_merge($showContent_timeline, array("backButton" => "Back Button"));
                }
                break;
            ...
            case 'sitereview_listing':
                ...
                $crowdfundingEnable = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding'); 
                if (($crowdfundingEnable && Engine_Api::_()->hasModuleBootstrap('sitecrowdfundingintegration') && Engine_Api::_()->getDbtable('modules', 'sitecrowdfunding')->getIntegratedModules(array('enabled' => 1, 'item_type' => 'sitereview_listing', 'item_module' => 'sitereview')))) {
                    $showContent_timeline = array_merge($showContent_timeline, array("backButton" => "Back Button"));
                }
                break;
            case 'siteevent_event':
                ...
                $crowdfundingEnable = Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitecrowdfunding'); 
                if (($crowdfundingEnable && Engine_Api::_()->hasModuleBootstrap('sitecrowdfundingintegration') && Engine_Api::_()->getDbtable('modules', 'sitecrowdfunding')->getIntegratedModules(array('enabled' => 1, 'item_type' => 'siteevent_event', 'item_module' => 'siteevent')))) {
                    $showContent_timeline = array_merge($showContent_timeline, array("backButton" => "Back Button"));
                }
                break;
            //
            case 'sitecrowdfunding_project':
                $showContent_timeline = array("title" => "Title","description" => "Project Description", "owner" => "Project Owner", "location" => "Location", "fundingRatio" => "Funding Ratio" , "fundedAmount" => "Funded Amount" ,"daysLeft" => "Days Left", "backerCount" => "Backer Count","backButton" => "Back Button","category" => "Category", "dashboardButton" => "Dashboard Button","shareOptions" => "Share Options (Facebook, Linkedin, Twitter, etc.)", "optionsButton" => "Options Button (Edit Details, Add to Diary, etc.)");
