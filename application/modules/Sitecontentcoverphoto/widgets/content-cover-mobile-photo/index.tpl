...
<div class="seaocore_profile_cover_wrapper">
  <?php if ($this->can_edit): ?>
    ...
    <?php endif; ?>
    <div class='seaocore_profile_cover_photo_wrapper' id="sitecontent_cover_photo" style='min-height:<?php echo $minHeight; ?>px;'>
      <?php if ($this->photo) : ?>
        <div class="seaocore_profile_cover_photo" id="sitecontentcover_middle_content">
      ...
      <?php elseif($this->showMemberLevelBasedPhoto):?>
		    <?php if (Engine_Api::_()->sitecontentcoverphoto()->getSiteContentDefaultSettingsIds($this->subject(), $moduleName, $level_id, 0)): ?>
		      <div class="seaocore_profile_cover_photo" id="sitecontentcover_middle_content">
		    ...
		    <?php elseif(Engine_Api::_()->getApi("settings", "core")->getSetting("siteusercoverphoto.cover.photo.preview.level.$level_id.id")) :?>
					<div class="seaocore_profile_cover_photo" id="sitecontentcover_middle_content">
						<img src="<?php echo Engine_Api::_()->storage()->get(Engine_Api::_()->getApi("settings", "core")->getSetting("siteusercoverphoto.cover.photo.preview.level.$level_id.id"), 'thumb.cover')->map()?>" align="left" class="cover_photo" style="top:<?php echo $this->coverTop?>px" />
					</div>
		    <?php endif;?>
 ...
 <?php if (empty($this->can_edit)) : ?>
  ...
  switch ($moduleName) {
    case "sitepage":
      include APPLICATION_PATH . '/application/modules/Sitecontentcoverphoto/views/scripts/content-mobile-main/_mainPhotoCoverContentSitepage.tpl';
      break;
    case "sitebusiness":
      include APPLICATION_PATH . '/application/modules/Sitecontentcoverphoto/views/scripts/content-mobile-main/_mainPhotoCoverContentSitebusiness.tpl';
      break;
    case "sitegroup":
      include APPLICATION_PATH . '/application/modules/Sitecontentcoverphoto/views/scripts/content-mobile-main/_mainPhotoCoverContentSitegroup.tpl';
      break;
    case "sitereview":
      include APPLICATION_PATH . '/application/modules/Sitecontentcoverphoto/views/scripts/content-mobile-main/_mainPhotoCoverContentSitereview.tpl';
      break;
    case "sitestore":
      include APPLICATION_PATH . '/application/modules/Sitecontentcoverphoto/views/scripts/content-mobile-main/_mainPhotoCoverContentSitestore.tpl';
      break;
    case "sitestoreproduct":
      include APPLICATION_PATH . '/application/modules/Sitecontentcoverphoto/views/scripts/content-mobile-main/_mainPhotoCoverContentSitestoreproduct.tpl';
      break;
    case "siteevent":
      include APPLICATION_PATH . '/application/modules/Sitecontentcoverphoto/views/scripts/content-mobile-main/_mainPhotoCoverContentSiteevent.tpl';
      break;
    case "album":
      include APPLICATION_PATH . '/application/modules/Sitecontentcoverphoto/views/scripts/content-mobile-main/_mainPhotoCoverContentSitealbum.tpl';
      break;
    case "default":
