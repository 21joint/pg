...
<?php if (!$this->cover_photo_preview && $this->memberCount && $this->membersCount && $this->showMember && !Engine_Api::_()->getApi("settings", "core")->getSetting("siteusercoverphoto.cover.photo.preview.level.$level_id.id") && !Engine_Api::_()->sitecontentcoverphoto()->getSiteContentDefaultSettingsIds($this->subject(), $this->moduleName, $level_id, 0) && !$this->photo && $this->showMemberLevelBasedPhoto): ?>
    <?php
...
<?php if (Engine_Api::_()->seaocore()->getCurrentActivateTheme() && $this->contentFullWidth): ?>    
    <style type="text/css">
        .layout_main {
            width:1200px;
            margin: 0 auto;
