...
$routes['group'] = array(
    ...
    'group_members_general' => array(
        ...
        'reqs' => array(
            'action' => '(list|invite|accept|ignore|leave|join|request|request-cancel|remove|edit|approve|promote|demote|get-invited-users)',
        )
    ),
...
$routes['poll'] = array(
    ...
    'poll_specific' => array(
        ...
        'reqs' => array(
            'poll_id' => '\d+',
            'action' => '(view|close|delete| edit|vote)',
        ),
    )
);
...
$routes['sitereview'] = array(
    'sitereview_general_listtype' => array(
        ...
        'reqs' => array(
            'action' => '(home|categories|search-form|index|manage|create|get-search-listings|map|packages|upgrade-package)',
        )
    ),
...
$routes['sitestore'] = array(
    ...
    'sitestore_specific' => array(
        ...
        'reqs' => array(
            'action' => '(view|close|delete|information|overview|album|offers|tellafriend|invite)',
        ),
    ),
...
$routes['sitestoreproduct'] = array(
    ...
    'sitestoreproduct_browse' => array(
        ...
        'reqs' => array(
            'action' => '(browse|validate-product|browse-wishlist|create-wishlist)',
        ),
    ),
    'sitestoreproduct_specific' => array(
        ...
        'reqs' => array(
            'action' => '(add-to-cart|messageowner|tellafriend|askopinion|photos)',
            'store_id' => '\d+',
            'product_id' => '\d+'
        ),
    ),
...
$routes['siteevent'] = array(
    ...
    'siteevent_members_general' => array(
        ...
        'reqs' => array(
            'action' => '(search-form|list|join|invite|promote|demote|manage-leaders|accept|reject|leave|request|remove|approve|cancel|confirm|compose|get-invited-users)',
        )
    ),
