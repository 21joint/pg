...
.siteapi-cont-body-bg{ width: 100%; float: left; box-sizing: border-box; background-size: cover; max-width: 100% !important;  padding: 50px 30px; background:url(/application/modules/Siteandroidapp/externals/images/showcase-new.png) no-repeat; background-size: cover;}
...
<div class="siteapi-cont-body-bg">
  <div class="siteapi-cont-lf">
    <div class="siteapi-cont-heading"> <?php echo "Your community is now available on mobile!"  ?> </div>
  ...
  <div class="siteapi-cont-rt">
	<img src='<?php echo $this->layout()->staticBaseUrl ?>application/modules/Siteandroidapp/externals/images/mobile-skeleton2.png' alt="" data-pagespeed-url-hash="3334356780" onload="pagespeed.CriticalImages.checkImageForCriticality(this);">
</div>
</div>
</div>
<?php } ?>
