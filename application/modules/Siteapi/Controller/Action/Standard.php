...
//        }
     ...
     * Set the device type
     */
//    protected function _setDeviceType() {
//        $getStringLenght = strlen($this->getDeviceId);
//        if (!empty($getStringLenght) && ($getStringLenght >= 40))
//            $this->getDeviceType = 'ios';
//        else if (!empty($getStringLenght) && ($getStringLenght < 40))
...
//        if (isset($_REQUEST['device_id'])) {
//            $this->getAccessToken = $_REQUEST['device_id'];
//        } else {
//            $getAllHeader = getallheaders();
//            if (!empty($getAllHeader) && isset($getAllHeader['device_id']))
//                $this->getDeviceId = $getAllHeader['device_id'];
