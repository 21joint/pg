...
if (Engine_Api::_()->getDbtable('modules', 'core')->getModule('sitemember')) {
    $showContent_timeline = array_merge($showContent_timeline, array('featured' => 'Featured', 'sponsored' => 'Sponsored', 'rating' => "Rating", "reviewbutton" => "Reviews & Ratings Button","followButton" => 'Follow Button'));
}
