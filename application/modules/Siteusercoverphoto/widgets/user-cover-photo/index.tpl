...
<?php if (!$this->setMessage): ?>
    ...
    <div class="seaocore_profile_cover_wrapper">
        ...
        <div class="seaocore_profile_cover_photo_wrapper <?php if ($this->contentFullWidth): ?><?php echo 'seaocore_profile_fullwidth_cover_photo'; ?><?php endif; ?> <?php if ($this->change_tab_position): ?>seaocore_profile_cover_has_tabs<?php endif; ?>" id="siteuser_cover_photo" style='height:<?php echo (!empty($this->user->user_cover) || !empty($this->can_edit) || $photo_preview_id) ? $this->columnHeight : $minHeight; ?>px;'>
        </div>
...
<?php else: ?>
    ...
    <div class="tip">
        <span>
            <?php $description = Zend_Registry::get('Zend_Translate')->_("You\'re a Super Admin and this message is visible only to you. (Note: The 'User Cover Photo and Information' widget is dependent on the 'SocialEngine Official Album Plugin' or <a href='https://socialengine.younetco.com/advanced-album.html' target='_blank'>'Younet:Advanced Album plugin'</a>.)"); ?>
