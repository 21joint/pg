...
return array(
    array(
        ...
        'description' => $view->translate('Forms the Offers tab of your Page and shows offers and deals of your Page. It should be placed in the Tabbed Blocks area of the Page Profile.'),
