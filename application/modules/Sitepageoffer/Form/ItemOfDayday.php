 ...
 */
class Sitepageoffer_Form_ItemOfDayday extends Engine_Form {

  protected $_field;

  public function init() {
    $this->setMethod('post');
    $this->setTitle('Add an Offer of the Day')
            ->setDescription('Select a start date and end date below.This offer will be displayed as "Offer of the Day" for this duration. If more than one offers of the day are found for a date then randomly one will be displayed.');

    // init to
    $this->addElement('Hidden', 'resource_id', array( 'order' => 890,));
