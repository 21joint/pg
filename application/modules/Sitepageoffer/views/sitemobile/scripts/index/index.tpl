...
<?php
			echo $this->content()->renderWidget("communityad.ads", array( "itemCount"=>Engine_Api::_()->getApi('settings', 'core')->getSetting('sitepage.adofferpage', 3),"loaded_by_ajax"=>0,'widgetId'=>"page_offerindex")); 			 
		?>
	</div>
<?php endif;?>
