...
<p>
  <?php echo $this->translate('Your members will be asked to provide some information about their page offers when creating a new offer. Create some offer questions that allow them to describe their offer. To reorder the offer questions, click on their names and drag them up or down.') ?>
</p>
