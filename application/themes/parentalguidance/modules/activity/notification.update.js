...
en4.activity = {
  ...
  hideNotifications: function (reset_text) {
    ...
    $('.updates_toggle').find('.notifications-count').text('0');
    /*
    ...
    */
    ...
    //     $notification_children.each(function () {
    //         $(this).attr('class', '');
    //     });
    // }
  ...
  showNotifications: function (responseJSON) {
    if (responseJSON.notificationCount > 0) {
      $('.updates_toggle').find('.notifications-count').find('span').html(responseJSON.notificationCount);
    }
  },
  ...
  cometNotify: function (responseObject) {
    $('#core_menu_mini_menu_updates').show();
    $('#core_menu_mini_menu_updates_count').html(responseObject.text);
  },
...
NotificationUpdateHandler = new Class({
  ...
  showNotifications: function (responseJSON) {
    if (responseJSON.notificationCount > 0) {
      ...
      $('.updates_toggle').find('span').text(responseJSON.notificationCount);
    } else {
...
export {en4, NotificationUpdateHandler, ActivityUpdateHandler}
