...
*/
  ...
  (function () {
    ...
    let arr = [Request, Fx];
    $(arr).each(function (i, klass) {
      if (klass) klass.implement(Events.prototype);
    });
...
*/
  ...
  Form.Validator = new Class({
    ...
    initialize: function (form, options) {
      ...
      this.warningPrefix = Function.from(this.options.warningPrefix).call(window);
      this.errorPrefix = Function.from(this.options.errorPrefix).call(window);
